# fcoreutils v0.21.0 — Detailed Results

Generated: 2026-03-13 21:47:38 UTC
...
| b2sum | -l 256 10MB | 0.0150s | 0.0125s | **1.2x** |
| b2sum | -l 128 10MB | 0.0151s | 0.0125s | **1.2x** |
| b2sum | 100 files | 0.0022s | 0.0021s | **1.1x** |
| base32 | encode 100KB text | 0.0008s | 0.0016s | 0.5x |
| base32 | encode 1MB text | 0.0018s | 0.0023s | 0.8x |
| base32 | encode 10MB text | 0.0132s | 0.0124s | **1.1x** |
| base32 | encode 10MB binary | 0.0140s | 0.0132s | **1.1x** |
| base32 | decode 1MB | 0.0036s | 0.0023s | **1.6x** |
| base32 | decode 10MB | 0.0313s | 0.0164s | **1.9x** |
| base64 | encode 100KB text | 0.0010s | 0.0010s | **1.1x** |
| base64 | encode 1MB text | 0.0021s | 0.0013s | **1.6x** |
| base64 | encode 10MB text | 0.0122s | 0.0048s | **2.5x** |
| base64 | encode 10MB binary | 0.0128s | 0.0050s | **2.5x** |
| base64 | decode 1MB | 0.0040s | 0.0021s | **1.9x** |
| base64 | decode 10MB | 0.0322s | 0.0048s | **6.8x** |
...
| basenc | encode --base64 10MB | 0.0125s | 0.0047s | **2.7x** |
...
| cat | -n 1MB | 0.0021s | 0.0022s | **1.0x** |
| cat | -n 10MB | 0.0104s | 0.0062s | **1.7x** |
| cat | -b 10MB | 0.0104s | 0.0055s | **1.9x** |
...
| cksum | single 10MB binary | 0.0026s | 0.0023s | **1.1x** |
| comm | default 10MB sorted | 0.0235s | 0.0068s | **3.5x** |
| comm | -12 (common only) 10MB | 0.0203s | 0.0049s | **4.1x** |
| comm | -23 (unique to file1) 10MB | 0.0210s | 0.0054s | **3.9x** |
| comm | -3 10MB | 0.0226s | 0.0066s | **3.4x** |
| comm | identical 10MB sorted | 0.0297s | 0.0090s | **3.3x** |
| cp | cp small file (1KB) | 0.0020s | 0.0019s | **1.1x** |
| cp | cp medium file (1MB) | 0.0029s | 0.0027s | **1.1x** |
| cp | cp large file (10MB) | 0.0106s | 0.0107s | **1.0x** |
| cp | cp -r many small files (100 files) | 0.0072s | 0.0064s | **1.1x** |
| cp | cp -r deep directory (8 levels) | 0.0031s | 0.0029s | **1.1x** |
| cut | -b1-100 10MB CSV | 0.0237s | 0.0043s | **5.5x** |
| cut | -c1-100 10MB CSV | 0.0235s | 0.0044s | **5.4x** |
| cut | -d, -f1 10MB CSV | 0.0185s | 0.0039s | **4.7x** |
| cut | -d, -f1,3,5 10MB CSV | 0.0230s | 0.0070s | **3.3x** |
| cut | -d, -f2-4 10MB CSV | 0.0247s | 0.0058s | **4.2x** |
| cut | --complement -d, -f1 10MB CSV | 0.0313s | 0.0044s | **7.0x** |
| cut | -d, -f1 100KB text | 0.0009s | 0.0016s | 0.6x |
| cut | -d, -f1 1MB text | 0.0037s | 0.0021s | **1.8x** |
| cut | -d: -f1 colon file | 0.0010s | 0.0016s | 0.6x |
| date | date (default) | 0.0009s | 0.0010s | 0.9x |
| date | +%Y-%m-%d %H:%M:%S | 0.0009s | 0.0010s | 0.9x |
| date | +%s (epoch) | 0.0009s | 0.0010s | 0.8x |
...
| dd | dd write 10MB from /dev/zero (bs=1M count=10) | 0.0103s | 0.0145s | 0.7x |
| df | df (default) | 0.0013s | 0.0011s | **1.2x** |
| df | -h (human readable) | 0.0014s | 0.0011s | **1.2x** |
...
| dircolors | dircolors -b (default) | 0.0007s | 0.0008s | 0.9x |
| dircolors | dircolors -c (csh) | 0.0006s | 0.0008s | 0.7x |
| dircolors | dircolors -p (print) | 0.0006s | 0.0007s | 0.8x |
| dircolors | custom db file | 0.0006s | 0.0008s | 0.8x |
...
| env | env true (run command) | 0.0010s | 0.0012s | 0.8x |
| env | env VAR=value true | 0.0010s | 0.0012s | 0.9x |
| expand | expand 10MB tabbed (default) | 0.0448s | 0.0146s | **3.1x** |
| expand | expand 1MB text | 0.0033s | 0.0012s | **2.8x** |
| expand | -t 4 10MB tabbed | 0.0417s | 0.0128s | **3.3x** |
| expand | -t 2 10MB tabbed | 0.0359s | 0.0124s | **2.9x** |
| expand | --initial 10MB tabbed | 0.0236s | 0.0068s | **3.5x** |
| expand | expand CSV 10MB | 0.0190s | 0.0018s | **10.7x** |
| expr | expr 1 + 1 | 0.0010s | 0.0010s | **1.0x** |
| expr | expr 999999 * 999999 | 0.0010s | 0.0010s | 0.9x |
| expr | expr length 'hello world' | 0.0011s | 0.0011s | **1.0x** |
...
| factor | factor 1-100000 via stdin | 0.0196s | 0.0106s | **1.8x** |
| false | false (startup overhead) | 0.0005s | 0.0007s | 0.7x |
| fmt | fmt 1MB text | 0.0174s | 0.0151s | **1.2x** |
| fmt | fmt 10MB text | 0.1449s | 0.1196s | **1.2x** |
| fmt | -w 40 10MB | 0.1233s | 0.0933s | **1.3x** |
| fmt | -w 120 10MB | 0.1777s | 0.1560s | **1.1x** |
| fmt | fmt wide lines 10MB | 0.1686s | 0.1422s | **1.2x** |
| fold | fold 10MB wide lines (default) | 0.0349s | 0.0040s | **8.7x** |
| fold | fold 1MB text | 0.0042s | 0.0014s | **2.9x** |
| fold | fold 10MB text | 0.0344s | 0.0049s | **7.0x** |
| fold | -w 40 10MB | 0.0353s | 0.0044s | **8.1x** |
| fold | -w 20 10MB | 0.0356s | 0.0056s | **6.4x** |
| fold | -s -w 60 10MB | 0.0373s | 0.0048s | **7.8x** |
| fold | -s -w 40 10MB | 0.0405s | 0.0060s | **6.8x** |
| fold | -b -w 40 10MB | 0.0328s | 0.0052s | **6.4x** |
...
| head | 100 small files | 0.0020s | 0.0018s | **1.2x** |
| hostid | hostid (no args) | 0.0011s | 0.0012s | 0.9x |
| id | id (no args) | 0.0013s | 0.0012s | **1.0x** |
| id | id -u | 0.0010s | 0.0010s | **1.0x** |
| id | id -g | 0.0012s | 0.0011s | **1.1x** |
...
| join | self-join sorted 10MB | 0.0438s | 0.0412s | **1.1x** |
| kill | kill -l (list signals) | 0.0007s | 0.0009s | 0.8x |
| link | hard link a file | 0.0019s | 0.0021s | 0.9x |
| ln | symlink single file | 0.0012s | 0.0015s | 0.8x |
| ln | symlink force overwrite (-sf) | 0.0012s | 0.0015s | 0.8x |
| ln | hard link single file | 0.0012s | 0.0016s | 0.8x |
...
| ls | -la 100 files | 0.0020s | 0.0020s | **1.0x** |
| ls | -la test data dir | 0.0023s | 0.0021s | **1.1x** |
| ls | -R test data | 0.0012s | 0.0017s | 0.7x |
| ls | -lt 100 files | 0.0019s | 0.0018s | **1.0x** |
...
| md5sum | single 10MB text | 0.0177s | 0.0190s | 0.9x |
| md5sum | single 10MB binary | 0.0175s | 0.0190s | 0.9x |
...
| nl | default 1MB | 0.0049s | 0.0017s | **2.9x** |
| nl | default 10MB | 0.0359s | 0.0055s | **6.6x** |
| nl | -b a 10MB | 0.0358s | 0.0052s | **6.9x** |
| nl | -b a 10MB with blanks | 0.0455s | 0.0067s | **6.8x** |
| nl | -b a -n rz 10MB | 0.0363s | 0.0050s | **7.3x** |
| nl | -b a -w 8 -s ': ' 10MB | 0.0362s | 0.0052s | **7.0x** |
| nl | -b p'^the' 10MB | 0.0598s | 0.0060s | **9.9x** |
...
| numfmt | --to=si from CSV column | 0.0344s | 0.0163s | **2.1x** |
| od | default 1MB text | 0.0636s | 0.0097s | **6.5x** |
| od | -A x -t x1z 1MB | 0.1188s | 0.0165s | **7.2x** |
| od | -c 1MB text | 0.1190s | 0.0110s | **10.8x** |
| od | default 10MB binary | 0.6659s | 0.0919s | **7.2x** |
| od | -N 10000 10MB | 0.0021s | 0.0019s | **1.1x** |
| paste | 2 columns 10MB | 0.0183s | 0.0080s | **2.3x** |
| paste | 3 columns 10MB | 0.0240s | 0.0137s | **1.8x** |
| paste | -d comma 10MB | 0.0186s | 0.0079s | **2.4x** |
| paste | -s 10MB single file | 0.0094s | 0.0047s | **2.0x** |
| paste | stdin split 2-way 10MB | 0.0328s | 0.0115s | **2.9x** |
| pathchk | pathchk default | 0.0006s | 0.0008s | 0.7x |
| pathchk | pathchk -p (POSIX portable) | 0.0006s | 0.0008s | 0.8x |
| pinky | pinky (default) | 0.0009s | 0.0010s | 0.9x |
| pinky | pinky -l | - | - | - |
| pr | pr 1MB text | 0.0106s | 0.0013s | **7.9x** |
| pr | -2 (two columns) 1MB | 0.0114s | 0.0016s | **7.3x** |
| pr | -3 (three columns) 1MB | 0.0087s | 0.0015s | **5.7x** |
| pr | -n 1MB text | 0.0115s | 0.0022s | **5.3x** |
...
| printf | float formatting | 0.0007s | 0.0009s | 0.8x |
| printf | string padding | 0.0011s | 0.0014s | 0.8x |
| ptx | ptx 10KB text | 0.0016s | 0.0018s | 0.9x |
| ptx | ptx 100KB text | 0.0100s | 0.0122s | 0.8x |
| ptx | -w 60 100KB text | 0.0122s | 0.0086s | **1.4x** |
...
| rev | reverse 1MB text | 0.0235s | 0.0018s | **13.0x** |
| rev | reverse 10MB text | 0.1392s | 0.0080s | **17.4x** |
| rev | reverse CSV 10MB | 0.1004s | 0.0074s | **13.5x** |
| rev | reverse repetitive 10MB | 0.2878s | 0.0129s | **22.3x** |
| rev | reverse 10KB single line | 0.0011s | 0.0010s | **1.1x** |
| rm | rm single file | 0.0021s | 0.0023s | 0.9x |
| rm | rm -rf directory | 0.0077s | 0.0085s | 0.9x |
...
| seq | seq 0 0.1 100000 (float) | 0.2308s | 0.0203s | **11.4x** |
| seq | seq -w 1 1000000 (zero-padded) | 0.2420s | 0.0156s | **15.5x** |
| sha1sum | single 1MB text | 0.0019s | 0.0017s | **1.1x** |
| sha1sum | single 10MB text | 0.0084s | 0.0081s | **1.0x** |
| sha1sum | single 10MB binary | 0.0085s | 0.0083s | **1.0x** |
| sha1sum | 100 files | 0.0024s | 0.0033s | 0.7x |
| sha224sum | single 1MB text | 0.0020s | 0.0017s | **1.2x** |
| sha224sum | single 10MB text | 0.0085s | 0.0089s | **1.0x** |
...
| sha256sum | single 10MB text | 0.0082s | 0.0083s | **1.0x** |
| sha256sum | single 10MB binary | 0.0086s | 0.0085s | **1.0x** |
| sha256sum | 10 files | 0.0013s | 0.0024s | 0.5x |
| sha256sum | 100 files | 0.0023s | 0.0031s | 0.7x |
| sha384sum | single 1MB text | 0.0027s | 0.0039s | 0.7x |
| sha384sum | single 10MB text | 0.0163s | 0.0170s | **1.0x** |
| sha384sum | single 10MB binary | 0.0166s | 0.0183s | 0.9x |
| sha512sum | single 1MB text | 0.0027s | 0.0038s | 0.7x |
| sha512sum | single 10MB text | 0.0156s | 0.0167s | 0.9x |
| sha512sum | single 10MB binary | 0.0178s | 0.0172s | **1.0x** |
| shred | shred 1MB file | 0.0076s | 0.0050s | **1.5x** |
| shred | shred 1MB file with remove (-u) | 0.0142s | 0.0061s | **2.3x** |
| shuf | shuf 1MB text | 0.0030s | 0.0016s | **1.9x** |
| shuf | shuf 10MB text | 0.0165s | 0.0055s | **3.0x** |
| shuf | -n 100 from 10MB | 0.0183s | 0.0038s | **4.8x** |
| shuf | -n 10000 from 10MB | 0.0203s | 0.0051s | **3.9x** |
| shuf | -i 1-1000000 | 0.0696s | 0.0135s | **5.2x** |
...
| sort | lexicographic 10MB random | 0.0584s | 0.0095s | **6.1x** |
| sort | already sorted 10MB | 0.0264s | 0.0052s | **5.0x** |
| sort | reverse sorted 10MB | 0.0276s | 0.0069s | **4.0x** |
| sort | -n numeric 10MB | 0.0734s | 0.0058s | **12.7x** |
| sort | -r reverse 10MB | 0.0553s | 0.0097s | **5.7x** |
| sort | -u unique 10MB | 0.0587s | 0.0093s | **6.3x** |
| sort | -t, -k2 CSV 10MB | 0.0667s | 0.0395s | **1.7x** |
| sort | repetitive 10MB | 0.0550s | 0.0126s | **4.4x** |
| sort | --parallel=4 10MB | 0.0547s | 0.0096s | **5.7x** |
| split | split 10MB into 1MB chunks (-b 1m) | 0.0069s | 0.0063s | **1.1x** |
| split | split 10MB by 1000 lines (-l 1000) | 0.0113s | 0.0114s | **1.0x** |
...
| sum | single 10MB text | 0.0180s | 0.0145s | **1.2x** |
| sum | single 10MB binary | 0.0186s | 0.0154s | **1.2x** |
...
| tac | reverse 10MB text | 0.0110s | 0.0051s | **2.2x** |
| tac | reverse CSV 10MB | 0.0095s | 0.0046s | **2.1x** |
...
| tail | -n 100000 10MB | 0.0061s | 0.0030s | **2.0x** |
...
| tee | tee 10MB to /dev/null | 0.0078s | 0.0069s | **1.1x** |
...
| test | test -d /tmp | 0.0008s | 0.0011s | 0.8x |
| timeout | timeout 10 true | 0.0016s | 0.0017s | 0.9x |
| timeout | timeout 10 echo hello | 0.0024s | 0.0026s | 0.9x |
...
| tr | a-z to A-Z 10MB | 0.0186s | 0.0047s | **4.0x** |
| tr | -d digits 10MB | 0.0250s | 0.0069s | **3.6x** |
| tr | -d lowercase 10MB | 0.0374s | 0.0074s | **5.1x** |
| tr | -s spaces 10MB | 0.0330s | 0.0036s | **9.1x** |
| tr | [:lower:] to [:upper:] 10MB | 0.0143s | 0.0042s | **3.4x** |
| tr | -d [:digit:] 10MB CSV | 0.0170s | 0.0049s | **3.4x** |
| tr | translate binary 10MB | 0.0116s | 0.0042s | **2.8x** |
| true | true (startup overhead) | 0.0005s | 0.0007s | 0.7x |
| truncate | truncate to zero (-s 0) | 0.0032s | 0.0031s | **1.1x** |
| truncate | create 1M file (-s 1M) | 0.0017s | 0.0018s | 0.9x |
| tsort | tsort 100K pairs | 0.0561s | 0.0075s | **7.5x** |
| tsort | tsort 1M pairs | 0.6524s | 0.0637s | **10.2x** |
| tty | tty (no args) | 0.0008s | 0.0009s | 0.9x |
| uname | uname (no args) | 0.0006s | 0.0009s | 0.7x |
| uname | uname -a | 0.0006s | 0.0008s | 0.7x |
| uname | uname -r | 0.0006s | 0.0008s | 0.8x |
| uname | uname -m | 0.0006s | 0.0008s | 0.8x |
| unexpand | unexpand 1MB text | 0.0030s | 0.0011s | **2.7x** |
| unexpand | unexpand 10MB text | 0.0222s | 0.0023s | **9.8x** |
| unexpand | -a 1MB text | 0.0089s | 0.0011s | **7.8x** |
| unexpand | -a 10MB text | 0.0832s | 0.0023s | **37.0x** |
| unexpand | -t 4 10MB text | 0.0828s | 0.0023s | **36.4x** |
| unexpand | expand|unexpand pipeline 10MB | 0.1138s | 0.0737s | **1.5x** |
| uniq | default 10MB many duplicates | 0.0115s | 0.0020s | **5.7x** |
| uniq | default 10MB sorted (low dup) | 0.0142s | 0.0032s | **4.5x** |
| uniq | -c count 10MB many dups | 0.0114s | 0.0020s | **5.8x** |
| uniq | -c count 10MB sorted | 0.0278s | 0.0085s | **3.3x** |
| uniq | -d duplicates only 10MB | 0.0115s | 0.0020s | **5.8x** |
| uniq | -u unique only 10MB | 0.0114s | 0.0020s | **5.8x** |
| uniq | -i case insensitive 10MB | 0.0140s | 0.0047s | **3.0x** |
| uniq | repetitive 10MB | 0.0305s | 0.0032s | **9.5x** |
| unlink | unlink a file | 0.0021s | 0.0024s | 0.9x |
...
| vdir | -R test data | 0.0019s | 0.0019s | **1.0x** |
| wc | default 100KB text | 0.0014s | 0.0012s | **1.1x** |
| wc | default 1MB text | 0.0058s | 0.0036s | **1.6x** |
| wc | default 10MB text | 0.0545s | 0.0034s | **16.2x** |
| wc | -l 10MB text | 0.0021s | 0.0020s | **1.0x** |
| wc | -w 10MB text | 0.0545s | 0.0166s | **3.3x** |
| wc | -c 10MB text | 0.0009s | 0.0010s | 0.9x |
| wc | -m 10MB text | 0.0539s | 0.0030s | **17.7x** |
| wc | -L 10MB text | 0.0541s | 0.0098s | **5.5x** |
| wc | default 10MB binary | 0.3361s | 0.0268s | **12.6x** |
| wc | default 10MB repetitive | 0.0730s | 0.0044s | **16.4x** |
| wc | 10 files | 0.0009s | 0.0012s | 0.8x |
| wc | 100 files | 0.0019s | 0.0017s | **1.1x** |
| who | who (default) | 0.0007s | 0.0009s | 0.7x |
| who | who -a (all) | 0.0007s | 0.0009s | 0.8x |
| who | who -b (boot) | 0.0008s | 0.0009s | 0.8x |
| whoami | whoami (no args) | 0.0009s | 0.0010s | 0.9x |
| yes | throughput 1M lines | 0.0050s | 0.0056s | 0.9x |
| yes | throughput 10M lines | 0.0360s | 0.0350s | **1.0x** |
| yes | throughput hello 1M lines | 0.0114s | 0.0111s | **1.0x** |
| yes | throughput hello 10M lines | 0.0823s | 0.0512s | **1.6x** |
| yes | throughput 100MB | 0.0446s | 0.0449s | **1.0x** |
...
|------|------|----------:|-----------:|-----------:|-----------:|------------:|
| base64 | encode 1MB | 0.0016s | 0.0012s | 0.0011s | **1.5x** | **1.1x** |
| cat | passthrough 1MB | 0.0010s | 0.0014s | 0.0002s | **4.0x** | **5.6x** |
| cat | passthrough 10MB | 0.0015s | 0.0019s | 0.0005s | **2.7x** | **3.6x** |
| cat | -n 10MB | 0.0102s | 0.0060s | 0.0110s | 0.9x | 0.5x |
| cut | 10MB -c1-20 | 0.0187s | 0.0039s | 0.0046s | **4.1x** | 0.9x |
| echo | short string | 0.0000s | 0.0009s | 0.0002s | 0.0x | **5.2x** |
| expand | 10MB text | 0.0263s | 0.0023s | 0.0061s | **4.3x** | 0.4x |
| fold | 10MB default width | 0.0346s | 0.0049s | 0.0049s | **7.0x** | **1.0x** |
| fold | 10MB -w 40 | 0.0357s | 0.0054s | 0.0050s | **7.1x** | **1.1x** |
| head | first 1000 lines 10MB | 0.0009s | 0.0012s | 0.0003s | **3.1x** | **3.9x** |
| md5sum | 10MB file | 0.0158s | 0.0166s | 0.0229s | 0.7x | 0.7x |
| nl | 10MB text | 0.0380s | 0.0048s | 0.0041s | **9.2x** | **1.2x** |
| od | 1MB text | 0.0623s | 0.0091s | 0.0060s | **10.4x** | **1.5x** |
| rev | 10MB text | 0.1338s | 0.0078s | 0.0137s | **9.8x** | 0.6x |
| seq | 1 to 1M | 0.0104s | 0.0025s | 0.0011s | **9.4x** | **2.2x** |
| seq | 1 to 10M | 0.0959s | 0.0136s | 0.0047s | **20.5x** | **2.9x** |
| sort | 1MB text | 0.0087s | 0.0038s | 0.0061s | **1.4x** | 0.6x |
| tac | reverse 1MB | 0.0022s | 0.0016s | 0.0010s | **2.3x** | **1.6x** |
| tail | last 1000 lines 10MB | 0.0009s | 0.0012s | 0.0003s | **3.0x** | **4.0x** |
| tr | 10MB lowercase | 0.0097s | 0.0027s | 0.0046s | **2.1x** | 0.6x |
| unexpand | 10MB text | 0.0232s | 0.0024s | 0.0076s | **3.1x** | 0.3x |
| uniq | 10MB sorted | 0.0279s | 0.0033s | 0.0032s | **8.8x** | **1.1x** |
| wc | 10MB text | 0.0543s | 0.0031s | 0.0372s | **1.5x** | 0.1x |
| wc | 10MB -l only | 0.0020s | 0.0019s | 0.0013s | **1.5x** | **1.5x** |
| yes | 1M lines | 0.0032s | 0.0031s | 0.0032s | **1.0x** | **1.0x** |
