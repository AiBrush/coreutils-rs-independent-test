# fcoreutils v0.18.3 — Detailed Results

Generated: 2026-03-06 12:26:54 UTC
...
| b2sum | single 10MB text | 0.0156s | 0.0124s | **1.3x** |
| b2sum | single 10MB binary | 0.0157s | 0.0130s | **1.2x** |
| b2sum | -l 256 10MB | 0.0151s | 0.0123s | **1.2x** |
| b2sum | -l 128 10MB | 0.0149s | 0.0120s | **1.2x** |
| b2sum | 100 files | 0.0022s | 0.0021s | **1.0x** |
| base32 | encode 100KB text | 0.0011s | 0.0014s | 0.8x |
| base32 | encode 1MB text | 0.0025s | 0.0023s | **1.1x** |
| base32 | encode 10MB text | 0.0154s | 0.0112s | **1.4x** |
| base32 | encode 10MB binary | 0.0155s | 0.0116s | **1.3x** |
| base32 | decode 1MB | 0.0037s | 0.0029s | **1.3x** |
| base32 | decode 10MB | 0.0285s | 0.0165s | **1.7x** |
| base64 | encode 100KB text | 0.0010s | 0.0010s | 0.9x |
| base64 | encode 1MB text | 0.0020s | 0.0013s | **1.5x** |
| base64 | encode 10MB text | 0.0123s | 0.0058s | **2.1x** |
| base64 | encode 10MB binary | 0.0126s | 0.0058s | **2.2x** |
| base64 | decode 1MB | 0.0039s | 0.0020s | **2.0x** |
| base64 | decode 10MB | 0.0318s | 0.0046s | **6.8x** |
| base64 | encode -w 76 10MB | 0.0121s | 0.0058s | **2.1x** |
| base64 | encode -w 0 (no wrap) 10MB | 0.0084s | 0.0039s | **2.1x** |
...
| basenc | encode --base64 10MB | 0.0125s | 0.0049s | **2.6x** |
...
| cat | -b 10MB | 0.0103s | 0.0053s | **1.9x** |
...
| comm | default 10MB sorted | 0.0222s | 0.0069s | **3.2x** |
| comm | -12 (common only) 10MB | 0.0185s | 0.0051s | **3.7x** |
| comm | -23 (unique to file1) 10MB | 0.0191s | 0.0055s | **3.5x** |
| comm | -3 10MB | 0.0207s | 0.0067s | **3.1x** |
| comm | identical 10MB sorted | 0.0281s | 0.0081s | **3.4x** |
| cp | cp small file (1KB) | 0.0022s | 0.0019s | **1.2x** |
...
| cut | -b1-100 10MB CSV | 0.0239s | 0.0035s | **6.7x** |
| cut | -c1-100 10MB CSV | 0.0227s | 0.0035s | **6.5x** |
| cut | -d, -f1 10MB CSV | 0.0169s | 0.0042s | **4.0x** |
| cut | -d, -f1,3,5 10MB CSV | 0.0218s | 0.0096s | **2.3x** |
| cut | -d, -f2-4 10MB CSV | 0.0243s | 0.0079s | **3.1x** |
...
| dd | dd read 10MB (bs=4096) | 0.0021s | 0.0022s | **1.0x** |
| dd | dd write 10MB from /dev/zero (bs=1M count=10) | 0.0067s | 0.0095s | 0.7x |
| df | df (default) | 0.0012s | 0.0011s | **1.1x** |
| df | -h (human readable) | 0.0012s | 0.0011s | **1.1x** |
| df | df / | 0.0010s | 0.0011s | **1.0x** |
...
| du | -s (summary) | 0.0015s | 0.0018s | 0.8x |
...
| expand | expand 10MB tabbed (default) | 0.0452s | 0.0148s | **3.0x** |
| expand | expand 1MB text | 0.0033s | 0.0012s | **2.7x** |
| expand | -t 4 10MB tabbed | 0.0426s | 0.0128s | **3.3x** |
| expand | -t 2 10MB tabbed | 0.0364s | 0.0132s | **2.8x** |
| expand | --initial 10MB tabbed | 0.0250s | 0.0072s | **3.5x** |
| expand | expand CSV 10MB | 0.0195s | 0.0018s | **10.6x** |
| expr | expr 1 + 1 | 0.0009s | 0.0012s | 0.8x |
...
| factor | factor 1-100000 via stdin | 0.0213s | 0.0106s | **2.0x** |
| false | false (startup overhead) | 0.0005s | 0.0007s | 0.7x |
| fmt | fmt 1MB text | 0.0165s | 0.0199s | 0.8x |
| fmt | fmt 10MB text | 0.1452s | 0.1260s | **1.2x** |
| fmt | -w 40 10MB | 0.1222s | 0.1024s | **1.2x** |
| fmt | -w 120 10MB | 0.1711s | 0.1640s | **1.0x** |
| fmt | fmt wide lines 10MB | 0.1650s | 0.1451s | **1.1x** |
| fold | fold 10MB wide lines (default) | 0.0346s | 0.0043s | **8.1x** |
| fold | fold 1MB text | 0.0042s | 0.0016s | **2.7x** |
| fold | fold 10MB text | 0.0350s | 0.0050s | **7.0x** |
| fold | -w 40 10MB | 0.0355s | 0.0044s | **8.1x** |
| fold | -w 20 10MB | 0.0378s | 0.0060s | **6.3x** |
| fold | -s -w 60 10MB | 0.0386s | 0.0048s | **8.1x** |
...
| head | -n 100000 10MB | 0.0065s | 0.0039s | **1.7x** |
...
| join | self-join sorted 10MB | 0.0472s | 0.0390s | **1.2x** |
...
| ls | 100 files | 0.0013s | 0.0017s | 0.7x |
| ls | -la 100 files | 0.0023s | 0.0019s | **1.2x** |
...
| md5sum | single 10MB binary | 0.0183s | 0.0192s | **1.0x** |
...
| mv | mv same-fs large (10MB) | 0.0112s | 0.0113s | **1.0x** |
| mv | mv many files (100 files) | - | 0.0111s | - |
| nice | nice true (default priority) | 0.0016s | 0.0016s | **1.0x** |
| nice | nice -n 10 true | 0.0013s | 0.0014s | 0.9x |
| nl | default 1MB | 0.0049s | 0.0017s | **2.9x** |
| nl | default 10MB | 0.0356s | 0.0053s | **6.7x** |
| nl | -b a 10MB | 0.0360s | 0.0052s | **7.0x** |
| nl | -b a 10MB with blanks | 0.0449s | 0.0068s | **6.6x** |
| nl | -b a -n rz 10MB | 0.0358s | 0.0058s | **6.1x** |
| nl | -b a -w 8 -s ': ' 10MB | 0.0363s | 0.0057s | **6.4x** |
| nl | -b p'^the' 10MB | 0.0599s | 0.0113s | **5.3x** |
...
| numfmt | --to=si from CSV column | 0.0222s | 0.0191s | **1.2x** |
| od | default 1MB text | 0.0636s | 0.0098s | **6.5x** |
| od | -A x -t x1z 1MB | 0.1199s | 0.0167s | **7.2x** |
| od | -c 1MB text | 0.1222s | 0.0112s | **10.9x** |
| od | default 10MB binary | 0.6651s | 0.0905s | **7.3x** |
| od | -N 10000 10MB | 0.0021s | 0.0019s | **1.1x** |
| paste | 2 columns 10MB | 0.0239s | 0.0075s | **3.2x** |
| paste | 3 columns 10MB | 0.0306s | 0.0156s | **2.0x** |
| paste | -d comma 10MB | 0.0235s | 0.0074s | **3.2x** |
| paste | -s 10MB single file | 0.0105s | 0.0047s | **2.2x** |
| paste | stdin split 2-way 10MB | 0.0303s | 0.0078s | **3.9x** |
| pathchk | pathchk default | 0.0008s | 0.0010s | 0.9x |
| pathchk | pathchk -p (POSIX portable) | 0.0008s | 0.0009s | 0.9x |
| pinky | pinky (default) | 0.0008s | 0.0010s | 0.9x |
| pinky | pinky -l | - | - | - |
| pr | pr 1MB text | 0.0105s | 0.0015s | **7.2x** |
| pr | -2 (two columns) 1MB | 0.0115s | 0.0018s | **6.4x** |
| pr | -3 (three columns) 1MB | 0.0086s | 0.0017s | **5.1x** |
| pr | -n 1MB text | 0.0117s | 0.0018s | **6.3x** |
| pr | -t 1MB text | 0.0100s | 0.0015s | **6.7x** |
| printenv | printenv (all) | 0.0009s | 0.0010s | 0.9x |
...
| ptx | ptx 10KB text | 0.0020s | 0.0017s | **1.2x** |
| ptx | ptx 100KB text | 0.0112s | 0.0064s | **1.8x** |
| ptx | -w 60 100KB text | 0.0102s | 0.0055s | **1.9x** |
...
| rev | reverse CSV 10MB | 0.0994s | 0.0072s | **13.9x** |
| rev | reverse repetitive 10MB | 0.2868s | 0.0125s | **23.0x** |
| rev | reverse 10KB single line | 0.0010s | 0.0009s | **1.1x** |
| rm | rm single file | 0.0022s | 0.0024s | 0.9x |
| rm | rm -rf directory | 0.0090s | 0.0082s | **1.1x** |
| rmdir | rmdir single empty directory | 0.0019s | 0.0020s | 0.9x |
| rmdir | rmdir -p nested directories | - | - | - |
| seq | seq 1000000 | 0.0111s | 0.0025s | **4.4x** |
| seq | seq 1 10000000 | 0.0944s | 0.0129s | **7.3x** |
| seq | seq 0 0.1 100000 (float) | 0.2145s | 0.0192s | **11.2x** |
| seq | seq -w 1 1000000 (zero-padded) | 0.2279s | 0.0148s | **15.4x** |
| sha1sum | single 1MB text | 0.0019s | 0.0017s | **1.2x** |
| sha1sum | single 10MB text | 0.0079s | 0.0078s | **1.0x** |
...
| sha224sum | single 10MB text | 0.0088s | 0.0084s | **1.0x** |
...
| sha256sum | single 10MB binary | 0.0090s | 0.0090s | **1.0x** |
...
| sha384sum | single 10MB text | 0.0166s | 0.0172s | **1.0x** |
| sha384sum | single 10MB binary | 0.0164s | 0.0176s | 0.9x |
| sha512sum | single 1MB text | 0.0027s | 0.0040s | 0.7x |
| sha512sum | single 10MB text | 0.0159s | 0.0174s | 0.9x |
| sha512sum | single 10MB binary | 0.0165s | 0.0178s | 0.9x |
| shred | shred 1MB file | 0.1350s | 0.0070s | **19.4x** |
| shred | shred 1MB file with remove (-u) | 0.0182s | 0.0079s | **2.3x** |
| shuf | shuf 1MB text | 0.0021s | 0.0015s | **1.4x** |
| shuf | shuf 10MB text | 0.0126s | 0.0052s | **2.4x** |
| shuf | -n 100 from 10MB | 0.0271s | 0.0033s | **8.2x** |
| shuf | -n 10000 from 10MB | 0.0292s | 0.0032s | **9.3x** |
| shuf | -i 1-1000000 | 0.0686s | 0.0161s | **4.3x** |
...
| sort | lexicographic 10MB random | 0.0715s | 0.0104s | **6.9x** |
| sort | already sorted 10MB | 0.0357s | 0.0061s | **5.9x** |
| sort | reverse sorted 10MB | 0.0276s | 0.0067s | **4.1x** |
| sort | -n numeric 10MB | 0.0738s | 0.0059s | **12.6x** |
| sort | -r reverse 10MB | 0.0548s | 0.0098s | **5.6x** |
| sort | -u unique 10MB | 0.0580s | 0.0098s | **5.9x** |
| sort | -t, -k2 CSV 10MB | 0.0668s | 0.0406s | **1.6x** |
| sort | repetitive 10MB | 0.0560s | 0.0130s | **4.3x** |
| sort | --parallel=4 10MB | 0.0544s | 0.0094s | **5.8x** |
| split | split 10MB into 1MB chunks (-b 1m) | 0.0105s | 0.0071s | **1.5x** |
| split | split 10MB by 1000 lines (-l 1000) | 0.0172s | 0.0175s | **1.0x** |
...
| sum | single 10MB text | 0.0178s | 0.0153s | **1.2x** |
...
| tac | reverse CSV 10MB | 0.0092s | 0.0047s | **1.9x** |
| tac | reverse repetitive 10MB | 0.0235s | 0.0093s | **2.5x** |
...
| tail | -n 100000 10MB | 0.0065s | 0.0033s | **2.0x** |
| tail | -n +100 10MB (from line 100) | 0.0041s | 0.0022s | **1.9x** |
| tail | -n +100000 10MB (from line 100000) | 0.0041s | 0.0034s | **1.2x** |
| tail | -c 1000000 10MB | 0.0012s | 0.0012s | **1.0x** |
| tail | 100 small files | 0.0019s | 0.0022s | 0.8x |
| tee | tee 1MB to /dev/null | 0.0018s | 0.0017s | **1.0x** |
| tee | tee 10MB to /dev/null | 0.0071s | 0.0053s | **1.3x** |
...
| timeout | timeout 10 true | 0.0017s | 0.0020s | 0.9x |
...
| tr | a-z to A-Z 10MB | 0.0194s | 0.0035s | **5.5x** |
| tr | -d digits 10MB | 0.0180s | 0.0041s | **4.3x** |
| tr | -d lowercase 10MB | 0.0324s | 0.0047s | **6.8x** |
| tr | -s spaces 10MB | 0.0275s | 0.0035s | **7.8x** |
| tr | [:lower:] to [:upper:] 10MB | 0.0124s | 0.0037s | **3.4x** |
| tr | -d [:digit:] 10MB CSV | 0.0164s | 0.0042s | **3.9x** |
| tr | translate binary 10MB | 0.0121s | 0.0038s | **3.2x** |
...
| tsort | tsort 100K pairs | 0.0576s | 0.0074s | **7.8x** |
| tsort | tsort 1M pairs | 0.6513s | 0.0641s | **10.2x** |
...
| unexpand | unexpand 10MB text | 0.0234s | 0.0029s | **8.0x** |
| unexpand | -a 1MB text | 0.0091s | 0.0012s | **7.3x** |
| unexpand | -a 10MB text | 0.0834s | 0.0026s | **32.7x** |
| unexpand | -t 4 10MB text | 0.0838s | 0.0026s | **32.4x** |
| unexpand | expand|unexpand pipeline 10MB | 0.1295s | 0.0846s | **1.5x** |
| uniq | default 10MB many duplicates | 0.0126s | 0.0019s | **6.6x** |
| uniq | default 10MB sorted (low dup) | 0.0204s | 0.0037s | **5.5x** |
| uniq | -c count 10MB many dups | 0.0146s | 0.0018s | **8.2x** |
| uniq | -c count 10MB sorted | 0.0292s | 0.0077s | **3.8x** |
| uniq | -d duplicates only 10MB | 0.0121s | 0.0019s | **6.4x** |
| uniq | -u unique only 10MB | 0.0120s | 0.0020s | **6.1x** |
| uniq | -i case insensitive 10MB | 0.0139s | 0.0044s | **3.2x** |
| uniq | repetitive 10MB | 0.0421s | 0.0035s | **11.9x** |
...
| wc | default 10MB text | 0.0547s | 0.0032s | **16.8x** |
| wc | -l 10MB text | 0.0021s | 0.0021s | **1.0x** |
| wc | -w 10MB text | 0.0546s | 0.0137s | **4.0x** |
| wc | -c 10MB text | 0.0009s | 0.0011s | 0.8x |
| wc | -m 10MB text | 0.0546s | 0.0031s | **17.6x** |
| wc | -L 10MB text | 0.0545s | 0.0101s | **5.4x** |
| wc | default 10MB binary | 0.3161s | 0.0278s | **11.4x** |
| wc | default 10MB repetitive | 0.0736s | 0.0047s | **15.6x** |
...
| yes | throughput 1M lines | 0.0031s | 0.0036s | 0.9x |
| yes | throughput 10M lines | 0.0266s | 0.0339s | 0.8x |
| yes | throughput hello 1M lines | 0.0071s | 0.0075s | 0.9x |
| yes | throughput hello 10M lines | 0.0536s | 0.0622s | 0.9x |
| yes | throughput 100MB | 0.0461s | 0.0547s | 0.8x |
