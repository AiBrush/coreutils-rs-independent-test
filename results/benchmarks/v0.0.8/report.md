...
|------|------|-----------|-------------------|---------|
| wc | default 100KB text | 0.0017s | 0.0017s | **1.0x** |
| wc | default 1MB text | 0.0042s | 0.0021s | **2.0x** |
| wc | default 10MB text | 0.0288s | 0.0042s | **6.8x** |
| wc | default 100MB text | 0.2717s | 0.0220s | **12.4x** |
| wc | -l 10MB text | 0.0061s | 0.0030s | **2.0x** |
| wc | -w 10MB text | 0.0396s | 0.0058s | **6.8x** |
| wc | -c 10MB text | 0.0021s | 0.0022s | **1.0x** |
| wc | -m 10MB text | 0.0303s | 0.0050s | **6.1x** |
| wc | -L 10MB text | 0.0465s | 0.0177s | **2.6x** |
| wc | default 10MB binary | 0.1478s | 0.0054s | **27.3x** |
| wc | default 10MB repetitive | 0.0419s | 0.0061s | **6.8x** |
| wc | 10 files | 0.0020s | 0.0020s | **1.0x** |
| wc | 100 files | 0.0041s | 0.0043s | **0.9x** |
| cut | -b1-100 10MB CSV | 0.0287s | 0.0040s | **7.2x** |
| cut | -c1-100 10MB CSV | 0.0380s | 0.0043s | **8.9x** |
| cut | -d, -f1 10MB CSV | 0.0172s | 0.0120s | **1.4x** |
| cut | -d, -f1,3,5 10MB CSV | 0.0409s | 0.0038s | **10.9x** |
| cut | -d, -f2-4 10MB CSV | 0.0313s | 0.0031s | **10.2x** |
| cut | --complement -d, -f1 10MB CSV | 0.0463s | 0.0091s | **5.1x** |
| cut | -d, -f1 100KB text | 0.0016s | 0.0021s | **0.8x** |
| cut | -d, -f1 1MB text | 0.0041s | 0.0026s | **1.6x** |
| cut | -d: -f1 colon file | 0.0019s | 0.0045s | **0.4x** |
| sha256sum | single 100KB text | 0.0019s | 0.0020s | **1.0x** |
| sha256sum | single 1MB text | 0.0052s | 0.0048s | **1.1x** |
| sha256sum | single 10MB text | 0.0519s | 0.0338s | **1.5x** |
| sha256sum | single 10MB binary | 0.0476s | 0.0345s | **1.4x** |
| sha256sum | single 100MB text | 0.3745s | 0.3115s | **1.2x** |
| sha256sum | 10 files | 0.0018s | 0.0022s | **0.8x** |
| sha256sum | 100 files | 0.0037s | 0.0036s | **1.0x** |
| md5sum | single 100KB text | 0.0020s | 0.0024s | **0.8x** |
| md5sum | single 1MB text | 0.0041s | 0.0035s | **1.1x** |
| md5sum | single 10MB text | 0.0201s | 0.0212s | **0.9x** |
| md5sum | single 10MB binary | 0.0328s | 0.0215s | **1.5x** |
| md5sum | single 100MB text | 0.1809s | 0.1840s | **1.0x** |
| md5sum | 10 files | 0.0023s | 0.0022s | **1.0x** |
| md5sum | 100 files | 0.0041s | 0.0034s | **1.2x** |
| b2sum | single 100KB text | 0.0014s | 0.0011s | **1.3x** |
| b2sum | single 1MB text | 0.0033s | 0.0026s | **1.3x** |
| b2sum | single 10MB text | 0.0178s | 0.0131s | **1.4x** |
| b2sum | single 10MB binary | 0.0288s | 0.0129s | **2.2x** |
| b2sum | single 100MB text | 0.1726s | 0.1127s | **1.5x** |
| b2sum | -l 256 10MB | 0.0194s | 0.0125s | **1.6x** |
| b2sum | -l 128 10MB | 0.0183s | 0.0135s | **1.4x** |
| b2sum | 100 files | 0.0041s | 0.0037s | **1.1x** |
| base64 | encode 100KB text | 0.0026s | 0.0018s | **1.4x** |
| base64 | encode 1MB text | 0.0031s | 0.0023s | **1.3x** |
| base64 | encode 10MB text | 0.0153s | 0.0054s | **2.8x** |
| base64 | encode 10MB binary | 0.0162s | 0.0070s | **2.3x** |
| base64 | decode 1MB | 0.0043s | 0.0033s | **1.3x** |
| base64 | decode 10MB | 0.0282s | 0.0136s | **2.1x** |
| base64 | encode -w 76 10MB | 0.0153s | 0.0058s | **2.6x** |
| base64 | encode -w 0 (no wrap) 10MB | 0.0076s | 0.0048s | **1.6x** |
| sort | lexicographic 1MB | 0.1109s | 0.0047s | **23.5x** |
| sort | lexicographic 10MB random | 0.4004s | 0.0169s | **23.7x** |
| sort | already sorted 10MB | 0.2177s | 0.0147s | **14.8x** |
| sort | reverse sorted 10MB | 0.2117s | 0.0120s | **17.7x** |
| sort | -n numeric 10MB | 0.4842s | 0.0321s | **15.1x** |
| sort | -r reverse 10MB | 0.4038s | 0.0152s | **26.5x** |
| sort | -u unique 10MB | 0.4373s | 0.0163s | **26.8x** |
| sort | -t, -k2 CSV 10MB | 0.5772s | 0.0265s | **21.8x** |
| sort | repetitive 10MB | 0.0554s | 0.0198s | **2.8x** |
| sort | --parallel=4 10MB | 0.3910s | 0.0607s | **6.4x** |
| tr | a-z to A-Z 1MB | 0.0442s | 0.0191s | **2.3x** |
| tr | a-z to A-Z 10MB | 0.0332s | 0.0000s | **874.4x** |
| tr | -d digits 10MB | 0.0210s | 0.0177s | **1.2x** |
| tr | -d lowercase 10MB | 0.0350s | 0.0296s | **1.2x** |
| tr | -s spaces 10MB | 0.0438s | 0.0289s | **1.5x** |
| tr | [:lower:] to [:upper:] 10MB | 0.0157s | 0.0113s | **1.4x** |
| tr | -d [:digit:] 10MB CSV | 0.0195s | 0.0187s | **1.0x** |
| tr | translate binary 10MB | 0.0158s | 0.0121s | **1.3x** |
| uniq | default 10MB many duplicates | 0.0107s | 0.0060s | **1.8x** |
| uniq | default 10MB sorted (low dup) | 0.0174s | 0.0068s | **2.6x** |
| uniq | -c count 10MB many dups | 0.0109s | 0.0060s | **1.8x** |
| uniq | -c count 10MB sorted | 0.0323s | 0.0083s | **3.9x** |
| uniq | -d duplicates only 10MB | 0.0108s | 0.0061s | **1.8x** |
| uniq | -u unique only 10MB | 0.0108s | 0.0057s | **1.9x** |
| uniq | -i case insensitive 10MB | 0.0188s | 0.0076s | **2.5x** |
| uniq | repetitive 10MB | 0.0370s | 0.0088s | **4.2x** |
| tac | reverse 100KB text | 0.0017s | 0.0017s | **1.0x** |
| tac | reverse 1MB text | 0.0028s | 0.0019s | **1.5x** |
| tac | reverse 10MB text | 0.0146s | 0.0079s | **1.9x** |
| tac | reverse 100MB text | 0.1296s | 0.0602s | **2.2x** |
| tac | reverse CSV 10MB | 0.0133s | 0.0079s | **1.7x** |
| tac | reverse repetitive 10MB | 0.0283s | 0.0134s | **2.1x** |
| tac | custom separator 1MB | 0.0074s | 0.0058s | **1.3x** |
