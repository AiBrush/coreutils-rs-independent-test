...
Generated: 2026-02-28 21:51:46 UTC
...
| b2sum | single 10MB text | 0.0154s | 0.0122s | **1.3x** |
| b2sum | single 10MB binary | 0.0155s | 0.0129s | **1.2x** |
| b2sum | single 100MB text | 0.1415s | 0.1115s | **1.3x** |
...
| base32 | encode 10MB text | 0.0144s | 0.0121s | **1.2x** |
| base32 | encode 10MB binary | 0.0164s | 0.0140s | **1.2x** |
| base32 | decode 1MB | 0.0036s | 0.0025s | **1.5x** |
| base32 | decode 10MB | 0.0275s | 0.0164s | **1.7x** |
...
| base64 | encode 10MB binary | 0.0129s | 0.0055s | **2.3x** |
| base64 | decode 1MB | 0.0040s | 0.0021s | **1.9x** |
| base64 | decode 10MB | 0.0323s | 0.0047s | **6.8x** |
...
| basenc | encode --base64 10MB | 0.0121s | 0.0047s | **2.6x** |
...
| cat | passthrough 10MB | 0.0014s | 0.0013s | **1.1x** |
| cat | passthrough 100MB | 0.0087s | 0.0035s | **2.5x** |
| cat | -n 1MB | 0.0021s | 0.0018s | **1.1x** |
| cat | -n 10MB | 0.0101s | 0.0060s | **1.7x** |
| cat | -b 10MB | 0.0101s | 0.0059s | **1.7x** |
...
| chmod | chmod 644 on file | 0.0021s | 0.0022s | 0.9x |
...
| cksum | single 10MB binary | 0.0028s | 0.0030s | 0.9x |
| comm | default 10MB sorted | 0.0234s | 0.0070s | **3.4x** |
| comm | -12 (common only) 10MB | 0.0202s | 0.0055s | **3.7x** |
| comm | -23 (unique to file1) 10MB | 0.0207s | 0.0057s | **3.6x** |
| comm | -3 10MB | 0.0224s | 0.0066s | **3.4x** |
| comm | identical 10MB sorted | 0.0296s | 0.0111s | **2.7x** |
| cp | cp 1MB file | 0.0028s | 0.0026s | **1.1x** |
| cp | cp 10MB file | 0.0100s | 0.0101s | **1.0x** |
| cp | cp -r directory (many_files) | 0.0072s | 0.0063s | **1.1x** |
| csplit | csplit 1MB by pattern | 0.4477s | 0.0246s | **18.2x** |
| cut | -b1-100 10MB CSV | 0.0224s | 0.0039s | **5.8x** |
| cut | -c1-100 10MB CSV | 0.0223s | 0.0039s | **5.8x** |
| cut | -d, -f1 10MB CSV | 0.0164s | 0.0094s | **1.7x** |
| cut | -d, -f1,3,5 10MB CSV | 0.0220s | 0.0112s | **2.0x** |
| cut | -d, -f2-4 10MB CSV | 0.0241s | 0.0104s | **2.3x** |
| cut | --complement -d, -f1 10MB CSV | 0.0305s | 0.0107s | **2.8x** |
...
| expand | expand 10MB tabbed (default) | 0.0446s | 0.0351s | **1.3x** |
| expand | expand 1MB text | 0.0033s | 0.0011s | **3.1x** |
| expand | -t 4 10MB tabbed | 0.0417s | 0.0354s | **1.2x** |
| expand | -t 2 10MB tabbed | 0.0357s | 0.0351s | **1.0x** |
| expand | --initial 10MB tabbed | 0.0231s | 0.0066s | **3.5x** |
| expand | expand CSV 10MB | 0.0189s | 0.0018s | **10.8x** |
...
| fold | fold 10MB wide lines (default) | 0.0336s | 0.0056s | **6.0x** |
| fold | fold 1MB text | 0.0042s | 0.0018s | **2.4x** |
| fold | fold 10MB text | 0.0345s | 0.0078s | **4.4x** |
| fold | -w 40 10MB | 0.0349s | 0.0062s | **5.7x** |
| fold | -w 20 10MB | 0.0356s | 0.0071s | **5.0x** |
| fold | -s -w 60 10MB | 0.0381s | 0.0063s | **6.0x** |
| fold | -s -w 40 10MB | 0.0401s | 0.0067s | **5.9x** |
| fold | -b -w 40 10MB | 0.0326s | 0.0059s | **5.5x** |
...
| join | self-join sorted 10MB | 0.0459s | 0.0377s | **1.2x** |
...
| md5sum | single 1MB text | 0.0028s | 0.0040s | 0.7x |
| md5sum | single 10MB text | 0.0169s | 0.0186s | 0.9x |
| md5sum | single 10MB binary | 0.0177s | 0.0195s | 0.9x |
| md5sum | single 100MB text | 0.1595s | 0.1608s | **1.0x** |
...
| mv | mv 10MB file | 0.0110s | 0.0111s | **1.0x** |
...
| nl | default 10MB | 0.0355s | 0.0067s | **5.3x** |
| nl | -b a 10MB | 0.0355s | 0.0067s | **5.3x** |
| nl | -b a 10MB with blanks | 0.0454s | 0.0090s | **5.0x** |
| nl | -b a -n rz 10MB | 0.0355s | 0.0068s | **5.3x** |
| nl | -b a -w 8 -s ': ' 10MB | 0.0358s | 0.0071s | **5.0x** |
| nl | -b p'^the' 10MB | 0.0594s | 0.0117s | **5.1x** |
| nohup | nohup true | 0.0021s | 0.0022s | **1.0x** |
| nproc | nproc (no args) | 0.0008s | 0.0010s | 0.8x |
| nproc | nproc --all | 0.0008s | 0.0009s | 0.9x |
| paste | 2 columns 10MB | 0.0235s | 0.0087s | **2.7x** |
| paste | 3 columns 10MB | 0.0304s | 0.0138s | **2.2x** |
| paste | -d comma 10MB | 0.0235s | 0.0087s | **2.7x** |
| paste | -s 10MB single file | 0.0105s | 0.0053s | **2.0x** |
| paste | stdin split 2-way 10MB | 0.0310s | 0.0182s | **1.7x** |
...
| rev | reverse 1MB text | 0.0143s | 0.0017s | **8.3x** |
| rev | reverse 10MB text | 0.1335s | 0.0075s | **17.9x** |
| rev | reverse 100MB text | 1.3311s | 0.0697s | **19.1x** |
| rev | reverse CSV 10MB | 0.1088s | 0.0070s | **15.5x** |
| rev | reverse repetitive 10MB | 0.2866s | 0.0122s | **23.5x** |
...
| seq | seq 1 10000000 | 0.0957s | 0.0137s | **7.0x** |
| seq | seq 0 0.1 100000 (float) | 0.2304s | 0.0188s | **12.3x** |
| seq | seq -w 1 1000000 (zero-padded) | 0.2414s | 0.0154s | **15.7x** |
| sha1sum | single 1MB text | 0.0019s | 0.0032s | 0.6x |
| sha1sum | single 10MB text | 0.0079s | 0.0096s | 0.8x |
| sha1sum | single 10MB binary | 0.0085s | 0.0102s | 0.8x |
...
| sha224sum | single 10MB binary | 0.0087s | 0.0104s | 0.8x |
| sha256sum | single 100KB text | 0.0013s | 0.0026s | 0.5x |
| sha256sum | single 1MB text | 0.0020s | 0.0033s | 0.6x |
| sha256sum | single 10MB text | 0.0083s | 0.0099s | 0.8x |
| sha256sum | single 10MB binary | 0.0087s | 0.0106s | 0.8x |
| sha256sum | single 100MB text | 0.0737s | 0.0751s | **1.0x** |
...
| sha384sum | single 10MB text | 0.0152s | 0.0169s | 0.9x |
| sha384sum | single 10MB binary | 0.0160s | 0.0180s | 0.9x |
| sha512sum | single 1MB text | 0.0027s | 0.0039s | 0.7x |
| sha512sum | single 10MB text | 0.0153s | 0.0169s | 0.9x |
| sha512sum | single 10MB binary | 0.0161s | 0.0177s | 0.9x |
| shred | shred 1MB file | 0.0088s | 0.0059s | **1.5x** |
| shred | shred 1MB file with remove (-u) | 0.0175s | 0.0074s | **2.4x** |
...
| sort | lexicographic 10MB random | 0.0536s | 0.0089s | **6.0x** |
| sort | already sorted 10MB | 0.0262s | 0.0048s | **5.4x** |
| sort | reverse sorted 10MB | 0.0272s | 0.0066s | **4.1x** |
| sort | -n numeric 10MB | 0.0730s | 0.0057s | **12.8x** |
| sort | -r reverse 10MB | 0.0545s | 0.0091s | **6.0x** |
| sort | -u unique 10MB | 0.0607s | 0.0115s | **5.3x** |
| sort | -t, -k2 CSV 10MB | 0.0672s | 0.0399s | **1.7x** |
| sort | repetitive 10MB | 0.0558s | 0.0125s | **4.5x** |
| sort | --parallel=4 10MB | 0.0537s | 0.0092s | **5.9x** |
| split | split 10MB into 1MB chunks (-b 1m) | - | - | - |
| split | split 10MB by 1000 lines (-l 1000) | 0.0167s | 0.0177s | 0.9x |
...
| tac | reverse 10MB text | 0.0104s | 0.0053s | **2.0x** |
| tac | reverse 100MB text | 0.1025s | 0.0265s | **3.9x** |
| tac | reverse CSV 10MB | 0.0093s | 0.0051s | **1.8x** |
| tac | reverse repetitive 10MB | 0.0227s | 0.0095s | **2.4x** |
...
| tail | default 100MB text | 0.0009s | 0.0012s | 0.7x |
...
| tail | -n +100000 10MB (from line 100000) | 0.0039s | 0.0031s | **1.3x** |
| tail | -c 1000000 10MB | 0.0012s | 0.0011s | **1.1x** |
| tail | 100 small files | 0.0018s | 0.0024s | 0.7x |
| tee | tee 1MB to /dev/null | 0.0016s | 0.0017s | **1.0x** |
| tee | tee 10MB to /dev/null | 0.0069s | 0.0050s | **1.4x** |
...
| tr | a-z to A-Z 1MB | 0.0024s | 0.0015s | **1.5x** |
| tr | a-z to A-Z 10MB | 0.0138s | 0.0039s | **3.5x** |
| tr | -d digits 10MB | 0.0158s | 0.0042s | **3.8x** |
| tr | -d lowercase 10MB | 0.0319s | 0.0048s | **6.7x** |
| tr | -s spaces 10MB | 0.0264s | 0.0038s | **6.9x** |
| tr | [:lower:] to [:upper:] 10MB | 0.0125s | 0.0036s | **3.4x** |
| tr | -d [:digit:] 10MB CSV | 0.0176s | 0.0041s | **4.3x** |
...
| tsort | tsort 100K pairs | 0.0556s | 0.0071s | **7.8x** |
| tsort | tsort 1M pairs | 0.6540s | 0.0631s | **10.4x** |
...
| unexpand | unexpand 10MB text | 0.0221s | 0.0044s | **5.0x** |
| unexpand | -a 1MB text | 0.0088s | 0.0050s | **1.7x** |
| unexpand | -a 10MB text | 0.0829s | 0.0352s | **2.4x** |
| unexpand | -t 4 10MB text | 0.0828s | 0.0368s | **2.2x** |
| unexpand | expand|unexpand pipeline 10MB | 0.1125s | 0.1130s | **1.0x** |
| uniq | default 10MB many duplicates | 0.0117s | 0.0019s | **6.1x** |
| uniq | default 10MB sorted (low dup) | 0.0139s | 0.0031s | **4.5x** |
...
| uniq | repetitive 10MB | 0.0419s | 0.0036s | **11.8x** |
...
| wc | default 10MB text | 0.0539s | 0.0031s | **17.5x** |
| wc | default 100MB text | 0.4810s | 0.0135s | **35.6x** |
| wc | -l 10MB text | 0.0019s | 0.0024s | 0.8x |
| wc | -w 10MB text | 0.0539s | 0.0133s | **4.0x** |
| wc | -c 10MB text | 0.0009s | 0.0010s | 0.9x |
| wc | -m 10MB text | 0.0541s | 0.0029s | **18.5x** |
| wc | -L 10MB text | 0.0539s | 0.0097s | **5.6x** |
| wc | default 10MB binary | 0.3152s | 0.0269s | **11.7x** |
| wc | default 10MB repetitive | 0.0727s | 0.0044s | **16.7x** |
| wc | 10 files | 0.0010s | 0.0011s | 0.9x |
| wc | 100 files | 0.0019s | 0.0018s | **1.0x** |
| whoami | whoami (no args) | 0.0009s | 0.0010s | 0.9x |
| yes | startup --help | 0.0008s | 0.0002s | **3.9x** |
| yes | startup --version | 0.0009s | 0.0002s | **4.2x** |
| yes | throughput 1M lines | 0.0031s | 0.0031s | **1.0x** |
| yes | throughput 10M lines | 0.0221s | 0.0232s | **1.0x** |
| yes | throughput hello 1M lines | 0.0064s | 0.0065s | **1.0x** |
| yes | throughput hello 10M lines | 0.0511s | 0.0572s | 0.9x |
| yes | throughput 100MB | 0.0450s | 0.0432s | **1.0x** |
