...
|------|------|-----------|-------------------|---------|
| wc | default 100KB text | 0.0044s | 0.0025s | **1.8x** |
| wc | default 1MB text | 0.0041s | 0.0038s | **1.1x** |
| wc | default 10MB text | 0.0307s | 0.0257s | **1.2x** |
| wc | default 100MB text | 0.2896s | 0.0977s | **3.0x** |
| wc | -l 10MB text | 0.0082s | 0.0054s | **1.5x** |
| wc | -w 10MB text | 0.0409s | 0.0212s | **1.9x** |
| wc | -c 10MB text | 0.0038s | 0.0012s | **3.1x** |
| wc | -m 10MB text | 0.0275s | 0.0002s | **149.5x** |
| wc | -L 10MB text | 0.0291s | 0.0216s | **1.3x** |
| wc | default 10MB binary | 0.1385s | 0.0890s | **1.6x** |
| wc | default 10MB repetitive | 0.0426s | 0.0132s | **3.2x** |
| wc | 10 files | 0.0035s | 0.0057s | **0.6x** |
| wc | 100 files | 0.0056s | 0.0056s | **1.0x** |
| cut | -b1-100 10MB CSV | 0.0257s | 0.0050s | **5.2x** |
| cut | -c1-100 10MB CSV | 0.0270s | 0.0044s | **6.2x** |
| cut | -d, -f1 10MB CSV | 0.0205s | 0.0071s | **2.9x** |
| cut | -d, -f1,3,5 10MB CSV | 0.0376s | 0.0162s | **2.3x** |
| cut | -d, -f2-4 10MB CSV | 0.0375s | 0.0122s | **3.1x** |
| cut | --complement -d, -f1 10MB CSV | 0.0563s | 0.0166s | **3.4x** |
| cut | -d, -f1 100KB text | 0.0046s | 0.0040s | **1.2x** |
| cut | -d, -f1 1MB text | 0.0054s | 0.0053s | **1.0x** |
| cut | -d: -f1 colon file | 0.0050s | 0.0016s | **3.1x** |
| sha256sum | single 100KB text | 0.0041s | 0.0029s | **1.4x** |
| sha256sum | single 1MB text | 0.0034s | 0.0018s | **1.9x** |
| sha256sum | single 10MB text | 0.0421s | 0.0089s | **4.7x** |
| sha256sum | single 10MB binary | 0.0424s | 0.0083s | **5.1x** |
| sha256sum | single 100MB text | 0.3848s | 0.0567s | **6.8x** |
| sha256sum | 10 files | 0.0061s | 0.0082s | **0.8x** |
| sha256sum | 100 files | 0.0059s | 0.0065s | **0.9x** |
| md5sum | single 100KB text | 0.0041s | 0.0069s | **0.6x** |
| md5sum | single 1MB text | 0.0083s | 0.0058s | **1.4x** |
| md5sum | single 10MB text | 0.0230s | 0.0235s | **1.0x** |
| md5sum | single 10MB binary | 0.0237s | 0.0268s | **0.9x** |
| md5sum | single 100MB text | 0.1980s | 0.1805s | **1.1x** |
| md5sum | 10 files | 0.0016s | 0.0033s | **0.5x** |
| md5sum | 100 files | 0.0044s | 0.0041s | **1.1x** |
| b2sum | single 100KB text | 0.0018s | 0.0048s | **0.4x** |
| b2sum | single 1MB text | 0.0038s | 0.0032s | **1.2x** |
| b2sum | single 10MB text | 0.0178s | 0.0136s | **1.3x** |
| b2sum | single 10MB binary | 0.0219s | 0.0125s | **1.7x** |
| b2sum | single 100MB text | 0.1597s | 0.1226s | **1.3x** |
| b2sum | -l 256 10MB | 0.0224s | 0.0167s | **1.3x** |
| b2sum | -l 128 10MB | 0.0168s | 0.0167s | **1.0x** |
| b2sum | 100 files | 0.0068s | 0.0048s | **1.4x** |
| base64 | encode 100KB text | 0.0043s | 0.0024s | **1.8x** |
| base64 | encode 1MB text | 0.0080s | 0.0051s | **1.6x** |
| base64 | encode 10MB text | 0.0245s | 0.0047s | **5.2x** |
| base64 | encode 10MB binary | 0.0191s | 0.0069s | **2.8x** |
| base64 | decode 1MB | 0.0070s | 0.0041s | **1.7x** |
| base64 | decode 10MB | 0.0357s | 0.0106s | **3.4x** |
| base64 | encode -w 76 10MB | 0.0177s | 0.0054s | **3.2x** |
| base64 | encode -w 0 (no wrap) 10MB | 0.0068s | 0.0034s | **2.0x** |
| sort | lexicographic 1MB | 0.1001s | 0.0034s | **29.4x** |
| sort | lexicographic 10MB random | 0.4373s | 0.0181s | **24.2x** |
| sort | already sorted 10MB | 0.3147s | 0.0192s | **16.4x** |
| sort | reverse sorted 10MB | 0.2990s | 0.0121s | **24.6x** |
| sort | -n numeric 10MB | 0.5321s | 0.0294s | **18.1x** |
| sort | -r reverse 10MB | 0.5535s | 0.0238s | **23.2x** |
| sort | -u unique 10MB | 0.5427s | 0.0204s | **26.6x** |
| sort | -t, -k2 CSV 10MB | 0.6399s | 0.0457s | **14.0x** |
| sort | repetitive 10MB | 0.0762s | 0.0223s | **3.4x** |
| sort | --parallel=4 10MB | 0.5192s | 0.0152s | **34.3x** |
| tr | a-z to A-Z 1MB | 0.0083s | 0.0047s | **1.8x** |
| tr | a-z to A-Z 10MB | 0.0262s | 0.0086s | **3.0x** |
| tr | -d digits 10MB | 0.0323s | 0.0129s | **2.5x** |
| tr | -d lowercase 10MB | 0.0394s | 0.0221s | **1.8x** |
| tr | -s spaces 10MB | 0.0507s | 0.0198s | **2.6x** |
| tr | [:lower:] to [:upper:] 10MB | 0.0278s | 0.0175s | **1.6x** |
| tr | -d [:digit:] 10MB CSV | 0.0295s | 0.0157s | **1.9x** |
| tr | translate binary 10MB | 0.0341s | 0.0154s | **2.2x** |
| uniq | default 10MB many duplicates | 0.0118s | 0.0055s | **2.2x** |
| uniq | default 10MB sorted (low dup) | 0.0242s | 0.0064s | **3.8x** |
| uniq | -c count 10MB many dups | 0.0134s | 0.0075s | **1.8x** |
| uniq | -c count 10MB sorted | 0.0369s | 0.0167s | **2.2x** |
| uniq | -d duplicates only 10MB | 0.0112s | 0.0104s | **1.1x** |
| uniq | -u unique only 10MB | 0.0151s | 0.0097s | **1.6x** |
| uniq | -i case insensitive 10MB | 0.0231s | 0.0099s | **2.3x** |
| uniq | repetitive 10MB | 0.0389s | 0.0077s | **5.1x** |
| tac | reverse 100KB text | 0.0023s | 0.0037s | **0.6x** |
| tac | reverse 1MB text | 0.0039s | 0.0028s | **1.4x** |
| tac | reverse 10MB text | 0.0160s | 0.0091s | **1.8x** |
| tac | reverse 100MB text | 0.1351s | 0.0598s | **2.3x** |
| tac | reverse CSV 10MB | 0.0148s | 0.0071s | **2.1x** |
| tac | reverse repetitive 10MB | 0.0346s | 0.0127s | **2.7x** |
| tac | custom separator 1MB | 0.0168s | 0.0086s | **2.0x** |
