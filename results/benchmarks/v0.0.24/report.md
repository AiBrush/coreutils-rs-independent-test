...
|------|------|-----------|-------------------|---------|
| wc | default 100KB text | 0.0024s | 0.0026s | **0.9x** |
| wc | default 1MB text | 0.0053s | 0.0047s | **1.1x** |
| wc | default 10MB text | 0.0337s | 0.0223s | **1.5x** |
| wc | default 100MB text | 0.2502s | 0.0737s | **3.4x** |
| wc | -l 10MB text | 0.0061s | 0.0033s | **1.9x** |
| wc | -w 10MB text | 0.0345s | 0.0365s | **0.9x** |
| wc | -c 10MB text | 0.0004s | 0.0004s | **1.0x** |
| wc | -m 10MB text | 0.0356s | 0.0052s | **6.9x** |
| wc | -L 10MB text | 0.0322s | 0.0184s | **1.7x** |
| wc | default 10MB binary | 0.1588s | 0.0944s | **1.7x** |
| wc | default 10MB repetitive | 0.0501s | 0.0132s | **3.8x** |
| wc | 10 files | 0.0067s | 0.0045s | **1.5x** |
| wc | 100 files | 0.0072s | 0.0059s | **1.2x** |
| cut | -b1-100 10MB CSV | 0.0284s | 0.0083s | **3.4x** |
| cut | -c1-100 10MB CSV | 0.0267s | 0.0078s | **3.4x** |
| cut | -d, -f1 10MB CSV | 0.0169s | 0.0013s | **12.5x** |
| cut | -d, -f1,3,5 10MB CSV | 0.0291s | 0.0093s | **3.1x** |
| cut | -d, -f2-4 10MB CSV | 0.0320s | 0.0078s | **4.1x** |
| cut | --complement -d, -f1 10MB CSV | 0.0479s | 0.0129s | **3.7x** |
| cut | -d, -f1 100KB text | 0.0016s | 0.0016s | **1.0x** |
| cut | -d, -f1 1MB text | 0.0070s | 0.0021s | **3.4x** |
| cut | -d: -f1 colon file | 0.0029s | 0.0029s | **1.0x** |
| sha256sum | single 100KB text | 0.0033s | 0.0023s | **1.4x** |
| sha256sum | single 1MB text | 0.0058s | 0.0051s | **1.1x** |
| sha256sum | single 10MB text | 0.0405s | 0.0100s | **4.1x** |
| sha256sum | single 10MB binary | 0.0386s | 0.0093s | **4.2x** |
| sha256sum | single 100MB text | 0.3586s | 0.0534s | **6.7x** |
| sha256sum | 10 files | 0.0024s | 0.0024s | **1.0x** |
| sha256sum | 100 files | 0.0042s | 0.0043s | **1.0x** |
| md5sum | single 100KB text | 0.0023s | 0.0020s | **1.2x** |
| md5sum | single 1MB text | 0.0051s | 0.0038s | **1.4x** |
| md5sum | single 10MB text | 0.0208s | 0.0196s | **1.1x** |
| md5sum | single 10MB binary | 0.0207s | 0.0197s | **1.1x** |
| md5sum | single 100MB text | 0.1877s | 0.2298s | **0.8x** |
| md5sum | 10 files | 0.0001s | 0.0056s | - |
| md5sum | 100 files | 0.0093s | 0.0051s | **1.8x** |
| b2sum | single 100KB text | 0.0028s | 0.0039s | **0.7x** |
| b2sum | single 1MB text | 0.0044s | 0.0051s | **0.9x** |
| b2sum | single 10MB text | 0.0202s | 0.0138s | **1.5x** |
| b2sum | single 10MB binary | 0.0188s | 0.0144s | **1.3x** |
| b2sum | single 100MB text | 0.1583s | 0.1108s | **1.4x** |
| b2sum | -l 256 10MB | 0.0179s | 0.0129s | **1.4x** |
| b2sum | -l 128 10MB | 0.0186s | 0.0124s | **1.5x** |
| b2sum | 100 files | 0.0040s | 0.0046s | **0.9x** |
| base64 | encode 100KB text | 0.0035s | 0.0033s | **1.1x** |
| base64 | encode 1MB text | 0.0058s | 0.0034s | **1.7x** |
| base64 | encode 10MB text | 0.0212s | 0.0075s | **2.8x** |
| base64 | encode 10MB binary | 0.0212s | 0.0022s | **9.5x** |
| base64 | decode 1MB | 0.0083s | 0.0095s | **0.9x** |
| base64 | decode 10MB | 0.0329s | 0.0149s | **2.2x** |
| base64 | encode -w 76 10MB | 0.0212s | 0.0062s | **3.4x** |
| base64 | encode -w 0 (no wrap) 10MB | 0.0077s | 0.0039s | **2.0x** |
| sort | lexicographic 1MB | 0.1203s | 0.0056s | **21.3x** |
| sort | lexicographic 10MB random | 0.4316s | 0.0235s | **18.3x** |
| sort | already sorted 10MB | 0.2246s | 0.0114s | **19.8x** |
| sort | reverse sorted 10MB | 0.2575s | 0.0128s | **20.1x** |
| sort | -n numeric 10MB | 0.5005s | 0.0096s | **52.3x** |
| sort | -r reverse 10MB | 0.4273s | 0.0225s | **19.0x** |
| sort | -u unique 10MB | 0.5479s | 0.0271s | **20.2x** |
| sort | -t, -k2 CSV 10MB | 0.5710s | 0.0279s | **20.4x** |
| sort | repetitive 10MB | 0.0538s | 0.0151s | **3.6x** |
| sort | --parallel=4 10MB | 0.5122s | 0.0274s | **18.7x** |
| tr | a-z to A-Z 1MB | 0.0094s | 0.0033s | **2.9x** |
| tr | a-z to A-Z 10MB | 0.0243s | 0.0047s | **5.2x** |
| tr | -d digits 10MB | 0.0185s | 0.0120s | **1.5x** |
| tr | -d lowercase 10MB | 0.0348s | 0.0242s | **1.4x** |
| tr | -s spaces 10MB | 0.0533s | 0.0182s | **2.9x** |
| tr | [:lower:] to [:upper:] 10MB | 0.0169s | 0.0099s | **1.7x** |
| tr | -d [:digit:] 10MB CSV | 0.0227s | 0.0143s | **1.6x** |
| tr | translate binary 10MB | 0.0162s | 0.0068s | **2.4x** |
| uniq | default 10MB many duplicates | 0.0116s | 0.0086s | **1.4x** |
| uniq | default 10MB sorted (low dup) | 0.0196s | 0.0067s | **2.9x** |
| uniq | -c count 10MB many dups | 0.0118s | 0.0107s | **1.1x** |
| uniq | -c count 10MB sorted | 0.0329s | 0.0135s | **2.4x** |
| uniq | -d duplicates only 10MB | 0.0124s | 0.0120s | **1.0x** |
| uniq | -u unique only 10MB | 0.0133s | 0.0120s | **1.1x** |
| uniq | -i case insensitive 10MB | 0.0231s | 0.0126s | **1.8x** |
| uniq | repetitive 10MB | 0.0431s | 0.0109s | **3.9x** |
| tac | reverse 100KB text | 0.0032s | 0.0030s | **1.1x** |
| tac | reverse 1MB text | 0.0046s | 0.0024s | **1.9x** |
| tac | reverse 10MB text | 0.0150s | 0.0085s | **1.8x** |
| tac | reverse 100MB text | 0.1217s | 0.0460s | **2.6x** |
| tac | reverse CSV 10MB | 0.0111s | 0.0054s | **2.0x** |
| tac | reverse repetitive 10MB | 0.0271s | 0.0142s | **1.9x** |
| tac | custom separator 1MB | 0.0111s | 0.0079s | **1.4x** |
