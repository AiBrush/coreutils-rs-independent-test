# fcoreutils v0.20.9 — Detailed Results

Generated: 2026-03-13 21:07:59 UTC
...
| Linux_x86_64 | 3911 | 3794 | 17 | 97.0% |
...
| b2sum | single 10MB text | 0.0168s | 0.0132s | **1.3x** |
| b2sum | single 10MB binary | 0.0156s | 0.0128s | **1.2x** |
| b2sum | -l 256 10MB | 0.0149s | 0.0125s | **1.2x** |
| b2sum | -l 128 10MB | 0.0158s | 0.0122s | **1.3x** |
| b2sum | 100 files | 0.0022s | 0.0021s | **1.1x** |
| base32 | encode 100KB text | 0.0010s | 0.0014s | 0.8x |
| base32 | encode 1MB text | 0.0023s | 0.0023s | **1.0x** |
| base32 | encode 10MB text | 0.0149s | 0.0112s | **1.3x** |
| base32 | encode 10MB binary | 0.0168s | 0.0116s | **1.4x** |
| base32 | decode 1MB | 0.0036s | 0.0027s | **1.3x** |
| base32 | decode 10MB | 0.0287s | 0.0164s | **1.8x** |
| base64 | encode 100KB text | 0.0007s | 0.0009s | 0.8x |
| base64 | encode 1MB text | 0.0016s | 0.0013s | **1.2x** |
| base64 | encode 10MB text | 0.0110s | 0.0045s | **2.4x** |
| base64 | encode 10MB binary | 0.0112s | 0.0048s | **2.3x** |
| base64 | decode 1MB | 0.0036s | 0.0021s | **1.7x** |
| base64 | decode 10MB | 0.0309s | 0.0049s | **6.4x** |
| base64 | encode -w 76 10MB | 0.0108s | 0.0047s | **2.3x** |
...
| chown | chown current user on file | 0.0178s | 0.0232s | 0.8x |
| chown | chown current user on 1MB file | 0.0242s | 0.0419s | 0.6x |
| cksum | single 1MB text | 0.0014s | 0.0011s | **1.3x** |
| cksum | single 10MB text | 0.0027s | 0.0025s | **1.1x** |
| cksum | single 10MB binary | 0.0030s | 0.0025s | **1.2x** |
| comm | default 10MB sorted | 0.0241s | 0.0069s | **3.5x** |
| comm | -12 (common only) 10MB | 0.0203s | 0.0048s | **4.2x** |
| comm | -23 (unique to file1) 10MB | 0.0208s | 0.0054s | **3.8x** |
| comm | -3 10MB | 0.0222s | 0.0067s | **3.3x** |
| comm | identical 10MB sorted | 0.0296s | 0.0090s | **3.3x** |
| cp | cp small file (1KB) | 0.0023s | 0.0021s | **1.1x** |
| cp | cp medium file (1MB) | 0.0031s | 0.0028s | **1.1x** |
| cp | cp large file (10MB) | 0.0108s | 0.0106s | **1.0x** |
| cp | cp -r many small files (100 files) | 0.0079s | 0.0065s | **1.2x** |
| cp | cp -r deep directory (8 levels) | 0.0035s | 0.0032s | **1.1x** |
| cut | -b1-100 10MB CSV | 0.0232s | 0.0044s | **5.3x** |
| cut | -c1-100 10MB CSV | 0.0238s | 0.0044s | **5.4x** |
| cut | -d, -f1 10MB CSV | 0.0186s | 0.0039s | **4.7x** |
| cut | -d, -f1,3,5 10MB CSV | 0.0233s | 0.0070s | **3.3x** |
| cut | -d, -f2-4 10MB CSV | 0.0246s | 0.0058s | **4.2x** |
| cut | --complement -d, -f1 10MB CSV | 0.0311s | 0.0052s | **6.0x** |
| cut | -d, -f1 100KB text | 0.0009s | 0.0016s | 0.6x |
| cut | -d, -f1 1MB text | 0.0037s | 0.0021s | **1.8x** |
| cut | -d: -f1 colon file | 0.0009s | 0.0016s | 0.6x |
| date | date (default) | 0.0010s | 0.0010s | 0.9x |
| date | +%Y-%m-%d %H:%M:%S | 0.0010s | 0.0010s | 0.9x |
| date | +%s (epoch) | 0.0010s | 0.0010s | **1.0x** |
| date | ISO 8601 format | 0.0010s | 0.0010s | **1.0x** |
| date | RFC 3339 | 0.0010s | 0.0010s | 0.9x |
| date | -u (UTC) | 0.0009s | 0.0010s | 0.9x |
| dd | dd read 10MB (bs=4096) | 0.0047s | 0.0045s | **1.0x** |
| dd | dd write 10MB from /dev/zero (bs=1M count=10) | 0.0102s | 0.0150s | 0.7x |
| df | df (default) | 0.0015s | 0.0010s | **1.4x** |
| df | -h (human readable) | 0.0012s | 0.0010s | **1.2x** |
| df | df / | 0.0010s | 0.0010s | **1.0x** |
| df | -i (inodes) | 0.0012s | 0.0010s | **1.2x** |
| dir | dir current directory | 0.0011s | 0.0017s | 0.6x |
| dir | 100 files directory | 0.0012s | 0.0016s | 0.7x |
| dir | -la 100 files | 0.0019s | 0.0018s | **1.1x** |
| dir | -R test data | 0.0011s | 0.0015s | 0.7x |
| dircolors | dircolors -b (default) | 0.0007s | 0.0009s | 0.7x |
| dircolors | dircolors -c (csh) | 0.0007s | 0.0008s | 0.8x |
| dircolors | dircolors -p (print) | 0.0007s | 0.0009s | 0.7x |
| dircolors | custom db file | 0.0004s | 0.0008s | 0.5x |
| dirname | dirname simple path | 0.0009s | 0.0010s | 0.9x |
| dirname | dirname deep path | 0.0009s | 0.0010s | 0.9x |
| du | du test data dir | 0.0016s | 0.0016s | **1.0x** |
...
| echo | echo hello | 0.0008s | 0.0009s | 0.8x |
...
| expand | expand 10MB tabbed (default) | 0.0447s | 0.0159s | **2.8x** |
| expand | expand 1MB text | 0.0033s | 0.0012s | **2.8x** |
| expand | -t 4 10MB tabbed | 0.0424s | 0.0139s | **3.0x** |
| expand | -t 2 10MB tabbed | 0.0361s | 0.0132s | **2.7x** |
| expand | --initial 10MB tabbed | 0.0239s | 0.0072s | **3.3x** |
| expand | expand CSV 10MB | 0.0194s | 0.0022s | **9.0x** |
| expr | expr 1 + 1 | 0.0009s | 0.0011s | 0.9x |
| expr | expr 999999 * 999999 | 0.0009s | 0.0010s | 0.9x |
| expr | expr length 'hello world' | 0.0009s | 0.0010s | **1.0x** |
...
| factor | factor 1-100000 via stdin | 0.0165s | 0.0138s | **1.2x** |
| false | false (startup overhead) | 0.0006s | 0.0008s | 0.7x |
| fmt | fmt 1MB text | 0.0179s | 0.0159s | **1.1x** |
| fmt | fmt 10MB text | 0.1438s | 0.1207s | **1.2x** |
| fmt | -w 40 10MB | 0.1237s | 0.0933s | **1.3x** |
| fmt | -w 120 10MB | 0.1748s | 0.1556s | **1.1x** |
| fmt | fmt wide lines 10MB | 0.1673s | 0.1425s | **1.2x** |
| fold | fold 10MB wide lines (default) | 0.0350s | 0.0042s | **8.3x** |
| fold | fold 1MB text | 0.0042s | 0.0016s | **2.7x** |
| fold | fold 10MB text | 0.0349s | 0.0052s | **6.7x** |
| fold | -w 40 10MB | 0.0353s | 0.0046s | **7.7x** |
| fold | -w 20 10MB | 0.0371s | 0.0059s | **6.3x** |
| fold | -s -w 60 10MB | 0.0390s | 0.0053s | **7.4x** |
| fold | -s -w 40 10MB | 0.0416s | 0.0061s | **6.8x** |
| fold | -b -w 40 10MB | 0.0331s | 0.0052s | **6.3x** |
...
| install | install 1MB file | 0.0032s | 0.0028s | **1.1x** |
| install | install -d create directory | 0.0025s | 0.0024s | **1.1x** |
| join | default join 10MB | - | - | - |
| join | outer join 10MB | - | - | - |
| join | -v 1 (unmatched from file1) 10MB | - | - | - |
| join | -o 0,1.2,2.2 10MB | - | - | - |
| join | self-join sorted 10MB | 0.0464s | 0.0388s | **1.2x** |
| kill | kill -l (list signals) | 0.0008s | 0.0009s | 0.9x |
| link | hard link a file | 0.0012s | 0.0014s | 0.9x |
...
| md5sum | single 10MB text | 0.0171s | 0.0185s | 0.9x |
| md5sum | single 10MB binary | 0.0178s | 0.0192s | 0.9x |
...
| mknod | mknod named pipe | 0.0021s | 0.0020s | **1.0x** |
| mktemp | mktemp default | 0.0019s | 0.0020s | 0.9x |
| mktemp | mktemp -d directory | 0.0019s | 0.0021s | 0.9x |
| mv | mv same-fs small (1MB) | 0.0049s | 0.0050s | **1.0x** |
| mv | mv same-fs large (10MB) | 0.0149s | 0.0128s | **1.2x** |
| mv | mv many files (100 files) | - | 0.0127s | - |
...
| nl | default 10MB | 0.0297s | 0.0051s | **5.9x** |
| nl | -b a 10MB | 0.0298s | 0.0051s | **5.8x** |
| nl | -b a 10MB with blanks | 0.0390s | 0.0066s | **5.9x** |
| nl | -b a -n rz 10MB | 0.0296s | 0.0051s | **5.9x** |
| nl | -b a -w 8 -s ': ' 10MB | 0.0299s | 0.0052s | **5.8x** |
| nl | -b p'^the' 10MB | 0.0567s | 0.0058s | **9.7x** |
| nohup | nohup true | 0.0021s | 0.0023s | 0.9x |
| nproc | nproc (no args) | 0.0007s | 0.0008s | 0.8x |
| nproc | nproc --all | 0.0006s | 0.0008s | 0.8x |
| numfmt | --to=iec single value | 0.0011s | 0.0013s | 0.9x |
| numfmt | --from=iec single value | 0.0013s | 0.0013s | **1.0x** |
| numfmt | --to=si from CSV column | 0.0346s | 0.0192s | **1.8x** |
| od | default 1MB text | 0.0689s | 0.0099s | **7.0x** |
| od | -A x -t x1z 1MB | 0.1195s | 0.0170s | **7.0x** |
| od | -c 1MB text | 0.1189s | 0.0111s | **10.7x** |
| od | default 10MB binary | 0.6659s | 0.0908s | **7.3x** |
| od | -N 10000 10MB | 0.0021s | 0.0021s | **1.0x** |
| paste | 2 columns 10MB | 0.0244s | 0.0086s | **2.8x** |
| paste | 3 columns 10MB | 0.0314s | 0.0170s | **1.8x** |
| paste | -d comma 10MB | 0.0240s | 0.0081s | **2.9x** |
| paste | -s 10MB single file | 0.0105s | 0.0046s | **2.3x** |
| paste | stdin split 2-way 10MB | 0.0323s | 0.0088s | **3.7x** |
...
| pinky | pinky -l | - | - | - |
| pr | pr 1MB text | 0.0109s | 0.0016s | **7.0x** |
| pr | -2 (two columns) 1MB | 0.0120s | 0.0017s | **7.2x** |
| pr | -3 (three columns) 1MB | 0.0089s | 0.0016s | **5.5x** |
| pr | -n 1MB text | 0.0121s | 0.0020s | **6.0x** |
| pr | -t 1MB text | 0.0104s | 0.0013s | **7.7x** |
...
| printf | integer formatting | 0.0008s | 0.0012s | 0.7x |
...
| ptx | ptx 100KB text | 0.0110s | 0.0054s | **2.0x** |
...
| readlink | readlink -f (canonicalize) | 0.0009s | 0.0009s | **1.0x** |
| realpath | realpath . | 0.0006s | 0.0008s | 0.8x |
| realpath | realpath /tmp | 0.0006s | 0.0008s | 0.8x |
| realpath | realpath test data file | 0.0006s | 0.0009s | 0.7x |
| rev | reverse 100KB text | 0.0024s | 0.0011s | **2.2x** |
| rev | reverse 1MB text | 0.0150s | 0.0019s | **8.1x** |
| rev | reverse 10MB text | 0.1432s | 0.0087s | **16.5x** |
| rev | reverse CSV 10MB | 0.1019s | 0.0083s | **12.2x** |
| rev | reverse repetitive 10MB | 0.2951s | 0.0127s | **23.2x** |
| rev | reverse 10KB single line | 0.0011s | 0.0011s | **1.1x** |
| rm | rm single file | 0.0022s | 0.0024s | 0.9x |
| rm | rm -rf directory | 0.0074s | 0.0084s | 0.9x |
...
| seq | seq 0 0.1 100000 (float) | 0.2310s | 0.0203s | **11.4x** |
| seq | seq -w 1 1000000 (zero-padded) | 0.2423s | 0.0155s | **15.6x** |
| sha1sum | single 1MB text | 0.0020s | 0.0018s | **1.1x** |
| sha1sum | single 10MB text | 0.0084s | 0.0084s | **1.0x** |
| sha1sum | single 10MB binary | 0.0089s | 0.0086s | **1.0x** |
...
| sha256sum | single 100KB text | 0.0010s | 0.0010s | **1.1x** |
| sha256sum | single 1MB text | 0.0018s | 0.0016s | **1.1x** |
| sha256sum | single 10MB text | 0.0097s | 0.0091s | **1.1x** |
| sha256sum | single 10MB binary | 0.0103s | 0.0090s | **1.1x** |
...
| sha512sum | single 1MB text | 0.0027s | 0.0042s | 0.6x |
| sha512sum | single 10MB text | 0.0155s | 0.0167s | 0.9x |
| sha512sum | single 10MB binary | 0.0161s | 0.0173s | 0.9x |
| shred | shred 1MB file | 0.0272s | 0.0068s | **4.0x** |
| shred | shred 1MB file with remove (-u) | 0.0138s | 0.0058s | **2.4x** |
| shuf | shuf 1MB text | 0.0030s | 0.0016s | **1.8x** |
| shuf | shuf 10MB text | 0.0217s | 0.0080s | **2.7x** |
| shuf | -n 100 from 10MB | 0.0188s | 0.0041s | **4.6x** |
| shuf | -n 10000 from 10MB | 0.0215s | 0.0058s | **3.7x** |
| shuf | -i 1-1000000 | 0.0707s | 0.0140s | **5.0x** |
...
| sort | already sorted 10MB | 0.0276s | 0.0050s | **5.5x** |
| sort | reverse sorted 10MB | 0.0270s | 0.0064s | **4.2x** |
| sort | -n numeric 10MB | 0.0723s | 0.0055s | **13.2x** |
| sort | -r reverse 10MB | 0.0535s | 0.0089s | **6.0x** |
| sort | -u unique 10MB | 0.0567s | 0.0089s | **6.3x** |
| sort | -t, -k2 CSV 10MB | 0.0654s | 0.0359s | **1.8x** |
| sort | repetitive 10MB | 0.0543s | 0.0124s | **4.4x** |
| sort | --parallel=4 10MB | 0.0532s | 0.0089s | **5.9x** |
| split | split 10MB into 1MB chunks (-b 1m) | 0.0107s | 0.0073s | **1.5x** |
| split | split 10MB by 1000 lines (-l 1000) | 0.0176s | 0.0176s | **1.0x** |
| stat | stat single file | 0.0012s | 0.0011s | **1.1x** |
| stat | 100 files | 0.0045s | 0.0048s | **1.0x** |
| stat | --format=%s (size only) | 0.0010s | 0.0009s | **1.1x** |
| stat | --format='%n %s %Y' | 0.0011s | 0.0010s | **1.1x** |
| stat | -f (filesystem) | 0.0011s | 0.0010s | **1.2x** |
| stdbuf | -oL cat 1MB | 0.0018s | 0.0020s | 0.9x |
| stdbuf | -o0 cat 100KB | 0.0017s | 0.0020s | 0.9x |
| sum | single 1MB text | 0.0026s | 0.0023s | **1.1x** |
| sum | single 10MB text | 0.0178s | 0.0151s | **1.2x** |
| sum | single 10MB binary | 0.0184s | 0.0156s | **1.2x** |
| sync | sync (no args) | 0.0008s | 0.0010s | 0.9x |
| tac | reverse 100KB text | 0.0010s | 0.0011s | 0.9x |
| tac | reverse 1MB text | 0.0021s | 0.0015s | **1.4x** |
| tac | reverse 10MB text | 0.0112s | 0.0047s | **2.4x** |
| tac | reverse CSV 10MB | 0.0093s | 0.0045s | **2.1x** |
| tac | reverse repetitive 10MB | 0.0231s | 0.0085s | **2.7x** |
| tac | custom separator 1MB | 0.0057s | 0.0040s | **1.4x** |
...
| tail | -n +100 10MB (from line 100) | 0.0040s | 0.0020s | **1.9x** |
| tail | -n +100000 10MB (from line 100000) | 0.0039s | 0.0032s | **1.2x** |
| tail | -c 1000000 10MB | 0.0012s | 0.0012s | **1.0x** |
| tail | 100 small files | 0.0018s | 0.0021s | 0.8x |
| tee | tee 1MB to /dev/null | 0.0017s | 0.0017s | **1.1x** |
| tee | tee 10MB to /dev/null | 0.0077s | 0.0068s | **1.1x** |
...
| test | test -d /tmp | 0.0009s | 0.0010s | 0.8x |
| timeout | timeout 10 true | 0.0016s | 0.0017s | 0.9x |
| timeout | timeout 10 echo hello | 0.0019s | 0.0018s | **1.1x** |
...
| tr | a-z to A-Z 10MB | 0.0147s | 0.0049s | **3.0x** |
| tr | -d digits 10MB | 0.0211s | 0.0054s | **3.9x** |
| tr | -d lowercase 10MB | 0.0339s | 0.0063s | **5.3x** |
| tr | -s spaces 10MB | 0.0297s | 0.0041s | **7.2x** |
| tr | [:lower:] to [:upper:] 10MB | 0.0131s | 0.0043s | **3.1x** |
| tr | -d [:digit:] 10MB CSV | 0.0196s | 0.0054s | **3.6x** |
| tr | translate binary 10MB | 0.0139s | 0.0042s | **3.3x** |
| true | true (startup overhead) | 0.0005s | 0.0008s | 0.7x |
| truncate | truncate to zero (-s 0) | 0.0031s | 0.0032s | 0.9x |
| truncate | create 1M file (-s 1M) | 0.0018s | 0.0019s | 0.9x |
| tsort | tsort 100K pairs | 0.0579s | 0.0078s | **7.4x** |
| tsort | tsort 1M pairs | 0.6491s | 0.0652s | **10.0x** |
...
| unexpand | unexpand 10MB text | 0.0275s | 0.0024s | **11.4x** |
| unexpand | -a 1MB text | 0.0089s | 0.0011s | **7.8x** |
| unexpand | -a 10MB text | 0.0841s | 0.0023s | **35.9x** |
| unexpand | -t 4 10MB text | 0.0831s | 0.0022s | **37.0x** |
| unexpand | expand|unexpand pipeline 10MB | 0.1202s | 0.0715s | **1.7x** |
| uniq | default 10MB many duplicates | 0.0118s | 0.0020s | **5.9x** |
| uniq | default 10MB sorted (low dup) | 0.0201s | 0.0041s | **4.9x** |
| uniq | -c count 10MB many dups | 0.0141s | 0.0030s | **4.8x** |
| uniq | -c count 10MB sorted | 0.0310s | 0.0077s | **4.0x** |
| uniq | -d duplicates only 10MB | 0.0120s | 0.0021s | **5.7x** |
| uniq | -u unique only 10MB | 0.0120s | 0.0018s | **6.5x** |
| uniq | -i case insensitive 10MB | 0.0140s | 0.0044s | **3.2x** |
| uniq | repetitive 10MB | 0.0423s | 0.0037s | **11.4x** |
...
| wc | default 10MB text | 0.0549s | 0.0030s | **18.2x** |
| wc | -l 10MB text | 0.0019s | 0.0019s | **1.0x** |
| wc | -w 10MB text | 0.0543s | 0.0133s | **4.1x** |
| wc | -c 10MB text | 0.0009s | 0.0009s | 0.9x |
| wc | -m 10MB text | 0.0543s | 0.0029s | **18.5x** |
| wc | -L 10MB text | 0.0544s | 0.0104s | **5.2x** |
| wc | default 10MB binary | 0.3193s | 0.0276s | **11.6x** |
| wc | default 10MB repetitive | 0.0735s | 0.0046s | **16.0x** |
| wc | 10 files | 0.0010s | 0.0011s | 0.9x |
| wc | 100 files | 0.0019s | 0.0017s | **1.1x** |
| who | who (default) | 0.0010s | 0.0011s | 0.9x |
| who | who -a (all) | 0.0011s | 0.0012s | 0.9x |
| who | who -b (boot) | 0.0010s | 0.0011s | 0.9x |
| whoami | whoami (no args) | 0.0006s | 0.0008s | 0.8x |
| yes | throughput 1M lines | 0.0030s | 0.0032s | 0.9x |
| yes | throughput 10M lines | 0.0330s | 0.0246s | **1.3x** |
| yes | throughput hello 1M lines | 0.0067s | 0.0065s | **1.0x** |
| yes | throughput hello 10M lines | 0.0560s | 0.0614s | 0.9x |
| yes | throughput 100MB | 0.0476s | 0.0474s | **1.0x** |
...
|------|------|----------:|-----------:|-----------:|-----------:|------------:|
| base64 | encode 1MB | 0.0016s | 0.0014s | 0.0011s | **1.5x** | **1.3x** |
| cat | passthrough 1MB | 0.0010s | 0.0014s | 0.0003s | **3.6x** | **5.2x** |
| cat | passthrough 10MB | 0.0015s | 0.0019s | 0.0005s | **2.9x** | **3.6x** |
| cat | -n 10MB | 0.0103s | 0.0060s | 0.0110s | 0.9x | 0.5x |
| cut | 10MB -c1-20 | 0.0224s | 0.0032s | 0.0037s | **6.0x** | 0.9x |
| echo | short string | 0.0000s | 0.0010s | 0.0002s | 0.2x | **4.7x** |
| expand | 10MB text | 0.0249s | 0.0021s | 0.0058s | **4.3x** | 0.4x |
| fold | 10MB default width | 0.0347s | 0.0051s | 0.0050s | **6.9x** | **1.0x** |
| fold | 10MB -w 40 | 0.0374s | 0.0058s | 0.0052s | **7.3x** | **1.1x** |
| head | first 1000 lines 10MB | 0.0006s | 0.0009s | 0.0002s | **2.9x** | **4.1x** |
| md5sum | 10MB file | 0.0174s | 0.0190s | 0.0243s | 0.7x | 0.8x |
| nl | 10MB text | 0.0315s | 0.0051s | 0.0042s | **7.4x** | **1.2x** |
| od | 1MB text | 0.0645s | 0.0106s | 0.0064s | **10.1x** | **1.7x** |
| rev | 10MB text | 0.1434s | 0.0085s | 0.0154s | **9.3x** | 0.6x |
| seq | 1 to 1M | 0.0105s | 0.0025s | 0.0011s | **9.6x** | **2.3x** |
| seq | 1 to 10M | 0.0968s | 0.0134s | 0.0049s | **19.8x** | **2.7x** |
| sort | 1MB text | 0.0085s | 0.0041s | 0.0061s | **1.4x** | 0.7x |
| tac | reverse 1MB | 0.0019s | 0.0015s | 0.0009s | **2.1x** | **1.6x** |
| tail | last 1000 lines 10MB | 0.0009s | 0.0012s | 0.0003s | **3.0x** | **4.0x** |
| tr | 10MB lowercase | 0.0094s | 0.0026s | 0.0047s | **2.0x** | 0.6x |
| unexpand | 10MB text | 0.0226s | 0.0024s | 0.0071s | **3.2x** | 0.3x |
| uniq | 10MB sorted | 0.0207s | 0.0031s | 0.0033s | **6.3x** | 0.9x |
| wc | 10MB text | 0.0543s | 0.0030s | 0.0376s | **1.4x** | 0.1x |
| wc | 10MB -l only | 0.0019s | 0.0019s | 0.0013s | **1.5x** | **1.4x** |
| yes | 1M lines | 0.0033s | 0.0032s | 0.0033s | **1.0x** | **1.0x** |
