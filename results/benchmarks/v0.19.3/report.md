# fcoreutils v0.19.3 — Detailed Results

Generated: 2026-03-09 21:16:12 UTC
...
| b2sum | single 10MB text | 0.0144s | 0.0129s | **1.1x** |
| b2sum | single 10MB binary | 0.0151s | 0.0131s | **1.2x** |
| b2sum | -l 256 10MB | 0.0149s | 0.0122s | **1.2x** |
| b2sum | -l 128 10MB | 0.0137s | 0.0116s | **1.2x** |
...
| base32 | decode 10MB | 0.0276s | 0.0157s | **1.8x** |
| base64 | encode 100KB text | 0.0011s | 0.0011s | **1.1x** |
| base64 | encode 1MB text | 0.0024s | 0.0014s | **1.7x** |
| base64 | encode 10MB text | 0.0145s | 0.0051s | **2.9x** |
| base64 | encode 10MB binary | 0.0149s | 0.0054s | **2.8x** |
| base64 | decode 1MB | 0.0041s | 0.0020s | **2.1x** |
| base64 | decode 10MB | 0.0323s | 0.0048s | **6.7x** |
| base64 | encode -w 76 10MB | 0.0143s | 0.0052s | **2.8x** |
| base64 | encode -w 0 (no wrap) 10MB | 0.0099s | 0.0036s | **2.7x** |
...
| cat | -n 10MB | 0.0091s | 0.0066s | **1.4x** |
| cat | -b 10MB | 0.0099s | 0.0061s | **1.6x** |
| cat | -A 1MB | 0.0016s | 0.0016s | **1.0x** |
| cat | 100 small files | 0.0016s | 0.0019s | 0.8x |
...
| cksum | single 10MB text | 0.0029s | 0.0024s | **1.2x** |
...
| comm | -23 (unique to file1) 10MB | 0.0209s | 0.0054s | **3.9x** |
| comm | -3 10MB | 0.0222s | 0.0066s | **3.4x** |
| comm | identical 10MB sorted | 0.0296s | 0.0090s | **3.3x** |
| cp | cp small file (1KB) | 0.0021s | 0.0019s | **1.2x** |
...
| cut | -b1-100 10MB CSV | 0.0228s | 0.0036s | **6.4x** |
| cut | -c1-100 10MB CSV | 0.0229s | 0.0037s | **6.2x** |
| cut | -d, -f1 10MB CSV | 0.0168s | 0.0040s | **4.2x** |
| cut | -d, -f1,3,5 10MB CSV | 0.0222s | 0.0104s | **2.1x** |
| cut | -d, -f2-4 10MB CSV | 0.0242s | 0.0080s | **3.0x** |
| cut | --complement -d, -f1 10MB CSV | 0.0310s | 0.0050s | **6.2x** |
...
| dd | dd write 10MB from /dev/zero (bs=1M count=10) | 0.0145s | 0.0145s | **1.0x** |
| df | df (default) | 0.0014s | 0.0011s | **1.2x** |
| df | -h (human readable) | 0.0013s | 0.0011s | **1.2x** |
| df | df / | 0.0011s | 0.0011s | **1.0x** |
| df | -i (inodes) | 0.0014s | 0.0011s | **1.2x** |
| dir | dir current directory | 0.0011s | 0.0014s | 0.8x |
| dir | 100 files directory | 0.0012s | 0.0016s | 0.7x |
| dir | -la 100 files | 0.0019s | 0.0018s | **1.0x** |
| dir | -R test data | 0.0011s | 0.0015s | 0.8x |
...
| echo | echo hello | 0.0006s | 0.0007s | 0.8x |
...
| env | env VAR=value true | 0.0016s | 0.0015s | **1.1x** |
| expand | expand 10MB tabbed (default) | 0.0457s | 0.0198s | **2.3x** |
| expand | expand 1MB text | 0.0033s | 0.0012s | **2.8x** |
| expand | -t 4 10MB tabbed | 0.0419s | 0.0125s | **3.4x** |
| expand | -t 2 10MB tabbed | 0.0356s | 0.0123s | **2.9x** |
| expand | --initial 10MB tabbed | 0.0230s | 0.0068s | **3.4x** |
| expand | expand CSV 10MB | 0.0191s | 0.0018s | **10.6x** |
| expr | expr 1 + 1 | 0.0008s | 0.0009s | **1.0x** |
...
| factor | factor 1-100000 via stdin | 0.0230s | 0.0145s | **1.6x** |
| false | false (startup overhead) | 0.0006s | 0.0008s | 0.7x |
| fmt | fmt 1MB text | 0.0175s | 0.0156s | **1.1x** |
| fmt | fmt 10MB text | 0.1439s | 0.1217s | **1.2x** |
| fmt | -w 40 10MB | 0.1236s | 0.0947s | **1.3x** |
| fmt | -w 120 10MB | 0.1767s | 0.1589s | **1.1x** |
| fmt | fmt wide lines 10MB | 0.1673s | 0.1445s | **1.2x** |
| fold | fold 10MB wide lines (default) | 0.0348s | 0.0040s | **8.8x** |
| fold | fold 1MB text | 0.0042s | 0.0016s | **2.7x** |
| fold | fold 10MB text | 0.0343s | 0.0050s | **6.9x** |
| fold | -w 40 10MB | 0.0352s | 0.0044s | **8.0x** |
| fold | -w 20 10MB | 0.0361s | 0.0058s | **6.2x** |
| fold | -s -w 60 10MB | 0.0376s | 0.0048s | **7.9x** |
| fold | -s -w 40 10MB | 0.0408s | 0.0060s | **6.8x** |
...
| head | -n 100000 10MB | 0.0071s | 0.0040s | **1.7x** |
...
| id | id -u | 0.0009s | 0.0009s | **1.1x** |
| id | id -g | 0.0010s | 0.0009s | **1.1x** |
| id | id -un | 0.0011s | 0.0010s | **1.0x** |
| install | install 1MB file | 0.0021s | 0.0023s | 0.9x |
| install | install -d create directory | 0.0018s | 0.0020s | 0.9x |
| join | default join 10MB | - | - | - |
| join | outer join 10MB | - | - | - |
| join | -v 1 (unmatched from file1) 10MB | - | - | - |
| join | -o 0,1.2,2.2 10MB | - | - | - |
| join | self-join sorted 10MB | 0.0476s | 0.0389s | **1.2x** |
| kill | kill -l (list signals) | 0.0006s | 0.0008s | 0.8x |
...
| mktemp | mktemp -d directory | 0.0018s | 0.0020s | 0.9x |
| mv | mv same-fs small (1MB) | 0.0027s | 0.0026s | **1.0x** |
| mv | mv same-fs large (10MB) | 0.0066s | 0.0069s | **1.0x** |
| mv | mv many files (100 files) | - | 0.0060s | - |
...
| nl | default 10MB | 0.0360s | 0.0050s | **7.2x** |
| nl | -b a 10MB | 0.0353s | 0.0050s | **7.1x** |
| nl | -b a 10MB with blanks | 0.0449s | 0.0066s | **6.8x** |
| nl | -b a -n rz 10MB | 0.0354s | 0.0050s | **7.1x** |
| nl | -b a -w 8 -s ': ' 10MB | 0.0357s | 0.0050s | **7.1x** |
| nl | -b p'^the' 10MB | 0.0594s | 0.0056s | **10.6x** |
...
| numfmt | --to=si from CSV column | 0.0341s | 0.0162s | **2.1x** |
| od | default 1MB text | 0.0648s | 0.0100s | **6.5x** |
| od | -A x -t x1z 1MB | 0.1220s | 0.0172s | **7.1x** |
| od | -c 1MB text | 0.1219s | 0.0115s | **10.6x** |
| od | default 10MB binary | 0.6690s | 0.0910s | **7.4x** |
| od | -N 10000 10MB | 0.0022s | 0.0020s | **1.1x** |
| paste | 2 columns 10MB | 0.0237s | 0.0084s | **2.8x** |
| paste | 3 columns 10MB | 0.0290s | 0.0153s | **1.9x** |
| paste | -d comma 10MB | 0.0235s | 0.0081s | **2.9x** |
| paste | -s 10MB single file | 0.0105s | 0.0045s | **2.3x** |
| paste | stdin split 2-way 10MB | 0.0293s | 0.0086s | **3.4x** |
| pathchk | pathchk default | 0.0008s | 0.0010s | 0.8x |
| pathchk | pathchk -p (POSIX portable) | 0.0008s | 0.0009s | 0.9x |
| pinky | pinky (default) | 0.0010s | 0.0012s | 0.8x |
| pinky | pinky -l | - | - | - |
| pr | pr 1MB text | 0.0127s | 0.0014s | **8.8x** |
| pr | -2 (two columns) 1MB | 0.0116s | 0.0016s | **7.4x** |
| pr | -3 (three columns) 1MB | 0.0101s | 0.0016s | **6.2x** |
| pr | -n 1MB text | 0.0118s | 0.0018s | **6.4x** |
| pr | -t 1MB text | 0.0099s | 0.0014s | **7.1x** |
...
| printf | float formatting | 0.0008s | 0.0012s | 0.7x |
| printf | string padding | 0.0008s | 0.0010s | 0.8x |
| ptx | ptx 10KB text | 0.0019s | 0.0015s | **1.2x** |
| ptx | ptx 100KB text | 0.0154s | 0.0065s | **2.4x** |
| ptx | -w 60 100KB text | 0.0103s | 0.0052s | **2.0x** |
| pwd | pwd (no args) | 0.0009s | 0.0009s | **1.0x** |
| pwd | pwd -L | 0.0010s | 0.0011s | 0.9x |
...
| rev | reverse 100KB text | 0.0027s | 0.0010s | **2.8x** |
| rev | reverse 1MB text | 0.0148s | 0.0018s | **8.2x** |
| rev | reverse 10MB text | 0.1387s | 0.0089s | **15.6x** |
| rev | reverse CSV 10MB | 0.1005s | 0.0077s | **13.1x** |
| rev | reverse repetitive 10MB | 0.2942s | 0.0126s | **23.3x** |
| rev | reverse 10KB single line | 0.0010s | 0.0010s | **1.1x** |
| rm | rm single file | 0.0021s | 0.0022s | **1.0x** |
| rm | rm -rf directory | 0.0072s | 0.0074s | **1.0x** |
...
| seq | seq 1 10000000 | 0.0958s | 0.0135s | **7.1x** |
| seq | seq 0 0.1 100000 (float) | 0.2314s | 0.0300s | **7.7x** |
| seq | seq -w 1 1000000 (zero-padded) | 0.2461s | 0.0236s | **10.4x** |
| sha1sum | single 1MB text | 0.0019s | 0.0017s | **1.1x** |
| sha1sum | single 10MB text | 0.0084s | 0.0080s | **1.0x** |
...
| sha224sum | single 10MB text | 0.0108s | 0.0085s | **1.3x** |
| sha224sum | single 10MB binary | 0.0097s | 0.0083s | **1.2x** |
| sha256sum | single 100KB text | 0.0010s | 0.0010s | **1.1x** |
| sha256sum | single 1MB text | 0.0018s | 0.0017s | **1.1x** |
| sha256sum | single 10MB text | 0.0099s | 0.0086s | **1.1x** |
| sha256sum | single 10MB binary | 0.0104s | 0.0091s | **1.1x** |
| sha256sum | 10 files | 0.0011s | 0.0023s | 0.5x |
| sha256sum | 100 files | 0.0014s | 0.0024s | 0.6x |
| sha384sum | single 1MB text | 0.0027s | 0.0042s | 0.6x |
| sha384sum | single 10MB text | 0.0190s | 0.0194s | **1.0x** |
| sha384sum | single 10MB binary | 0.0198s | 0.0202s | **1.0x** |
| sha512sum | single 1MB text | 0.0027s | 0.0039s | 0.7x |
| sha512sum | single 10MB text | 0.0155s | 0.0168s | 0.9x |
| sha512sum | single 10MB binary | 0.0160s | 0.0175s | 0.9x |
| shred | shred 1MB file | 0.0101s | 0.0065s | **1.6x** |
| shred | shred 1MB file with remove (-u) | 0.0197s | 0.0085s | **2.3x** |
| shuf | shuf 1MB text | 0.0029s | 0.0015s | **1.9x** |
| shuf | shuf 10MB text | 0.0177s | 0.0055s | **3.2x** |
| shuf | -n 100 from 10MB | 0.0182s | 0.0038s | **4.8x** |
| shuf | -n 10000 from 10MB | 0.0203s | 0.0051s | **3.9x** |
| shuf | -i 1-1000000 | 0.0697s | 0.0136s | **5.1x** |
| shuf | -i 1-1000000 -n 100 | 0.0009s | 0.0009s | 0.9x |
| sleep | sleep 0 (startup overhead) | 0.0009s | 0.0010s | 0.9x |
| sleep | sleep 0.001 (tiny sleep) | 0.0020s | 0.0023s | 0.9x |
| sort | lexicographic 1MB | 0.0088s | 0.0040s | **2.2x** |
| sort | lexicographic 10MB random | 0.0612s | 0.0097s | **6.3x** |
| sort | already sorted 10MB | 0.0267s | 0.0053s | **5.0x** |
| sort | reverse sorted 10MB | 0.0276s | 0.0069s | **4.0x** |
| sort | -n numeric 10MB | 0.0736s | 0.0061s | **12.2x** |
| sort | -r reverse 10MB | 0.0556s | 0.0098s | **5.7x** |
| sort | -u unique 10MB | 0.0587s | 0.0099s | **5.9x** |
| sort | -t, -k2 CSV 10MB | 0.0684s | 0.0424s | **1.6x** |
| sort | repetitive 10MB | 0.0570s | 0.0128s | **4.5x** |
| sort | --parallel=4 10MB | 0.0543s | 0.0106s | **5.1x** |
| split | split 10MB into 1MB chunks (-b 1m) | 0.0070s | 0.0056s | **1.3x** |
| split | split 10MB by 1000 lines (-l 1000) | 0.0113s | 0.0123s | 0.9x |
...
| stdbuf | -o0 cat 100KB | 0.0020s | 0.0018s | **1.1x** |
| sum | single 1MB text | 0.0025s | 0.0023s | **1.1x** |
| sum | single 10MB text | 0.0174s | 0.0146s | **1.2x** |
...
| tac | reverse 10MB text | 0.0115s | 0.0050s | **2.3x** |
| tac | reverse CSV 10MB | 0.0095s | 0.0047s | **2.0x** |
...
| tail | -n 100000 10MB | 0.0061s | 0.0032s | **1.9x** |
| tail | -n +100 10MB (from line 100) | 0.0041s | 0.0021s | **1.9x** |
| tail | -n +100000 10MB (from line 100000) | 0.0042s | 0.0035s | **1.2x** |
| tail | -c 1000000 10MB | 0.0010s | 0.0010s | **1.0x** |
| tail | 100 small files | 0.0018s | 0.0022s | 0.8x |
| tee | tee 1MB to /dev/null | 0.0017s | 0.0017s | **1.0x** |
| tee | tee 10MB to /dev/null | 0.0067s | 0.0056s | **1.2x** |
...
| timeout | timeout 10 true | 0.0021s | 0.0022s | **1.0x** |
...
| tr | a-z to A-Z 10MB | 0.0135s | 0.0047s | **2.9x** |
| tr | -d digits 10MB | 0.0226s | 0.0043s | **5.3x** |
| tr | -d lowercase 10MB | 0.0318s | 0.0051s | **6.3x** |
| tr | -s spaces 10MB | 0.0261s | 0.0037s | **7.0x** |
| tr | [:lower:] to [:upper:] 10MB | 0.0124s | 0.0037s | **3.3x** |
| tr | -d [:digit:] 10MB CSV | 0.0163s | 0.0050s | **3.2x** |
| tr | translate binary 10MB | 0.0139s | 0.0039s | **3.6x** |
...
| tsort | tsort 1M pairs | 0.6552s | 0.0638s | **10.3x** |
...
| unexpand | unexpand 10MB text | 0.0245s | 0.0020s | **12.2x** |
| unexpand | -a 1MB text | 0.0073s | 0.0011s | **6.5x** |
| unexpand | -a 10MB text | 0.0701s | 0.0019s | **37.8x** |
| unexpand | -t 4 10MB text | 0.0699s | 0.0020s | **34.1x** |
| unexpand | expand|unexpand pipeline 10MB | 0.0943s | 0.0615s | **1.5x** |
| uniq | default 10MB many duplicates | 0.0125s | 0.0020s | **6.1x** |
| uniq | default 10MB sorted (low dup) | 0.0141s | 0.0031s | **4.5x** |
| uniq | -c count 10MB many dups | 0.0123s | 0.0020s | **6.3x** |
| uniq | -c count 10MB sorted | 0.0301s | 0.0078s | **3.9x** |
| uniq | -d duplicates only 10MB | 0.0123s | 0.0019s | **6.5x** |
| uniq | -u unique only 10MB | 0.0121s | 0.0019s | **6.4x** |
...
| wc | default 10MB text | 0.0553s | 0.0039s | **14.1x** |
| wc | -l 10MB text | 0.0023s | 0.0023s | **1.0x** |
| wc | -w 10MB text | 0.0547s | 0.0144s | **3.8x** |
| wc | -c 10MB text | 0.0009s | 0.0010s | 0.9x |
| wc | -m 10MB text | 0.0540s | 0.0034s | **16.0x** |
| wc | -L 10MB text | 0.0546s | 0.0115s | **4.8x** |
| wc | default 10MB binary | 0.3171s | 0.0278s | **11.4x** |
| wc | default 10MB repetitive | 0.0734s | 0.0049s | **14.9x** |
...
| yes | throughput 10M lines | 0.0296s | 0.0247s | **1.2x** |
| yes | throughput hello 1M lines | 0.0102s | 0.0063s | **1.6x** |
| yes | throughput hello 10M lines | 0.0519s | 0.0573s | 0.9x |
| yes | throughput 100MB | 0.0454s | 0.0482s | 0.9x |
...
| cat | passthrough 1MB | 0.0009s | 0.0014s | 0.0002s | **4.0x** | **5.9x** |
| cat | passthrough 10MB | 0.0015s | 0.0019s | 0.0005s | **2.8x** | **3.7x** |
| cat | -n 10MB | 0.0102s | 0.0058s | 0.0141s | 0.7x | 0.4x |
| cut | 10MB -c1-20 | 0.0258s | 0.0042s | 0.0053s | **4.9x** | 0.8x |
| echo | short string | 0.0000s | 0.0008s | 0.0002s | 0.2x | **4.9x** |
| expand | 10MB text | 0.0253s | 0.0022s | 0.0059s | **4.3x** | 0.4x |
| fold | 10MB default width | 0.0346s | 0.0049s | 0.0050s | **6.9x** | **1.0x** |
| fold | 10MB -w 40 | 0.0360s | 0.0056s | 0.0051s | **7.0x** | **1.1x** |
| head | first 1000 lines 10MB | 0.0009s | 0.0011s | 0.0003s | **2.9x** | **3.6x** |
| md5sum | 10MB file | 0.0169s | 0.0182s | 0.0240s | 0.7x | 0.8x |
| nl | 10MB text | 0.0358s | 0.0050s | 0.0041s | **8.7x** | **1.2x** |
| od | 1MB text | 0.0645s | 0.0099s | 0.0067s | **9.6x** | **1.5x** |
| rev | 10MB text | 0.1384s | 0.0080s | 0.0141s | **9.8x** | 0.6x |
| seq | 1 to 1M | 0.0103s | 0.0025s | 0.0011s | **9.4x** | **2.2x** |
| seq | 1 to 10M | 0.0953s | 0.0135s | 0.0047s | **20.3x** | **2.9x** |
| sort | 1MB text | 0.0086s | 0.0044s | 0.0065s | **1.3x** | 0.7x |
| tac | reverse 1MB | 0.0019s | 0.0015s | 0.0009s | **2.1x** | **1.6x** |
| tail | last 1000 lines 10MB | 0.0010s | 0.0012s | 0.0003s | **3.0x** | **3.9x** |
| tr | 10MB lowercase | 0.0100s | 0.0024s | 0.0049s | **2.0x** | 0.5x |
| unexpand | 10MB text | 0.0265s | 0.0029s | 0.0058s | **4.5x** | 0.5x |
| uniq | 10MB sorted | 0.0267s | 0.0029s | 0.0028s | **9.6x** | **1.0x** |
| yes | 1M lines | 0.0024s | 0.0025s | 0.0024s | **1.0x** | **1.0x** |
