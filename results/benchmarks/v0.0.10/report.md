...
|------|------|-----------|-------------------|---------|
| wc | default 100KB text | 0.0038s | 0.0020s | **1.9x** |
| wc | default 1MB text | 0.0047s | 0.0034s | **1.4x** |
| wc | default 10MB text | 0.0372s | 0.0073s | **5.1x** |
| wc | default 100MB text | 0.3813s | 0.0436s | **8.7x** |
| wc | -l 10MB text | 0.0160s | 0.0038s | **4.2x** |
| wc | -w 10MB text | 0.0450s | 0.0056s | **8.1x** |
| wc | -c 10MB text | 0.0025s | 0.0050s | **0.5x** |
| wc | -m 10MB text | 0.0437s | 0.0071s | **6.1x** |
| wc | -L 10MB text | 0.0375s | 0.0257s | **1.5x** |
| wc | default 10MB binary | 0.1509s | 0.0080s | **18.8x** |
| wc | default 10MB repetitive | 0.0535s | 0.0117s | **4.6x** |
| wc | 10 files | 0.0029s | 0.0044s | **0.7x** |
| wc | 100 files | 0.0231s | 0.0159s | **1.5x** |
| cut | -b1-100 10MB CSV | 0.0411s | 0.0129s | **3.2x** |
| cut | -c1-100 10MB CSV | 0.0401s | 0.0095s | **4.2x** |
| cut | -d, -f1 10MB CSV | 0.0182s | 0.0007s | **24.9x** |
| cut | -d, -f1,3,5 10MB CSV | 0.0405s | 0.0144s | **2.8x** |
| cut | -d, -f2-4 10MB CSV | 0.0319s | 0.0064s | **5.0x** |
| cut | --complement -d, -f1 10MB CSV | 0.0473s | 0.0125s | **3.8x** |
| cut | -d, -f1 100KB text | 0.0062s | 0.0038s | **1.7x** |
| cut | -d, -f1 1MB text | 0.0014s | 0.0016s | **0.9x** |
| cut | -d: -f1 colon file | 0.0033s | 0.0007s | **4.8x** |
| sha256sum | single 100KB text | 0.0043s | 0.0051s | **0.8x** |
| sha256sum | single 1MB text | 0.0097s | 0.0055s | **1.8x** |
| sha256sum | single 10MB text | 0.0468s | 0.0132s | **3.5x** |
| sha256sum | single 10MB binary | 0.0412s | 0.0076s | **5.4x** |
| sha256sum | single 100MB text | 0.3991s | 0.0561s | **7.1x** |
| sha256sum | 10 files | 0.0024s | 0.0023s | **1.0x** |
| sha256sum | 100 files | 0.0041s | 0.0109s | **0.4x** |
| md5sum | single 100KB text | 0.0027s | 0.0041s | **0.7x** |
| md5sum | single 1MB text | 0.0082s | 0.0017s | **4.8x** |
| md5sum | single 10MB text | 0.0208s | 0.0206s | **1.0x** |
| md5sum | single 10MB binary | 0.0205s | 0.0203s | **1.0x** |
| md5sum | single 100MB text | 0.1775s | 0.1726s | **1.0x** |
| md5sum | 10 files | 0.0024s | 0.0028s | **0.9x** |
| md5sum | 100 files | 0.0036s | 0.0031s | **1.2x** |
| b2sum | single 100KB text | 0.0014s | 0.0015s | **0.9x** |
| b2sum | single 1MB text | 0.0030s | 0.0026s | **1.2x** |
| b2sum | single 10MB text | 0.0191s | 0.0138s | **1.4x** |
| b2sum | single 10MB binary | 0.0207s | 0.0131s | **1.6x** |
| b2sum | single 100MB text | 0.1742s | 0.1124s | **1.5x** |
| b2sum | -l 256 10MB | 0.0194s | 0.0197s | **1.0x** |
| b2sum | -l 128 10MB | 0.0174s | 0.0145s | **1.2x** |
| b2sum | 100 files | 0.0062s | 0.0100s | **0.6x** |
| base64 | encode 100KB text | 0.0022s | 0.0102s | **0.2x** |
| base64 | encode 1MB text | 0.0080s | 0.0009s | **8.9x** |
| base64 | encode 10MB text | 0.0194s | 0.0164s | **1.2x** |
| base64 | encode 10MB binary | 0.0206s | 0.0090s | **2.3x** |
| base64 | decode 1MB | 0.0073s | 0.0035s | **2.1x** |
| base64 | decode 10MB | 0.0365s | 0.0170s | **2.1x** |
| base64 | encode -w 76 10MB | 0.0166s | 0.0077s | **2.2x** |
| base64 | encode -w 0 (no wrap) 10MB | 0.0077s | 0.0058s | **1.3x** |
| sort | lexicographic 1MB | 0.0981s | 0.0061s | **16.2x** |
| sort | lexicographic 10MB random | 0.3914s | 0.0181s | **21.6x** |
| sort | already sorted 10MB | 0.2157s | 0.0207s | **10.4x** |
| sort | reverse sorted 10MB | 0.2581s | 0.0150s | **17.2x** |
| sort | -n numeric 10MB | 0.4264s | 0.0330s | **12.9x** |
| sort | -r reverse 10MB | 0.3928s | 0.0273s | **14.4x** |
| sort | -u unique 10MB | 0.5745s | 0.0176s | **32.7x** |
| sort | -t, -k2 CSV 10MB | 0.5849s | 0.0235s | **24.9x** |
| sort | repetitive 10MB | 0.0647s | 0.0189s | **3.4x** |
| sort | --parallel=4 10MB | 0.4624s | 0.0239s | **19.3x** |
| tr | a-z to A-Z 1MB | 0.0024s | 0.0134s | **0.2x** |
| tr | a-z to A-Z 10MB | 0.0207s | 0.0101s | **2.1x** |
| tr | -d digits 10MB | 0.0186s | 0.0189s | **1.0x** |
| tr | -d lowercase 10MB | 0.0294s | 0.0262s | **1.1x** |
| tr | -s spaces 10MB | 0.0440s | 0.0289s | **1.5x** |
| tr | [:lower:] to [:upper:] 10MB | 0.0140s | 0.0141s | **1.0x** |
| tr | -d [:digit:] 10MB CSV | 0.0190s | 0.0148s | **1.3x** |
| tr | translate binary 10MB | 0.0134s | 0.0106s | **1.3x** |
| uniq | default 10MB many duplicates | 0.0110s | 0.0066s | **1.7x** |
| uniq | default 10MB sorted (low dup) | 0.0178s | 0.0114s | **1.6x** |
| uniq | -c count 10MB many dups | 0.0104s | 0.0087s | **1.2x** |
| uniq | -c count 10MB sorted | 0.0307s | 0.0088s | **3.5x** |
| uniq | -d duplicates only 10MB | 0.0097s | 0.0044s | **2.2x** |
| uniq | -u unique only 10MB | 0.0140s | 0.0160s | **0.9x** |
| uniq | -i case insensitive 10MB | 0.0213s | 0.0115s | **1.9x** |
| uniq | repetitive 10MB | 0.0471s | 0.0138s | **3.4x** |
| tac | reverse 100KB text | 0.0020s | 0.0018s | **1.1x** |
| tac | reverse 1MB text | 0.0031s | 0.0023s | **1.4x** |
| tac | reverse 10MB text | 0.0185s | 0.0089s | **2.1x** |
| tac | reverse 100MB text | 0.1277s | 0.0553s | **2.3x** |
| tac | reverse CSV 10MB | 0.0129s | 0.0081s | **1.6x** |
| tac | reverse repetitive 10MB | 0.0264s | 0.0127s | **2.1x** |
| tac | custom separator 1MB | 0.0077s | 0.0059s | **1.3x** |
