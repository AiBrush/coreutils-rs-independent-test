# fcoreutils v0.21.2 — Detailed Results

Generated: 2026-03-14 00:21:29 UTC
...
| base32 | encode 1MB text | 0.0024s | 0.0021s | **1.1x** |
| base32 | encode 10MB text | 0.0146s | 0.0107s | **1.4x** |
| base32 | encode 10MB binary | 0.0156s | 0.0110s | **1.4x** |
| base32 | decode 1MB | 0.0036s | 0.0025s | **1.5x** |
| base32 | decode 10MB | 0.0276s | 0.0158s | **1.8x** |
...
| base64 | decode 1MB | 0.0043s | 0.0020s | **2.1x** |
| base64 | decode 10MB | 0.0319s | 0.0045s | **7.0x** |
| base64 | encode -w 76 10MB | 0.0121s | 0.0046s | **2.6x** |
| base64 | encode -w 0 (no wrap) 10MB | 0.0084s | 0.0037s | **2.3x** |
...
| basenc | encode --base64 10MB | 0.0143s | 0.0052s | **2.8x** |
...
| cat | passthrough 10MB | 0.0013s | 0.0016s | 0.8x |
| cat | -n 1MB | 0.0016s | 0.0019s | 0.8x |
| cat | -n 10MB | 0.0099s | 0.0071s | **1.4x** |
| cat | -b 10MB | 0.0100s | 0.0064s | **1.6x** |
| cat | -A 1MB | 0.0016s | 0.0017s | 0.9x |
| cat | 100 small files | 0.0016s | 0.0019s | 0.9x |
| cat | binary 10MB | 0.0013s | 0.0016s | 0.8x |
...
| cksum | single 10MB text | 0.0028s | 0.0024s | **1.2x** |
| cksum | single 10MB binary | 0.0029s | 0.0026s | **1.1x** |
| comm | default 10MB sorted | 0.0237s | 0.0066s | **3.6x** |
| comm | -12 (common only) 10MB | 0.0187s | 0.0045s | **4.1x** |
| comm | -23 (unique to file1) 10MB | 0.0194s | 0.0051s | **3.8x** |
| comm | -3 10MB | 0.0210s | 0.0062s | **3.4x** |
| comm | identical 10MB sorted | 0.0283s | 0.0084s | **3.4x** |
| cp | cp small file (1KB) | 0.0020s | 0.0019s | **1.1x** |
| cp | cp medium file (1MB) | 0.0028s | 0.0027s | **1.0x** |
| cp | cp large file (10MB) | 0.0109s | 0.0107s | **1.0x** |
| cp | cp -r many small files (100 files) | 0.0076s | 0.0064s | **1.2x** |
...
| cut | -d, -f1 10MB CSV | 0.0162s | 0.0040s | **4.1x** |
| cut | -d, -f1,3,5 10MB CSV | 0.0216s | 0.0068s | **3.2x** |
| cut | -d, -f2-4 10MB CSV | 0.0238s | 0.0056s | **4.2x** |
| cut | --complement -d, -f1 10MB CSV | 0.0303s | 0.0042s | **7.1x** |
| cut | -d, -f1 100KB text | 0.0009s | 0.0015s | 0.6x |
...
| date | +%s (epoch) | 0.0009s | 0.0012s | 0.7x |
...
| dir | -R test data | 0.0012s | 0.0016s | 0.8x |
...
| du | du test data dir | 0.0009s | 0.0011s | 0.8x |
| du | -s (summary) | 0.0009s | 0.0012s | 0.8x |
| du | -sh (human summary) | 0.0009s | 0.0010s | 0.9x |
| du | --max-depth=1 | 0.0010s | 0.0011s | 0.9x |
| du | -b (bytes) | 0.0009s | 0.0011s | 0.8x |
| echo | echo hello | 0.0008s | 0.0011s | 0.8x |
| echo | echo -n hello | 0.0008s | 0.0009s | 0.9x |
| echo | echo -e with escapes | 0.0008s | 0.0010s | 0.8x |
| env | print all env vars | 0.0008s | 0.0012s | 0.7x |
| env | env true (run command) | 0.0017s | 0.0012s | **1.5x** |
| env | env VAR=value true | 0.0018s | 0.0019s | 0.9x |
| expand | expand 10MB tabbed (default) | 0.0460s | 0.0165s | **2.8x** |
| expand | expand 1MB text | 0.0034s | 0.0013s | **2.6x** |
| expand | -t 4 10MB tabbed | 0.0424s | 0.0132s | **3.2x** |
| expand | -t 2 10MB tabbed | 0.0363s | 0.0130s | **2.8x** |
| expand | --initial 10MB tabbed | 0.0239s | 0.0071s | **3.4x** |
| expand | expand CSV 10MB | 0.0197s | 0.0022s | **8.8x** |
| expr | expr 1 + 1 | 0.0009s | 0.0010s | **1.0x** |
| expr | expr 999999 * 999999 | 0.0010s | 0.0010s | **1.1x** |
...
| factor | factor 1-100000 via stdin | 0.0231s | 0.0162s | **1.4x** |
| false | false (startup overhead) | 0.0005s | 0.0007s | 0.7x |
| fmt | fmt 1MB text | 0.0170s | 0.0166s | **1.0x** |
| fmt | fmt 10MB text | 0.1449s | 0.1218s | **1.2x** |
| fmt | -w 40 10MB | 0.1231s | 0.0935s | **1.3x** |
| fmt | -w 120 10MB | 0.1756s | 0.1553s | **1.1x** |
| fmt | fmt wide lines 10MB | 0.1666s | 0.1421s | **1.2x** |
| fold | fold 10MB wide lines (default) | 0.0319s | 0.0040s | **8.0x** |
| fold | fold 1MB text | 0.0042s | 0.0016s | **2.7x** |
| fold | fold 10MB text | 0.0330s | 0.0052s | **6.3x** |
| fold | -w 40 10MB | 0.0332s | 0.0044s | **7.5x** |
| fold | -w 20 10MB | 0.0352s | 0.0057s | **6.1x** |
| fold | -s -w 60 10MB | 0.0353s | 0.0050s | **7.1x** |
| fold | -s -w 40 10MB | 0.0383s | 0.0060s | **6.4x** |
| fold | -b -w 40 10MB | 0.0288s | 0.0056s | **5.2x** |
...
| head | -n 1000 10MB | 0.0010s | 0.0011s | 0.9x |
| head | -n 100000 10MB | 0.0062s | 0.0038s | **1.6x** |
| head | -c 1000000 10MB | 0.0011s | 0.0011s | **1.0x** |
...
| join | self-join sorted 10MB | 0.0468s | 0.0389s | **1.2x** |
| kill | kill -l (list signals) | 0.0009s | 0.0011s | 0.8x |
| link | hard link a file | 0.0016s | 0.0018s | 0.9x |
| ln | symlink single file | 0.0017s | 0.0018s | **1.0x** |
...
| ls | -la test data dir | 0.0024s | 0.0022s | **1.1x** |
...
| md5sum | single 10MB text | 0.0172s | 0.0185s | 0.9x |
...
| mktemp | mktemp default | 0.0019s | 0.0020s | **1.0x** |
| mktemp | mktemp -d directory | 0.0026s | 0.0018s | **1.4x** |
| mv | mv same-fs small (1MB) | 0.0040s | 0.0039s | **1.0x** |
| mv | mv same-fs large (10MB) | 0.0114s | 0.0112s | **1.0x** |
...
| nl | default 10MB | 0.0360s | 0.0051s | **7.1x** |
| nl | -b a 10MB | 0.0358s | 0.0048s | **7.4x** |
| nl | -b a 10MB with blanks | 0.0453s | 0.0064s | **7.1x** |
| nl | -b a -n rz 10MB | 0.0380s | 0.0048s | **7.9x** |
| nl | -b a -w 8 -s ': ' 10MB | 0.0359s | 0.0048s | **7.5x** |
| nl | -b p'^the' 10MB | 0.0603s | 0.0055s | **10.9x** |
...
| numfmt | --to=si from CSV column | 0.0266s | 0.0192s | **1.4x** |
| od | default 1MB text | 0.0647s | 0.0096s | **6.7x** |
| od | -A x -t x1z 1MB | 0.1239s | 0.0167s | **7.4x** |
| od | -c 1MB text | 0.1281s | 0.0111s | **11.5x** |
| od | default 10MB binary | 0.6782s | 0.0895s | **7.6x** |
| od | -N 10000 10MB | 0.0022s | 0.0020s | **1.1x** |
| paste | 2 columns 10MB | 0.0238s | 0.0084s | **2.8x** |
| paste | 3 columns 10MB | 0.0307s | 0.0149s | **2.1x** |
| paste | -d comma 10MB | 0.0239s | 0.0083s | **2.9x** |
| paste | -s 10MB single file | 0.0105s | 0.0040s | **2.6x** |
| paste | stdin split 2-way 10MB | 0.0323s | 0.0079s | **4.1x** |
...
| pinky | pinky -l | - | - | - |
| pr | pr 1MB text | 0.0102s | 0.0013s | **7.6x** |
| pr | -2 (two columns) 1MB | 0.0114s | 0.0016s | **7.3x** |
| pr | -3 (three columns) 1MB | 0.0088s | 0.0016s | **5.6x** |
| pr | -n 1MB text | 0.0123s | 0.0019s | **6.4x** |
| pr | -t 1MB text | 0.0101s | 0.0013s | **8.0x** |
...
| rev | reverse 1MB text | 0.0144s | 0.0018s | **7.9x** |
| rev | reverse 10MB text | 0.1333s | 0.0079s | **16.8x** |
| rev | reverse CSV 10MB | 0.0995s | 0.0072s | **13.8x** |
| rev | reverse repetitive 10MB | 0.2865s | 0.0124s | **23.1x** |
...
| seq | seq 0 0.1 100000 (float) | 0.2386s | 0.0210s | **11.4x** |
| seq | seq -w 1 1000000 (zero-padded) | 0.2424s | 0.0158s | **15.4x** |
| sha1sum | single 1MB text | 0.0019s | 0.0018s | **1.1x** |
| sha1sum | single 10MB text | 0.0082s | 0.0078s | **1.0x** |
| sha1sum | single 10MB binary | 0.0082s | 0.0082s | **1.0x** |
| sha1sum | 100 files | 0.0023s | 0.0031s | 0.7x |
| sha224sum | single 1MB text | 0.0021s | 0.0018s | **1.2x** |
| sha224sum | single 10MB text | 0.0115s | 0.0090s | **1.3x** |
| sha224sum | single 10MB binary | 0.0108s | 0.0093s | **1.2x** |
| sha256sum | single 100KB text | 0.0013s | 0.0011s | **1.3x** |
| sha256sum | single 1MB text | 0.0020s | 0.0017s | **1.1x** |
...
| sha384sum | single 1MB text | 0.0026s | 0.0038s | 0.7x |
| sha384sum | single 10MB text | 0.0154s | 0.0166s | 0.9x |
| sha384sum | single 10MB binary | 0.0160s | 0.0174s | 0.9x |
| sha512sum | single 1MB text | 0.0027s | 0.0039s | 0.7x |
| sha512sum | single 10MB text | 0.0155s | 0.0166s | 0.9x |
| sha512sum | single 10MB binary | 0.0168s | 0.0175s | **1.0x** |
| shred | shred 1MB file | 0.0115s | 0.0063s | **1.8x** |
| shred | shred 1MB file with remove (-u) | 0.0273s | 0.0613s | 0.4x |
| shuf | shuf 1MB text | 0.0021s | 0.0016s | **1.3x** |
| shuf | shuf 10MB text | 0.0134s | 0.0065s | **2.1x** |
| shuf | -n 100 from 10MB | 0.0273s | 0.0039s | **6.9x** |
| shuf | -n 10000 from 10MB | 0.0301s | 0.0066s | **4.5x** |
| shuf | -i 1-1000000 | 0.0695s | 0.0155s | **4.5x** |
| shuf | -i 1-1000000 -n 100 | 0.0006s | 0.0008s | 0.8x |
| sleep | sleep 0 (startup overhead) | 0.0009s | 0.0009s | **1.0x** |
| sleep | sleep 0.001 (tiny sleep) | 0.0019s | 0.0020s | **1.0x** |
| sort | lexicographic 1MB | 0.0089s | 0.0042s | **2.1x** |
| sort | lexicographic 10MB random | 0.0626s | 0.0106s | **5.9x** |
| sort | already sorted 10MB | 0.0274s | 0.0058s | **4.7x** |
| sort | reverse sorted 10MB | 0.0285s | 0.0072s | **3.9x** |
| sort | -n numeric 10MB | 0.0771s | 0.0062s | **12.5x** |
| sort | -r reverse 10MB | 0.0572s | 0.0103s | **5.5x** |
| sort | -u unique 10MB | 0.0616s | 0.0115s | **5.3x** |
| sort | -t, -k2 CSV 10MB | 0.0748s | 0.0479s | **1.6x** |
| sort | repetitive 10MB | 0.0568s | 0.0147s | **3.9x** |
| sort | --parallel=4 10MB | 0.0565s | 0.0105s | **5.4x** |
| split | split 10MB into 1MB chunks (-b 1m) | 0.0109s | 0.0072s | **1.5x** |
| split | split 10MB by 1000 lines (-l 1000) | 0.0173s | 0.0175s | **1.0x** |
| stat | stat single file | 0.0008s | 0.0009s | 0.9x |
| stat | 100 files | 0.0026s | 0.0026s | **1.0x** |
| stat | --format=%s (size only) | 0.0007s | 0.0007s | **1.0x** |
| stat | --format='%n %s %Y' | 0.0008s | 0.0008s | 0.9x |
| stat | -f (filesystem) | 0.0007s | 0.0008s | 0.9x |
| stdbuf | -oL cat 1MB | 0.0013s | 0.0016s | 0.8x |
| stdbuf | -o0 cat 100KB | 0.0012s | 0.0015s | 0.8x |
| sum | single 1MB text | 0.0025s | 0.0023s | **1.1x** |
| sum | single 10MB text | 0.0174s | 0.0144s | **1.2x** |
| sum | single 10MB binary | 0.0182s | 0.0151s | **1.2x** |
| sync | sync (no args) | 0.0009s | 0.0009s | **1.0x** |
| tac | reverse 100KB text | 0.0012s | 0.0012s | **1.0x** |
| tac | reverse 1MB text | 0.0024s | 0.0017s | **1.4x** |
| tac | reverse 10MB text | 0.0109s | 0.0048s | **2.3x** |
| tac | reverse CSV 10MB | 0.0093s | 0.0044s | **2.1x** |
| tac | reverse repetitive 10MB | 0.0232s | 0.0084s | **2.8x** |
| tac | custom separator 1MB | 0.0060s | 0.0041s | **1.4x** |
...
| tail | -n +100000 10MB (from line 100000) | 0.0039s | 0.0034s | **1.2x** |
...
| tee | tee 10MB to /dev/null | 0.0076s | 0.0064s | **1.2x** |
...
| timeout | timeout 10 echo hello | 0.0027s | 0.0029s | 0.9x |
...
| tr | a-z to A-Z 10MB | 0.0193s | 0.0049s | **4.0x** |
| tr | -d digits 10MB | 0.0187s | 0.0061s | **3.1x** |
| tr | -d lowercase 10MB | 0.0310s | 0.0060s | **5.1x** |
| tr | -s spaces 10MB | 0.0283s | 0.0037s | **7.6x** |
| tr | [:lower:] to [:upper:] 10MB | 0.0131s | 0.0042s | **3.1x** |
| tr | -d [:digit:] 10MB CSV | 0.0167s | 0.0051s | **3.3x** |
| tr | translate binary 10MB | 0.0127s | 0.0041s | **3.1x** |
...
| tsort | tsort 100K pairs | 0.0567s | 0.0072s | **7.9x** |
| tsort | tsort 1M pairs | 0.6507s | 0.0634s | **10.3x** |
| tty | tty (no args) | 0.0008s | 0.0010s | 0.8x |
| uname | uname (no args) | 0.0009s | 0.0009s | 0.9x |
| uname | uname -a | 0.0009s | 0.0014s | 0.6x |
| uname | uname -r | 0.0008s | 0.0009s | 0.9x |
| uname | uname -m | 0.0009s | 0.0010s | 0.9x |
| unexpand | unexpand 1MB text | 0.0030s | 0.0012s | **2.6x** |
| unexpand | unexpand 10MB text | 0.0227s | 0.0026s | **8.8x** |
| unexpand | -a 1MB text | 0.0090s | 0.0012s | **7.6x** |
| unexpand | -a 10MB text | 0.0836s | 0.0024s | **35.1x** |
| unexpand | -t 4 10MB text | 0.0835s | 0.0024s | **35.4x** |
| unexpand | expand|unexpand pipeline 10MB | 0.1104s | 0.0700s | **1.6x** |
| uniq | default 10MB many duplicates | 0.0096s | 0.0015s | **6.5x** |
| uniq | default 10MB sorted (low dup) | 0.0194s | 0.0031s | **6.2x** |
| uniq | -c count 10MB many dups | 0.0097s | 0.0014s | **6.7x** |
| uniq | -c count 10MB sorted | 0.0297s | 0.0070s | **4.3x** |
| uniq | -d duplicates only 10MB | 0.0092s | 0.0014s | **6.8x** |
| uniq | -u unique only 10MB | 0.0091s | 0.0013s | **6.8x** |
| uniq | -i case insensitive 10MB | 0.0189s | 0.0043s | **4.3x** |
| uniq | repetitive 10MB | 0.0489s | 0.0032s | **15.3x** |
...
| users | users (default) | 0.0009s | 0.0012s | 0.7x |
| vdir | vdir current directory | 0.0013s | 0.0014s | 0.9x |
| vdir | 100 files directory | 0.0019s | 0.0018s | **1.1x** |
| vdir | -R test data | 0.0019s | 0.0018s | **1.0x** |
| wc | default 100KB text | 0.0014s | 0.0012s | **1.1x** |
| wc | default 1MB text | 0.0059s | 0.0036s | **1.6x** |
| wc | default 10MB text | 0.0550s | 0.0031s | **17.9x** |
| wc | -l 10MB text | 0.0021s | 0.0019s | **1.1x** |
| wc | -w 10MB text | 0.0543s | 0.0138s | **3.9x** |
| wc | -c 10MB text | 0.0009s | 0.0009s | 0.9x |
| wc | -m 10MB text | 0.0545s | 0.0031s | **17.5x** |
| wc | -L 10MB text | 0.0543s | 0.0110s | **4.9x** |
| wc | default 10MB binary | 0.3163s | 0.0273s | **11.6x** |
| wc | default 10MB repetitive | 0.0736s | 0.0046s | **16.1x** |
...
| yes | throughput 10M lines | 0.0243s | 0.0268s | 0.9x |
| yes | throughput hello 1M lines | 0.0064s | 0.0064s | **1.0x** |
| yes | throughput hello 10M lines | 0.0524s | 0.0587s | 0.9x |
...
|------|------|----------:|-----------:|-----------:|-----------:|------------:|
| base64 | encode 1MB | 0.0021s | 0.0015s | 0.0012s | **1.7x** | **1.2x** |
| cat | passthrough 1MB | 0.0010s | 0.0014s | 0.0003s | **3.4x** | **5.0x** |
| cat | passthrough 10MB | 0.0015s | 0.0019s | 0.0005s | **2.9x** | **3.8x** |
| cat | -n 10MB | 0.0103s | 0.0064s | 0.0110s | 0.9x | 0.6x |
| cut | 10MB -c1-20 | 0.0191s | 0.0038s | 0.0045s | **4.3x** | 0.9x |
| echo | short string | 0.0000s | 0.0009s | 0.0002s | 0.2x | **4.7x** |
| expand | 10MB text | 0.0250s | 0.0021s | 0.0059s | **4.3x** | 0.4x |
| fold | 10MB default width | 0.0352s | 0.0057s | 0.0051s | **6.9x** | **1.1x** |
| fold | 10MB -w 40 | 0.0367s | 0.0064s | 0.0054s | **6.8x** | **1.2x** |
| head | first 1000 lines 10MB | 0.0009s | 0.0013s | 0.0003s | **2.7x** | **3.7x** |
| md5sum | 10MB file | 0.0175s | 0.0194s | 0.0253s | 0.7x | 0.8x |
| nl | 10MB text | 0.0319s | 0.0044s | 0.0032s | **10.0x** | **1.4x** |
| od | 1MB text | 0.0643s | 0.0097s | 0.0062s | **10.3x** | **1.6x** |
| rev | 10MB text | 0.1363s | 0.0080s | 0.0142s | **9.6x** | 0.6x |
| seq | 1 to 1M | 0.0104s | 0.0025s | 0.0011s | **9.8x** | **2.3x** |
| seq | 1 to 10M | 0.0957s | 0.0135s | 0.0047s | **20.3x** | **2.9x** |
| sort | 1MB text | 0.0085s | 0.0040s | 0.0061s | **1.4x** | 0.7x |
| tac | reverse 1MB | 0.0020s | 0.0015s | 0.0009s | **2.1x** | **1.6x** |
| tail | last 1000 lines 10MB | 0.0009s | 0.0013s | 0.0003s | **3.0x** | **4.1x** |
| tr | 10MB lowercase | 0.0104s | 0.0026s | 0.0046s | **2.2x** | 0.6x |
| unexpand | 10MB text | 0.0246s | 0.0021s | 0.0061s | **4.0x** | 0.3x |
| uniq | 10MB sorted | 0.0204s | 0.0029s | 0.0033s | **6.2x** | 0.9x |
| wc | 10MB text | 0.0547s | 0.0030s | 0.0364s | **1.5x** | 0.1x |
| wc | 10MB -l only | 0.0019s | 0.0018s | 0.0013s | **1.5x** | **1.5x** |
| yes | 1M lines | 0.0032s | 0.0033s | 0.0032s | **1.0x** | **1.0x** |
