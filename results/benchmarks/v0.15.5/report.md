# fcoreutils v0.15.5 — Detailed Results

Generated: 2026-03-01 19:14:24 UTC
...
| base32 | encode 10MB text | 0.0149s | 0.0115s | **1.3x** |
| base32 | encode 10MB binary | 0.0154s | 0.0119s | **1.3x** |
| base32 | decode 1MB | 0.0036s | 0.0026s | **1.4x** |
| base32 | decode 10MB | 0.0280s | 0.0172s | **1.6x** |
| base64 | encode 100KB text | 0.0010s | 0.0014s | 0.7x |
| base64 | encode 1MB text | 0.0021s | 0.0017s | **1.3x** |
| base64 | encode 10MB text | 0.0132s | 0.0059s | **2.2x** |
| base64 | encode 10MB binary | 0.0135s | 0.0059s | **2.3x** |
| base64 | decode 1MB | 0.0041s | 0.0023s | **1.8x** |
| base64 | decode 10MB | 0.0331s | 0.0050s | **6.6x** |
| base64 | encode -w 76 10MB | 0.0127s | 0.0056s | **2.3x** |
...
| basenc | encode --base64 10MB | 0.0129s | 0.0055s | **2.3x** |
| basenc | encode --base32 1MB | 0.0023s | 0.0024s | **1.0x** |
| basenc | encode --base16 1MB | 0.0026s | 0.0027s | 0.9x |
| basenc | decode --base64 -d 1MB | 0.0044s | 0.0037s | **1.2x** |
| cat | passthrough 1MB | 0.0010s | 0.0011s | 0.9x |
| cat | passthrough 10MB | 0.0016s | 0.0012s | **1.3x** |
| cat | -n 1MB | 0.0020s | 0.0019s | **1.0x** |
| cat | -n 10MB | 0.0106s | 0.0063s | **1.7x** |
| cat | -b 10MB | 0.0103s | 0.0066s | **1.6x** |
...
| chown | chown current user on file | 0.0463s | 0.0024s | **19.6x** |
...
| comm | default 10MB sorted | 0.0266s | 0.0072s | **3.7x** |
| comm | -12 (common only) 10MB | 0.0213s | 0.0060s | **3.6x** |
| comm | -23 (unique to file1) 10MB | 0.0209s | 0.0058s | **3.6x** |
| comm | -3 10MB | 0.0224s | 0.0068s | **3.3x** |
| comm | identical 10MB sorted | 0.0295s | 0.0111s | **2.6x** |
| cp | cp small file (1KB) | 0.0021s | 0.0020s | **1.0x** |
| cp | cp medium file (1MB) | 0.0030s | 0.0027s | **1.1x** |
| cp | cp large file (10MB) | 0.0103s | 0.0140s | 0.7x |
| cp | cp -r many small files (100 files) | 0.0074s | 0.0062s | **1.2x** |
| cp | cp -r deep directory (8 levels) | 0.0032s | 0.0031s | **1.0x** |
| cut | -b1-100 10MB CSV | 0.0225s | 0.0039s | **5.8x** |
| cut | -c1-100 10MB CSV | 0.0224s | 0.0039s | **5.7x** |
| cut | -d, -f1 10MB CSV | 0.0166s | 0.0094s | **1.8x** |
| cut | -d, -f1,3,5 10MB CSV | 0.0217s | 0.0111s | **1.9x** |
| cut | -d, -f2-4 10MB CSV | 0.0237s | 0.0102s | **2.3x** |
...
| date | ISO 8601 format | 0.0008s | 0.0010s | 0.9x |
| date | RFC 3339 | 0.0009s | 0.0010s | 0.9x |
| date | -u (UTC) | 0.0009s | 0.0010s | 0.9x |
| dd | dd read 10MB (bs=4096) | 0.0048s | 0.0050s | **1.0x** |
| dd | dd write 10MB from /dev/zero (bs=1M count=10) | 0.0106s | 0.0210s | 0.5x |
| df | df (default) | 0.0009s | 0.0009s | **1.1x** |
| df | -h (human readable) | 0.0009s | 0.0009s | **1.1x** |
| df | df / | 0.0007s | 0.0008s | 0.9x |
| df | -i (inodes) | 0.0008s | 0.0012s | 0.7x |
| dir | dir current directory | 0.0011s | 0.0012s | 0.9x |
| dir | 100 files directory | 0.0012s | 0.0016s | 0.8x |
...
| du | --max-depth=1 | 0.0015s | 0.0020s | 0.8x |
| du | -b (bytes) | 0.0014s | 0.0020s | 0.7x |
| echo | echo hello | 0.0008s | 0.0009s | 0.9x |
| echo | echo -n hello | 0.0010s | 0.0010s | **1.0x** |
...
| env | env VAR=value true | 0.0012s | 0.0014s | 0.9x |
| expand | expand 10MB tabbed (default) | 0.0452s | 0.0358s | **1.3x** |
| expand | expand 1MB text | 0.0033s | 0.0010s | **3.3x** |
| expand | -t 4 10MB tabbed | 0.0421s | 0.0358s | **1.2x** |
| expand | -t 2 10MB tabbed | 0.0360s | 0.0365s | **1.0x** |
| expand | --initial 10MB tabbed | 0.0236s | 0.0069s | **3.4x** |
| expand | expand CSV 10MB | 0.0209s | 0.0020s | **10.2x** |
| expr | expr 1 + 1 | 0.0009s | 0.0010s | 0.8x |
...
| factor | factor 1-100000 via stdin | 0.0194s | 0.0108s | **1.8x** |
| false | false (startup overhead) | 0.0001s | 0.0007s | 0.2x |
| fmt | fmt 1MB text | 0.0165s | 0.0185s | 0.9x |
| fmt | fmt 10MB text | 0.1416s | 0.1521s | 0.9x |
| fmt | -w 40 10MB | 0.1209s | 0.1148s | **1.1x** |
| fmt | -w 120 10MB | 0.1712s | 0.1991s | 0.9x |
| fmt | fmt wide lines 10MB | 0.1622s | 0.1785s | 0.9x |
| fold | fold 10MB wide lines (default) | 0.0347s | 0.0059s | **5.9x** |
| fold | fold 1MB text | 0.0043s | 0.0019s | **2.2x** |
| fold | fold 10MB text | 0.0352s | 0.0080s | **4.4x** |
| fold | -w 40 10MB | 0.0370s | 0.0065s | **5.7x** |
| fold | -w 20 10MB | 0.0383s | 0.0077s | **5.0x** |
| fold | -s -w 60 10MB | 0.0377s | 0.0065s | **5.8x** |
| fold | -s -w 40 10MB | 0.0410s | 0.0070s | **5.8x** |
| fold | -b -w 40 10MB | 0.0346s | 0.0060s | **5.8x** |
| groups | groups (no args) | 0.0010s | 0.0011s | **1.0x** |
...
| head | -n 100000 10MB | 0.0062s | 0.0030s | **2.1x** |
| head | -c 1000000 10MB | 0.0011s | 0.0010s | **1.2x** |
...
| join | self-join sorted 10MB | 0.0462s | 0.0380s | **1.2x** |
...
| md5sum | single 10MB text | 0.0170s | 0.0197s | 0.9x |
| md5sum | single 10MB binary | 0.0179s | 0.0205s | 0.9x |
| md5sum | 10 files | 0.0014s | 0.0010s | **1.3x** |
...
| mv | mv same-fs large (10MB) | 0.0114s | 0.0115s | **1.0x** |
...
| nl | default 1MB | 0.0051s | 0.0019s | **2.7x** |
| nl | default 10MB | 0.0372s | 0.0078s | **4.8x** |
| nl | -b a 10MB | 0.0360s | 0.0071s | **5.0x** |
| nl | -b a 10MB with blanks | 0.0455s | 0.0095s | **4.8x** |
| nl | -b a -n rz 10MB | 0.0361s | 0.0075s | **4.8x** |
| nl | -b a -w 8 -s ': ' 10MB | 0.0365s | 0.0079s | **4.6x** |
| nl | -b p'^the' 10MB | 0.0602s | 0.0127s | **4.7x** |
...
| numfmt | --to=si from CSV column | 0.0232s | 0.0177s | **1.3x** |
| od | default 1MB text | 0.0726s | 0.0415s | **1.7x** |
| od | -A x -t x1z 1MB | 0.1190s | 0.0690s | **1.7x** |
| od | -c 1MB text | 0.1195s | 0.0455s | **2.6x** |
| od | default 10MB binary | 0.6631s | 0.4311s | **1.5x** |
| od | -N 10000 10MB | 0.0022s | 0.0023s | 0.9x |
| paste | 2 columns 10MB | 0.0240s | 0.0110s | **2.2x** |
| paste | 3 columns 10MB | 0.0302s | 0.0143s | **2.1x** |
| paste | -d comma 10MB | 0.0240s | 0.0089s | **2.7x** |
| paste | -s 10MB single file | 0.0105s | 0.0053s | **2.0x** |
| paste | stdin split 2-way 10MB | 0.0331s | 0.0180s | **1.8x** |
| pathchk | pathchk default | 0.0008s | 0.0010s | 0.9x |
| pathchk | pathchk -p (POSIX portable) | 0.0008s | 0.0009s | 0.9x |
| pinky | pinky (default) | 0.0006s | 0.0010s | 0.6x |
| pinky | pinky -l | - | - | - |
| pr | pr 1MB text | 0.0102s | 0.0027s | **3.8x** |
| pr | -2 (two columns) 1MB | 0.0122s | 0.0027s | **4.4x** |
| pr | -3 (three columns) 1MB | 0.0087s | 0.0030s | **2.9x** |
...
| printf | string padding | 0.0015s | 0.0010s | **1.5x** |
| ptx | ptx 10KB text | 0.0019s | 0.0016s | **1.2x** |
| ptx | ptx 100KB text | 0.0109s | 0.0055s | **2.0x** |
| ptx | -w 60 100KB text | 0.0104s | 0.0052s | **2.0x** |
...
| rev | reverse 1MB text | 0.0143s | 0.0018s | **8.0x** |
| rev | reverse 10MB text | 0.1387s | 0.0074s | **18.7x** |
| rev | reverse CSV 10MB | 0.0999s | 0.0075s | **13.4x** |
| rev | reverse repetitive 10MB | 0.2886s | 0.0121s | **23.8x** |
...
| seq | seq 1000000 | 0.0114s | 0.0024s | **4.7x** |
| seq | seq 1 10000000 | 0.0966s | 0.0135s | **7.2x** |
| seq | seq 0 0.1 100000 (float) | 0.2309s | 0.0188s | **12.3x** |
| seq | seq -w 1 1000000 (zero-padded) | 0.2423s | 0.0157s | **15.4x** |
| sha1sum | single 1MB text | 0.0019s | 0.0017s | **1.1x** |
| sha1sum | single 10MB text | 0.0081s | 0.0075s | **1.1x** |
| sha1sum | single 10MB binary | 0.0084s | 0.0080s | **1.0x** |
...
| sha224sum | single 10MB binary | 0.0090s | 0.0085s | **1.1x** |
| sha256sum | single 100KB text | 0.0013s | 0.0010s | **1.3x** |
| sha256sum | single 1MB text | 0.0019s | 0.0017s | **1.1x** |
| sha256sum | single 10MB text | 0.0084s | 0.0077s | **1.1x** |
| sha256sum | single 10MB binary | 0.0086s | 0.0083s | **1.0x** |
| sha256sum | 10 files | 0.0013s | 0.0011s | **1.3x** |
| sha256sum | 100 files | 0.0024s | 0.0016s | **1.5x** |
| sha384sum | single 1MB text | 0.0027s | 0.0030s | 0.9x |
| sha384sum | single 10MB text | 0.0154s | 0.0212s | 0.7x |
| sha384sum | single 10MB binary | 0.0162s | 0.0219s | 0.7x |
| sha512sum | single 1MB text | 0.0027s | 0.0030s | 0.9x |
| sha512sum | single 10MB text | 0.0155s | 0.0203s | 0.8x |
| sha512sum | single 10MB binary | 0.0161s | 0.0211s | 0.8x |
| shred | shred 1MB file | 0.0110s | 0.0066s | **1.7x** |
| shred | shred 1MB file with remove (-u) | 0.0188s | 0.0080s | **2.4x** |
| shuf | shuf 1MB text | 0.0030s | 0.0021s | **1.4x** |
| shuf | shuf 10MB text | 0.0165s | 0.0121s | **1.4x** |
| shuf | -n 100 from 10MB | 0.0185s | 0.0092s | **2.0x** |
| shuf | -n 10000 from 10MB | 0.0209s | 0.0089s | **2.3x** |
| shuf | -i 1-1000000 | 0.0699s | 0.0218s | **3.2x** |
...
| sort | lexicographic 10MB random | 0.0604s | 0.0092s | **6.5x** |
| sort | already sorted 10MB | 0.0264s | 0.0051s | **5.2x** |
| sort | reverse sorted 10MB | 0.0275s | 0.0067s | **4.1x** |
| sort | -n numeric 10MB | 0.0752s | 0.0056s | **13.3x** |
| sort | -r reverse 10MB | 0.0541s | 0.0090s | **6.0x** |
| sort | -u unique 10MB | 0.0571s | 0.0091s | **6.3x** |
| sort | -t, -k2 CSV 10MB | 0.0666s | 0.0385s | **1.7x** |
| sort | repetitive 10MB | 0.0548s | 0.0131s | **4.2x** |
| sort | --parallel=4 10MB | 0.0561s | 0.0091s | **6.1x** |
| split | split 10MB into 1MB chunks (-b 1m) | - | - | - |
| split | split 10MB by 1000 lines (-l 1000) | 0.0169s | 0.0178s | **1.0x** |
...
| sum | single 10MB text | 0.0177s | 0.0149s | **1.2x** |
| sum | single 10MB binary | 0.0187s | 0.0154s | **1.2x** |
| sync | sync (no args) | 0.0010s | 0.0010s | **1.1x** |
| tac | reverse 100KB text | 0.0009s | 0.0014s | 0.7x |
| tac | reverse 1MB text | 0.0019s | 0.0020s | **1.0x** |
| tac | reverse 10MB text | 0.0108s | 0.0053s | **2.0x** |
| tac | reverse CSV 10MB | 0.0092s | 0.0051s | **1.8x** |
...
| tail | -n +100000 10MB (from line 100000) | 0.0041s | 0.0035s | **1.2x** |
...
| timeout | timeout 10 echo hello | 0.0018s | 0.0111s | 0.2x |
...
| tr | a-z to A-Z 1MB | 0.0032s | 0.0029s | **1.1x** |
| tr | a-z to A-Z 10MB | 0.0200s | 0.0043s | **4.6x** |
| tr | -d digits 10MB | 0.0248s | 0.0067s | **3.7x** |
| tr | -d lowercase 10MB | 0.0383s | 0.0064s | **6.0x** |
| tr | -s spaces 10MB | 0.0358s | 0.0042s | **8.5x** |
| tr | [:lower:] to [:upper:] 10MB | 0.0123s | 0.0037s | **3.3x** |
| tr | -d [:digit:] 10MB CSV | 0.0175s | 0.0042s | **4.2x** |
| tr | translate binary 10MB | 0.0123s | 0.0038s | **3.2x** |
| true | true (startup overhead) | 0.0000s | 0.0007s | 0.0x |
| truncate | truncate to zero (-s 0) | 0.0030s | 0.0032s | **1.0x** |
| truncate | create 1M file (-s 1M) | 0.0017s | 0.0020s | 0.9x |
| tsort | tsort 100K pairs | 0.0604s | 0.0129s | **4.7x** |
| tsort | tsort 1M pairs | 0.6407s | 0.0742s | **8.6x** |
...
| unexpand | unexpand 1MB text | 0.0031s | 0.0013s | **2.3x** |
| unexpand | unexpand 10MB text | 0.0246s | 0.0041s | **6.0x** |
| unexpand | -a 1MB text | 0.0075s | 0.0052s | **1.4x** |
| unexpand | -a 10MB text | 0.0704s | 0.0372s | **1.9x** |
| unexpand | -t 4 10MB text | 0.0700s | 0.0390s | **1.8x** |
| unexpand | expand|unexpand pipeline 10MB | 0.0973s | 0.1006s | **1.0x** |
| uniq | default 10MB many duplicates | 0.0160s | 0.0018s | **8.6x** |
| uniq | default 10MB sorted (low dup) | 0.0150s | 0.0042s | **3.6x** |
| uniq | -c count 10MB many dups | 0.0125s | 0.0024s | **5.3x** |
...
| uniq | -i case insensitive 10MB | 0.0144s | 0.0044s | **3.3x** |
| uniq | repetitive 10MB | 0.0414s | 0.0035s | **11.7x** |
...
| vdir | vdir current directory | 0.0013s | 0.0013s | **1.0x** |
...
| wc | -w 10MB text | 0.0541s | 0.0134s | **4.0x** |
| wc | -c 10MB text | 0.0009s | 0.0010s | 0.9x |
| wc | -m 10MB text | 0.0541s | 0.0030s | **17.8x** |
| wc | -L 10MB text | 0.0542s | 0.0099s | **5.5x** |
| wc | default 10MB binary | 0.3175s | 0.0273s | **11.7x** |
| wc | default 10MB repetitive | 0.0731s | 0.0048s | **15.3x** |
...
| who | who -b (boot) | 0.0006s | 0.0010s | 0.7x |
| whoami | whoami (no args) | 0.0010s | 0.0011s | 0.9x |
| yes | throughput 1M lines | 0.0034s | 0.0031s | **1.1x** |
| yes | throughput 10M lines | 0.0305s | 0.0235s | **1.3x** |
| yes | throughput hello 1M lines | 0.0063s | 0.0064s | **1.0x** |
| yes | throughput hello 10M lines | 0.0571s | 0.0614s | 0.9x |
| yes | throughput 100MB | 0.0450s | 0.0444s | **1.0x** |
