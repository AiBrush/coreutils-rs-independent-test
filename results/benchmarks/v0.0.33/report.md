...
|------|------|-----------|-------------------|---------|
| cut | -b1-100 10MB CSV | 0.0367s | 0.0000s | **2620.1x** |
| cut | -c1-100 10MB CSV | 0.0322s | 0.0097s | **3.3x** |
| cut | -d, -f1 10MB CSV | 0.0393s | 0.0125s | **3.2x** |
| cut | -d, -f1,3,5 10MB CSV | 0.0563s | 0.0105s | **5.4x** |
| cut | -d, -f2-4 10MB CSV | 0.0408s | 0.0041s | **9.9x** |
| cut | --complement -d, -f1 10MB CSV | 0.0531s | 0.0137s | **3.9x** |
| cut | -d, -f1 100KB text | 0.0015s | 0.0015s | **1.0x** |
| cut | -d, -f1 1MB text | 0.0034s | 0.0032s | **1.1x** |
| cut | -d: -f1 colon file | 0.0025s | 0.0046s | **0.5x** |
| sha256sum | single 100KB text | 0.0003s | 0.0061s | - |
| sha256sum | single 1MB text | 0.0261s | 0.0000s | **726.1x** |
| sha256sum | single 10MB text | 0.0536s | 0.0060s | **8.9x** |
| sha256sum | single 10MB binary | 0.0605s | 0.0076s | **7.9x** |
| sha256sum | single 100MB text | 0.3939s | 0.0777s | **5.1x** |
| sha256sum | 10 files | 0.0307s | 0.0020s | **15.5x** |
| sha256sum | 100 files | 0.0051s | 0.0169s | **0.3x** |
| md5sum | single 100KB text | 0.0016s | 0.0015s | **1.1x** |
| md5sum | single 1MB text | 0.0087s | 0.0071s | **1.2x** |
| md5sum | single 10MB text | 0.0531s | 0.0254s | **2.1x** |
| md5sum | single 10MB binary | 0.0554s | 0.0362s | **1.5x** |
| md5sum | single 100MB text | 0.2649s | 0.2510s | **1.1x** |
| md5sum | 10 files | 0.0017s | 0.0014s | **1.2x** |
| md5sum | 100 files | 0.0046s | 0.0022s | **2.1x** |
| b2sum | single 100KB text | 0.0004s | 0.0004s | **1.0x** |
| b2sum | single 1MB text | 0.0222s | 0.0011s | **20.4x** |
| b2sum | single 10MB text | 0.0293s | 0.0409s | **0.7x** |
| b2sum | single 10MB binary | 0.0324s | 0.0226s | **1.4x** |
| b2sum | single 100MB text | 0.2456s | 0.2020s | **1.2x** |
| b2sum | -l 256 10MB | 0.0294s | 0.0225s | **1.3x** |
| b2sum | -l 128 10MB | 0.0216s | 0.0196s | **1.1x** |
| b2sum | 100 files | 0.0046s | 0.0092s | **0.5x** |
| base64 | encode 100KB text | 0.0002s | 0.0000s | **15.5x** |
| base64 | encode 1MB text | 0.0043s | 0.0113s | **0.4x** |
| base64 | encode 10MB text | 0.0519s | 0.0133s | **3.9x** |
| base64 | encode 10MB binary | 0.0340s | 0.0161s | **2.1x** |
| base64 | decode 1MB | 0.0055s | 0.0086s | **0.6x** |
| base64 | decode 10MB | 0.0348s | 0.0189s | **1.8x** |
| base64 | encode -w 76 10MB | 0.0283s | 0.0076s | **3.7x** |
| base64 | encode -w 0 (no wrap) 10MB | 0.0336s | 0.0026s | **12.8x** |
| sort | lexicographic 1MB | 0.1260s | 0.0038s | **33.1x** |
| sort | lexicographic 10MB random | 0.6086s | 0.0260s | **23.4x** |
| sort | already sorted 10MB | 0.2214s | 0.0083s | **26.6x** |
| sort | reverse sorted 10MB | 0.2250s | 0.0110s | **20.5x** |
| sort | -n numeric 10MB | 0.5584s | 0.0540s | **10.3x** |
| sort | -r reverse 10MB | 0.4991s | 0.0218s | **22.9x** |
| sort | -u unique 10MB | 0.5561s | 0.0744s | **7.5x** |
| sort | -t, -k2 CSV 10MB | 0.5799s | 0.0452s | **12.8x** |
| sort | repetitive 10MB | 0.0527s | 0.0137s | **3.9x** |
| sort | --parallel=4 10MB | 0.4625s | 0.0159s | **29.0x** |
| tr | a-z to A-Z 1MB | 0.0050s | 0.0065s | **0.8x** |
| tr | a-z to A-Z 10MB | 0.0166s | 0.0069s | **2.4x** |
| tr | -d digits 10MB | 0.0171s | 0.0107s | **1.6x** |
| tr | -d lowercase 10MB | 0.0298s | 0.0208s | **1.4x** |
| tr | -s spaces 10MB | 0.0454s | 0.0214s | **2.1x** |
| tr | [:lower:] to [:upper:] 10MB | 0.0145s | 0.0147s | **1.0x** |
| tr | -d [:digit:] 10MB CSV | 0.0424s | 0.0116s | **3.6x** |
| tr | translate binary 10MB | 0.0560s | 0.1029s | **0.5x** |
| uniq | default 10MB many duplicates | 0.0337s | 0.0033s | **10.3x** |
| uniq | default 10MB sorted (low dup) | 0.0103s | 0.0015s | **6.8x** |
| uniq | -c count 10MB many dups | 0.0133s | 0.0132s | **1.0x** |
| uniq | -c count 10MB sorted | 0.0471s | 0.0197s | **2.4x** |
| uniq | -d duplicates only 10MB | 0.0133s | 0.0061s | **2.2x** |
| uniq | -u unique only 10MB | 0.0156s | 0.0072s | **2.2x** |
| uniq | -i case insensitive 10MB | 0.0275s | 0.0152s | **1.8x** |
| uniq | repetitive 10MB | 0.0404s | 0.0089s | **4.6x** |
| tac | reverse 100KB text | 0.0021s | 0.0016s | **1.4x** |
| tac | reverse 1MB text | 0.0026s | 0.0000s | **294.2x** |
| tac | reverse 10MB text | 0.0195s | 0.0102s | **1.9x** |
| tac | reverse 100MB text | 0.1342s | 0.0824s | **1.6x** |
| tac | reverse CSV 10MB | 0.0051s | 0.0138s | **0.4x** |
| tac | reverse repetitive 10MB | 0.0324s | 0.0091s | **3.6x** |
| tac | custom separator 1MB | 0.0198s | 0.0083s | **2.4x** |
