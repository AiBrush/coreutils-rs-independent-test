# fcoreutils v0.19.9 — Detailed Results

Generated: 2026-03-12 14:02:40 UTC
...
| b2sum | single 10MB text | 0.0149s | 0.0123s | **1.2x** |
| b2sum | single 10MB binary | 0.0155s | 0.0125s | **1.2x** |
| b2sum | -l 256 10MB | 0.0146s | 0.0122s | **1.2x** |
...
| base32 | encode 10MB binary | 0.0151s | 0.0112s | **1.3x** |
| base32 | decode 1MB | 0.0035s | 0.0025s | **1.4x** |
| base32 | decode 10MB | 0.0276s | 0.0159s | **1.7x** |
| base64 | encode 100KB text | 0.0010s | 0.0010s | **1.0x** |
| base64 | encode 1MB text | 0.0021s | 0.0013s | **1.6x** |
| base64 | encode 10MB text | 0.0122s | 0.0048s | **2.6x** |
| base64 | encode 10MB binary | 0.0126s | 0.0054s | **2.4x** |
| base64 | decode 1MB | 0.0040s | 0.0020s | **2.0x** |
| base64 | decode 10MB | 0.0326s | 0.0046s | **7.1x** |
| base64 | encode -w 76 10MB | 0.0120s | 0.0048s | **2.5x** |
| base64 | encode -w 0 (no wrap) 10MB | 0.0084s | 0.0035s | **2.4x** |
...
| cat | passthrough 10MB | 0.0017s | 0.0029s | 0.6x |
| cat | -n 1MB | 0.0021s | 0.0019s | **1.1x** |
| cat | -n 10MB | 0.0125s | 0.0076s | **1.6x** |
| cat | -b 10MB | 0.0107s | 0.0061s | **1.8x** |
| cat | -A 1MB | 0.0020s | 0.0019s | **1.0x** |
| cat | 100 small files | 0.0029s | 0.0028s | **1.0x** |
| cat | binary 10MB | 0.0017s | 0.0022s | 0.8x |
| chgrp | chgrp current group on file | 0.0023s | 0.0024s | 0.9x |
| chgrp | chgrp current group on 1MB file | 0.0030s | 0.0031s | **1.0x** |
| chown | chown current user on file | 0.0025s | 0.0025s | **1.0x** |
| chown | chown current user on 1MB file | 0.0145s | 0.0034s | **4.2x** |
| cksum | single 1MB text | 0.0016s | 0.0011s | **1.4x** |
...
| comm | -12 (common only) 10MB | 0.0209s | 0.0050s | **4.2x** |
| comm | -23 (unique to file1) 10MB | 0.0224s | 0.0057s | **3.9x** |
| comm | -3 10MB | 0.0226s | 0.0066s | **3.4x** |
| comm | identical 10MB sorted | 0.0301s | 0.0094s | **3.2x** |
| cp | cp small file (1KB) | 0.0021s | 0.0019s | **1.1x** |
| cp | cp medium file (1MB) | 0.0030s | 0.0028s | **1.1x** |
| cp | cp large file (10MB) | 0.0109s | 0.0111s | **1.0x** |
| cp | cp -r many small files (100 files) | 0.0073s | 0.0067s | **1.1x** |
| cp | cp -r deep directory (8 levels) | 0.0034s | 0.0032s | **1.1x** |
| cut | -b1-100 10MB CSV | 0.0230s | 0.0043s | **5.4x** |
| cut | -c1-100 10MB CSV | 0.0232s | 0.0043s | **5.4x** |
| cut | -d, -f1 10MB CSV | 0.0171s | 0.0040s | **4.3x** |
| cut | -d, -f1,3,5 10MB CSV | 0.0220s | 0.0072s | **3.0x** |
| cut | -d, -f2-4 10MB CSV | 0.0242s | 0.0058s | **4.2x** |
| cut | --complement -d, -f1 10MB CSV | 0.0309s | 0.0043s | **7.2x** |
...
| date | +%s (epoch) | 0.0009s | 0.0011s | 0.9x |
| date | ISO 8601 format | 0.0009s | 0.0010s | 0.9x |
| date | RFC 3339 | 0.0010s | 0.0012s | 0.8x |
| date | -u (UTC) | 0.0009s | 0.0010s | 0.9x |
| dd | dd read 10MB (bs=4096) | 0.0048s | 0.0046s | **1.0x** |
| dd | dd write 10MB from /dev/zero (bs=1M count=10) | 0.0106s | 0.0134s | 0.8x |
...
| du | --max-depth=1 | 0.0016s | 0.0016s | **1.0x** |
...
| expand | expand 10MB tabbed (default) | 0.0414s | 0.0134s | **3.1x** |
| expand | expand 1MB text | 0.0030s | 0.0012s | **2.6x** |
| expand | -t 4 10MB tabbed | 0.0391s | 0.0113s | **3.5x** |
| expand | -t 2 10MB tabbed | 0.0370s | 0.0113s | **3.3x** |
| expand | --initial 10MB tabbed | 0.0262s | 0.0063s | **4.1x** |
| expand | expand CSV 10MB | 0.0199s | 0.0013s | **15.0x** |
...
| factor | factor 1-100000 via stdin | 0.0209s | 0.0106s | **2.0x** |
| false | false (startup overhead) | 0.0005s | 0.0007s | 0.7x |
| fmt | fmt 1MB text | 0.0178s | 0.0152s | **1.2x** |
| fmt | fmt 10MB text | 0.1444s | 0.1214s | **1.2x** |
| fmt | -w 40 10MB | 0.1231s | 0.0935s | **1.3x** |
| fmt | -w 120 10MB | 0.1749s | 0.1565s | **1.1x** |
| fmt | fmt wide lines 10MB | 0.1668s | 0.1427s | **1.2x** |
| fold | fold 10MB wide lines (default) | 0.0355s | 0.0043s | **8.2x** |
| fold | fold 1MB text | 0.0043s | 0.0015s | **2.9x** |
| fold | fold 10MB text | 0.0348s | 0.0052s | **6.7x** |
| fold | -w 40 10MB | 0.0360s | 0.0046s | **7.8x** |
| fold | -w 20 10MB | 0.0364s | 0.0061s | **6.0x** |
| fold | -s -w 60 10MB | 0.0378s | 0.0051s | **7.4x** |
| fold | -s -w 40 10MB | 0.0407s | 0.0061s | **6.7x** |
| fold | -b -w 40 10MB | 0.0336s | 0.0052s | **6.4x** |
| groups | groups (no args) | 0.0010s | 0.0011s | 0.9x |
| head | default 1MB text | 0.0006s | 0.0009s | 0.7x |
| head | default 10MB text | 0.0016s | 0.0010s | **1.7x** |
| head | -n 1000 10MB | 0.0007s | 0.0009s | 0.7x |
| head | -n 100000 10MB | 0.0054s | 0.0028s | **1.9x** |
| head | -c 1000000 10MB | 0.0007s | 0.0010s | 0.8x |
| head | -n -100 10MB (all but last 100) | 0.0018s | 0.0013s | **1.4x** |
| head | 100 small files | 0.0009s | 0.0012s | 0.8x |
| hostid | hostid (no args) | 0.0009s | 0.0012s | 0.8x |
...
| join | self-join sorted 10MB | 0.0464s | 0.0391s | **1.2x** |
| kill | kill -l (list signals) | 0.0008s | 0.0009s | 0.9x |
| link | hard link a file | 0.0017s | 0.0018s | 0.9x |
| ln | symlink single file | 0.0020s | 0.0022s | 0.9x |
| ln | symlink force overwrite (-sf) | 0.0013s | 0.0017s | 0.8x |
| ln | hard link single file | 0.0013s | 0.0016s | 0.8x |
| logname | logname (no args) | 0.0009s | 0.0010s | 0.9x |
| ls | ls current directory | 0.0008s | 0.0010s | 0.8x |
| ls | 100 files | 0.0008s | 0.0011s | 0.7x |
| ls | -la 100 files | 0.0012s | 0.0014s | 0.9x |
| ls | -la test data dir | 0.0013s | 0.0015s | 0.9x |
| ls | -R test data | 0.0008s | 0.0010s | 0.8x |
...
| md5sum | single 10MB text | 0.0174s | 0.0189s | 0.9x |
| md5sum | single 10MB binary | 0.0181s | 0.0194s | 0.9x |
...
| mktemp | mktemp -d directory | 0.0020s | 0.0021s | 0.9x |
| mv | mv same-fs small (1MB) | 0.0028s | 0.0029s | 0.9x |
| mv | mv same-fs large (10MB) | 0.0083s | 0.0082s | **1.0x** |
| mv | mv many files (100 files) | - | 0.0065s | - |
...
| nl | default 10MB | 0.0360s | 0.0053s | **6.7x** |
| nl | -b a 10MB | 0.0356s | 0.0051s | **7.0x** |
| nl | -b a 10MB with blanks | 0.0464s | 0.0078s | **6.0x** |
| nl | -b a -n rz 10MB | 0.0358s | 0.0051s | **7.0x** |
| nl | -b a -w 8 -s ': ' 10MB | 0.0360s | 0.0053s | **6.8x** |
| nl | -b p'^the' 10MB | 0.0597s | 0.0057s | **10.4x** |
| nohup | nohup true | 0.0015s | 0.0019s | 0.8x |
...
| numfmt | --to=si from CSV column | 0.0267s | 0.0180s | **1.5x** |
| od | default 1MB text | 0.0657s | 0.0099s | **6.7x** |
| od | -A x -t x1z 1MB | 0.1191s | 0.0166s | **7.2x** |
| od | -c 1MB text | 0.1193s | 0.0115s | **10.4x** |
| od | default 10MB binary | 0.6691s | 0.0899s | **7.4x** |
| od | -N 10000 10MB | 0.0022s | 0.0020s | **1.1x** |
| paste | 2 columns 10MB | 0.0267s | 0.0083s | **3.2x** |
| paste | 3 columns 10MB | 0.0315s | 0.0147s | **2.1x** |
| paste | -d comma 10MB | 0.0238s | 0.0083s | **2.9x** |
| paste | -s 10MB single file | 0.0108s | 0.0043s | **2.5x** |
| paste | stdin split 2-way 10MB | 0.0324s | 0.0082s | **4.0x** |
| pathchk | pathchk default | 0.0008s | 0.0010s | 0.9x |
| pathchk | pathchk -p (POSIX portable) | 0.0009s | 0.0011s | 0.9x |
| pinky | pinky (default) | 0.0009s | 0.0010s | 0.9x |
| pinky | pinky -l | - | - | - |
| pr | pr 1MB text | 0.0109s | 0.0014s | **7.8x** |
| pr | -2 (two columns) 1MB | 0.0116s | 0.0016s | **7.3x** |
| pr | -3 (three columns) 1MB | 0.0086s | 0.0015s | **5.6x** |
| pr | -n 1MB text | 0.0116s | 0.0018s | **6.6x** |
| pr | -t 1MB text | 0.0100s | 0.0013s | **7.8x** |
...
| printf | string padding | 0.0007s | 0.0009s | 0.8x |
| ptx | ptx 10KB text | 0.0019s | 0.0017s | **1.2x** |
| ptx | ptx 100KB text | 0.0110s | 0.0057s | **1.9x** |
| ptx | -w 60 100KB text | 0.0100s | 0.0054s | **1.9x** |
...
| rev | reverse 1MB text | 0.0152s | 0.0020s | **7.7x** |
| rev | reverse 10MB text | 0.1368s | 0.0085s | **16.1x** |
| rev | reverse CSV 10MB | 0.1002s | 0.0075s | **13.3x** |
| rev | reverse repetitive 10MB | 0.2949s | 0.0131s | **22.5x** |
...
| rmdir | rmdir single empty directory | 0.0020s | 0.0021s | 0.9x |
| rmdir | rmdir -p nested directories | - | - | - |
| seq | seq 1000000 | 0.0102s | 0.0026s | **3.9x** |
| seq | seq 1 10000000 | 0.0928s | 0.0129s | **7.2x** |
| seq | seq 0 0.1 100000 (float) | 0.2142s | 0.0194s | **11.1x** |
| seq | seq -w 1 1000000 (zero-padded) | 0.2269s | 0.0148s | **15.3x** |
| sha1sum | single 1MB text | 0.0019s | 0.0017s | **1.2x** |
| sha1sum | single 10MB text | 0.0083s | 0.0081s | **1.0x** |
| sha1sum | single 10MB binary | 0.0088s | 0.0085s | **1.0x** |
| sha1sum | 100 files | 0.0025s | 0.0036s | 0.7x |
| sha224sum | single 1MB text | 0.0021s | 0.0018s | **1.2x** |
| sha224sum | single 10MB text | 0.0090s | 0.0087s | **1.0x** |
| sha224sum | single 10MB binary | 0.0093s | 0.0091s | **1.0x** |
| sha256sum | single 100KB text | 0.0013s | 0.0011s | **1.3x** |
| sha256sum | single 1MB text | 0.0020s | 0.0018s | **1.1x** |
| sha256sum | single 10MB text | 0.0083s | 0.0084s | **1.0x** |
...
| sha384sum | single 10MB text | 0.0196s | 0.0173s | **1.1x** |
| sha384sum | single 10MB binary | 0.0204s | 0.0175s | **1.2x** |
| sha512sum | single 1MB text | 0.0027s | 0.0038s | 0.7x |
| sha512sum | single 10MB text | 0.0154s | 0.0167s | 0.9x |
| sha512sum | single 10MB binary | 0.0166s | 0.0175s | **1.0x** |
| shred | shred 1MB file | 0.0099s | 0.0064s | **1.5x** |
| shred | shred 1MB file with remove (-u) | 0.0704s | 0.0680s | **1.0x** |
| shuf | shuf 1MB text | 0.0031s | 0.0015s | **2.0x** |
| shuf | shuf 10MB text | 0.0163s | 0.0056s | **2.9x** |
| shuf | -n 100 from 10MB | 0.0182s | 0.0038s | **4.8x** |
| shuf | -n 10000 from 10MB | 0.0202s | 0.0051s | **3.9x** |
| shuf | -i 1-1000000 | 0.0698s | 0.0151s | **4.6x** |
...
| sort | lexicographic 10MB random | 0.0552s | 0.0104s | **5.3x** |
| sort | already sorted 10MB | 0.0273s | 0.0052s | **5.3x** |
| sort | reverse sorted 10MB | 0.0275s | 0.0066s | **4.1x** |
| sort | -n numeric 10MB | 0.0737s | 0.0056s | **13.1x** |
| sort | -r reverse 10MB | 0.0549s | 0.0096s | **5.7x** |
| sort | -u unique 10MB | 0.0580s | 0.0100s | **5.8x** |
| sort | -t, -k2 CSV 10MB | 0.0670s | 0.0409s | **1.6x** |
| sort | repetitive 10MB | 0.0545s | 0.0126s | **4.3x** |
| sort | --parallel=4 10MB | 0.0581s | 0.0098s | **5.9x** |
| split | split 10MB into 1MB chunks (-b 1m) | 0.0081s | 0.0065s | **1.2x** |
| split | split 10MB by 1000 lines (-l 1000) | 0.0122s | 0.0130s | 0.9x |
...
| stat | --format='%n %s %Y' | 0.0011s | 0.0009s | **1.2x** |
...
| sum | single 10MB text | 0.0185s | 0.0148s | **1.2x** |
...
| tac | reverse CSV 10MB | 0.0092s | 0.0043s | **2.1x** |
| tac | reverse repetitive 10MB | 0.0234s | 0.0085s | **2.7x** |
| tac | custom separator 1MB | 0.0058s | 0.0042s | **1.4x** |
...
| tr | a-z to A-Z 1MB | 0.0031s | 0.0019s | **1.6x** |
| tr | a-z to A-Z 10MB | 0.0189s | 0.0057s | **3.3x** |
| tr | -d digits 10MB | 0.0249s | 0.0063s | **4.0x** |
| tr | -d lowercase 10MB | 0.0408s | 0.0079s | **5.2x** |
| tr | -s spaces 10MB | 0.0387s | 0.0045s | **8.5x** |
| tr | [:lower:] to [:upper:] 10MB | 0.0136s | 0.0043s | **3.2x** |
| tr | -d [:digit:] 10MB CSV | 0.0179s | 0.0053s | **3.4x** |
| tr | translate binary 10MB | 0.0130s | 0.0043s | **3.0x** |
| true | true (startup overhead) | 0.0005s | 0.0007s | 0.7x |
| truncate | truncate to zero (-s 0) | 0.0029s | 0.0031s | **1.0x** |
| truncate | create 1M file (-s 1M) | 0.0018s | 0.0019s | 0.9x |
| tsort | tsort 100K pairs | 0.0579s | 0.0073s | **7.9x** |
| tsort | tsort 1M pairs | 0.6580s | 0.0645s | **10.2x** |
| tty | tty (no args) | 0.0008s | 0.0009s | 0.9x |
| uname | uname (no args) | 0.0006s | 0.0008s | 0.8x |
| uname | uname -a | 0.0006s | 0.0008s | 0.8x |
| uname | uname -r | 0.0009s | 0.0011s | 0.8x |
| uname | uname -m | 0.0006s | 0.0007s | 0.9x |
| unexpand | unexpand 1MB text | 0.0031s | 0.0011s | **2.7x** |
| unexpand | unexpand 10MB text | 0.0227s | 0.0023s | **9.8x** |
| unexpand | -a 1MB text | 0.0089s | 0.0012s | **7.6x** |
| unexpand | -a 10MB text | 0.0833s | 0.0024s | **34.5x** |
| unexpand | -t 4 10MB text | 0.0834s | 0.0024s | **34.4x** |
| unexpand | expand|unexpand pipeline 10MB | 0.1082s | 0.0715s | **1.5x** |
| uniq | default 10MB many duplicates | 0.0128s | 0.0019s | **6.7x** |
| uniq | default 10MB sorted (low dup) | 0.0206s | 0.0051s | **4.0x** |
| uniq | -c count 10MB many dups | 0.0121s | 0.0018s | **6.7x** |
| uniq | -c count 10MB sorted | 0.0294s | 0.0078s | **3.8x** |
| uniq | -d duplicates only 10MB | 0.0122s | 0.0019s | **6.5x** |
| uniq | -u unique only 10MB | 0.0122s | 0.0020s | **6.2x** |
| uniq | -i case insensitive 10MB | 0.0144s | 0.0049s | **2.9x** |
| uniq | repetitive 10MB | 0.0427s | 0.0036s | **11.9x** |
| unlink | unlink a file | 0.0015s | 0.0018s | 0.8x |
...
| vdir | -R test data | 0.0018s | 0.0017s | **1.1x** |
| wc | default 100KB text | 0.0013s | 0.0013s | **1.1x** |
| wc | default 1MB text | 0.0057s | 0.0037s | **1.6x** |
...
| wc | -m 10MB text | 0.0543s | 0.0030s | **18.1x** |
| wc | -L 10MB text | 0.0547s | 0.0098s | **5.6x** |
| wc | default 10MB binary | 0.3160s | 0.0270s | **11.7x** |
| wc | default 10MB repetitive | 0.0809s | 0.0046s | **17.5x** |
| wc | 10 files | 0.0010s | 0.0011s | 0.9x |
| wc | 100 files | 0.0019s | 0.0017s | **1.2x** |
...
| yes | throughput 1M lines | 0.0032s | 0.0038s | 0.9x |
| yes | throughput 10M lines | 0.0235s | 0.0316s | 0.7x |
| yes | throughput hello 1M lines | 0.0075s | 0.0070s | **1.1x** |
| yes | throughput hello 10M lines | 0.0595s | 0.0603s | **1.0x** |
| yes | throughput 100MB | 0.0469s | 0.0465s | **1.0x** |
...
| cat | passthrough 1MB | 0.0010s | 0.0014s | 0.0003s | **3.5x** | **5.0x** |
| cat | passthrough 10MB | 0.0015s | 0.0019s | 0.0005s | **2.8x** | **3.6x** |
| cat | -n 10MB | 0.0102s | 0.0061s | 0.0110s | 0.9x | 0.6x |
| cut | 10MB -c1-20 | 0.0201s | 0.0038s | 0.0051s | **3.9x** | 0.7x |
| echo | short string | 0.0000s | 0.0009s | 0.0002s | 0.2x | **4.2x** |
| expand | 10MB text | 0.0253s | 0.0024s | 0.0059s | **4.3x** | 0.4x |
| fold | 10MB default width | 0.0351s | 0.0053s | 0.0050s | **7.0x** | **1.0x** |
| fold | 10MB -w 40 | 0.0364s | 0.0055s | 0.0051s | **7.2x** | **1.1x** |
| head | first 1000 lines 10MB | 0.0009s | 0.0011s | 0.0003s | **3.0x** | **3.7x** |
| md5sum | 10MB file | 0.0173s | 0.0185s | 0.0242s | 0.7x | 0.8x |
| nl | 10MB text | 0.0362s | 0.0054s | 0.0042s | **8.7x** | **1.3x** |
| od | 1MB text | 0.0638s | 0.0096s | 0.0062s | **10.3x** | **1.6x** |
| rev | 10MB text | 0.1405s | 0.0079s | 0.0142s | **9.9x** | 0.6x |
| seq | 1 to 1M | 0.0105s | 0.0025s | 0.0011s | **9.8x** | **2.3x** |
| seq | 1 to 10M | 0.0960s | 0.0137s | 0.0048s | **20.2x** | **2.9x** |
| sort | 1MB text | 0.0106s | 0.0052s | 0.0064s | **1.7x** | 0.8x |
| tac | reverse 1MB | 0.0019s | 0.0016s | 0.0009s | **2.1x** | **1.6x** |
| tail | last 1000 lines 10MB | 0.0010s | 0.0013s | 0.0003s | **3.0x** | **3.9x** |
| tr | 10MB lowercase | 0.0105s | 0.0027s | 0.0048s | **2.2x** | 0.6x |
| unexpand | 10MB text | 0.0236s | 0.0027s | 0.0073s | **3.2x** | 0.4x |
| uniq | 10MB sorted | 0.0280s | 0.0030s | 0.0029s | **9.8x** | **1.0x** |
| wc | 10MB text | 0.0547s | 0.0032s | 0.0369s | **1.5x** | 0.1x |
| wc | 10MB -l only | 0.0020s | 0.0019s | 0.0013s | **1.5x** | **1.5x** |
| yes | 1M lines | 0.0052s | 0.0052s | 0.0057s | 0.9x | 0.9x |
