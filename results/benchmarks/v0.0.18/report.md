...
|------|------|-----------|-------------------|---------|
| wc | default 100KB text | 0.0029s | 0.0017s | **1.7x** |
| wc | default 1MB text | 0.0036s | 0.0050s | **0.7x** |
| wc | default 10MB text | 0.0279s | 0.0244s | **1.1x** |
| wc | default 100MB text | 0.2473s | 0.1968s | **1.3x** |
| wc | -l 10MB text | 0.0068s | 0.0049s | **1.4x** |
| wc | -w 10MB text | 0.0302s | 0.0243s | **1.2x** |
| wc | -c 10MB text | 0.0018s | 0.0040s | **0.5x** |
| wc | -m 10MB text | 0.0314s | 0.0054s | **5.8x** |
| wc | -L 10MB text | 0.0293s | 0.0163s | **1.8x** |
| wc | default 10MB binary | 0.1421s | 0.0987s | **1.4x** |
| wc | default 10MB repetitive | 0.0502s | 0.0188s | **2.7x** |
| wc | 10 files | 0.0022s | 0.0007s | **3.1x** |
| wc | 100 files | 0.0040s | 0.0051s | **0.8x** |
| cut | -b1-100 10MB CSV | 0.0311s | 0.0046s | **6.7x** |
| cut | -c1-100 10MB CSV | 0.0282s | 0.0065s | **4.3x** |
| cut | -d, -f1 10MB CSV | 0.0192s | 0.0039s | **4.9x** |
| cut | -d, -f1,3,5 10MB CSV | 0.0312s | 0.0082s | **3.8x** |
| cut | -d, -f2-4 10MB CSV | 0.0341s | 0.0105s | **3.3x** |
| cut | --complement -d, -f1 10MB CSV | 0.0456s | 0.0057s | **8.0x** |
| cut | -d, -f1 100KB text | 0.0015s | 0.0025s | **0.6x** |
| cut | -d, -f1 1MB text | 0.0037s | 0.0018s | **2.1x** |
| cut | -d: -f1 colon file | 0.0031s | 0.0028s | **1.1x** |
| sha256sum | single 100KB text | 0.0025s | 0.0017s | **1.5x** |
| sha256sum | single 1MB text | 0.0056s | 0.0026s | **2.1x** |
| sha256sum | single 10MB text | 0.0377s | 0.0074s | **5.1x** |
| sha256sum | single 10MB binary | 0.0396s | 0.0077s | **5.2x** |
| sha256sum | single 100MB text | 0.3739s | 0.0702s | **5.3x** |
| sha256sum | 10 files | 0.0130s | 0.0182s | **0.7x** |
| sha256sum | 100 files | 0.0015s | 0.0022s | **0.7x** |
| md5sum | single 100KB text | 0.0010s | 0.0011s | **0.9x** |
| md5sum | single 1MB text | 0.0054s | 0.0052s | **1.0x** |
| md5sum | single 10MB text | 0.0236s | 0.0232s | **1.0x** |
| md5sum | single 10MB binary | 0.0209s | 0.0211s | **1.0x** |
| md5sum | single 100MB text | 0.2088s | 0.1764s | **1.2x** |
| md5sum | 10 files | 0.0012s | 0.0007s | **1.8x** |
| md5sum | 100 files | 0.0032s | 0.0030s | **1.1x** |
| b2sum | single 100KB text | 0.0039s | 0.0011s | **3.6x** |
| b2sum | single 1MB text | 0.0030s | 0.0022s | **1.4x** |
| b2sum | single 10MB text | 0.0222s | 0.0176s | **1.3x** |
| b2sum | single 10MB binary | 0.0217s | 0.0169s | **1.3x** |
| b2sum | single 100MB text | 0.2077s | 0.1240s | **1.7x** |
| b2sum | -l 256 10MB | 0.0256s | 0.0110s | **2.3x** |
| b2sum | -l 128 10MB | 0.0201s | 0.0131s | **1.5x** |
| b2sum | 100 files | 0.0039s | 0.0034s | **1.2x** |
| base64 | encode 100KB text | 0.0014s | 0.0015s | **1.0x** |
| base64 | encode 1MB text | 0.0043s | 0.0040s | **1.1x** |
| base64 | encode 10MB text | 0.0152s | 0.0074s | **2.1x** |
| base64 | encode 10MB binary | 0.0158s | 0.0034s | **4.7x** |
| base64 | decode 1MB | 0.0057s | 0.0035s | **1.6x** |
| base64 | decode 10MB | 0.0284s | 0.0133s | **2.1x** |
| base64 | encode -w 76 10MB | 0.0157s | 0.0079s | **2.0x** |
| base64 | encode -w 0 (no wrap) 10MB | 0.0081s | 0.0040s | **2.0x** |
| sort | lexicographic 1MB | 0.1018s | 0.0079s | **12.8x** |
| sort | lexicographic 10MB random | 0.4389s | 0.0262s | **16.7x** |
| sort | already sorted 10MB | 0.2194s | 0.0146s | **15.1x** |
| sort | reverse sorted 10MB | 0.1934s | 0.0122s | **15.8x** |
| sort | -n numeric 10MB | 0.4144s | 0.0231s | **17.9x** |
| sort | -r reverse 10MB | 0.4294s | 0.0228s | **18.8x** |
| sort | -u unique 10MB | 0.4681s | 0.0194s | **24.1x** |
| sort | -t, -k2 CSV 10MB | 0.5305s | 0.0281s | **18.9x** |
| sort | repetitive 10MB | 0.0593s | 0.0191s | **3.1x** |
| sort | --parallel=4 10MB | 0.4778s | 0.0194s | **24.6x** |
| tr | a-z to A-Z 1MB | 0.0050s | 0.0016s | **3.1x** |
| tr | a-z to A-Z 10MB | 0.0154s | 0.0074s | **2.1x** |
| tr | -d digits 10MB | 0.0171s | 0.0138s | **1.2x** |
| tr | -d lowercase 10MB | 0.0284s | 0.0221s | **1.3x** |
| tr | -s spaces 10MB | 0.0406s | 0.0235s | **1.7x** |
| tr | [:lower:] to [:upper:] 10MB | 0.0134s | 0.0071s | **1.9x** |
| tr | -d [:digit:] 10MB CSV | 0.0177s | 0.0133s | **1.3x** |
| tr | translate binary 10MB | 0.0147s | 0.0080s | **1.8x** |
| uniq | default 10MB many duplicates | 0.0103s | 0.0061s | **1.7x** |
| uniq | default 10MB sorted (low dup) | 0.0190s | 0.0055s | **3.5x** |
| uniq | -c count 10MB many dups | 0.0099s | 0.0053s | **1.9x** |
| uniq | -c count 10MB sorted | 0.0327s | 0.0097s | **3.4x** |
| uniq | -d duplicates only 10MB | 0.0107s | 0.0072s | **1.5x** |
| uniq | -u unique only 10MB | 0.0112s | 0.0060s | **1.9x** |
| uniq | -i case insensitive 10MB | 0.0194s | 0.0090s | **2.2x** |
| uniq | repetitive 10MB | 0.0376s | 0.0093s | **4.0x** |
| tac | reverse 100KB text | 0.0028s | 0.0015s | **1.9x** |
| tac | reverse 1MB text | 0.0025s | 0.0028s | **0.9x** |
| tac | reverse 10MB text | 0.0133s | 0.0073s | **1.8x** |
| tac | reverse 100MB text | 0.1327s | 0.0514s | **2.6x** |
| tac | reverse CSV 10MB | 0.0133s | 0.0088s | **1.5x** |
| tac | reverse repetitive 10MB | 0.0317s | 0.0124s | **2.6x** |
| tac | custom separator 1MB | 0.0081s | 0.0056s | **1.4x** |
