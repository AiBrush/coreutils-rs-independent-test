# fcoreutils v0.19.0 — Detailed Results

Generated: 2026-03-07 04:43:34 UTC
...
| base64 | encode 1MB text | 0.0021s | 0.0014s | **1.6x** |
...
| basenc | encode --base64 10MB | 0.0129s | 0.0050s | **2.6x** |
...
| cksum | single 10MB text | 0.0030s | 0.0028s | **1.1x** |
| cksum | single 10MB binary | 0.0030s | 0.0027s | **1.1x** |
| comm | default 10MB sorted | 0.0258s | 0.0072s | **3.6x** |
| comm | -12 (common only) 10MB | 0.0212s | 0.0049s | **4.3x** |
| comm | -23 (unique to file1) 10MB | 0.0212s | 0.0054s | **3.9x** |
| comm | -3 10MB | 0.0225s | 0.0067s | **3.4x** |
| comm | identical 10MB sorted | 0.0298s | 0.0091s | **3.3x** |
| cp | cp small file (1KB) | 0.0021s | 0.0021s | **1.0x** |
| cp | cp medium file (1MB) | 0.0029s | 0.0031s | 0.9x |
| cp | cp large file (10MB) | 0.0102s | 0.0100s | **1.0x** |
...
| cut | -c1-100 10MB CSV | 0.0223s | 0.0034s | **6.5x** |
| cut | -d, -f1 10MB CSV | 0.0163s | 0.0039s | **4.2x** |
| cut | -d, -f1,3,5 10MB CSV | 0.0219s | 0.0101s | **2.2x** |
| cut | -d, -f2-4 10MB CSV | 0.0239s | 0.0078s | **3.1x** |
| cut | --complement -d, -f1 10MB CSV | 0.0305s | 0.0049s | **6.2x** |
...
| dd | dd write 10MB from /dev/zero (bs=1M count=10) | 0.0103s | 0.0131s | 0.8x |
| df | df (default) | 0.0013s | 0.0011s | **1.2x** |
| df | -h (human readable) | 0.0017s | 0.0010s | **1.6x** |
...
| dircolors | dircolors -c (csh) | 0.0009s | 0.0009s | 0.9x |
...
| env | env VAR=value true | 0.0014s | 0.0014s | **1.0x** |
| expand | expand 10MB tabbed (default) | 0.0449s | 0.0154s | **2.9x** |
| expand | expand 1MB text | 0.0033s | 0.0012s | **2.8x** |
| expand | -t 4 10MB tabbed | 0.0421s | 0.0130s | **3.3x** |
| expand | -t 2 10MB tabbed | 0.0361s | 0.0126s | **2.9x** |
| expand | --initial 10MB tabbed | 0.0233s | 0.0074s | **3.2x** |
| expand | expand CSV 10MB | 0.0193s | 0.0018s | **10.7x** |
...
| factor | factor 999999999999999989 (large prime) | 0.0007s | 0.0009s | 0.8x |
| factor | factor 1-100000 via stdin | 0.0149s | 0.0115s | **1.3x** |
| false | false (startup overhead) | 0.0006s | 0.0007s | 0.8x |
| fmt | fmt 1MB text | 0.0169s | 0.0139s | **1.2x** |
| fmt | fmt 10MB text | 0.1377s | 0.1148s | **1.2x** |
| fmt | -w 40 10MB | 0.1162s | 0.0907s | **1.3x** |
| fmt | -w 120 10MB | 0.1653s | 0.1473s | **1.1x** |
| fmt | fmt wide lines 10MB | 0.1575s | 0.1353s | **1.2x** |
| fold | fold 10MB wide lines (default) | 0.0346s | 0.0043s | **8.0x** |
| fold | fold 1MB text | 0.0042s | 0.0016s | **2.7x** |
| fold | fold 10MB text | 0.0344s | 0.0049s | **7.0x** |
| fold | -w 40 10MB | 0.0349s | 0.0045s | **7.8x** |
| fold | -w 20 10MB | 0.0356s | 0.0057s | **6.3x** |
| fold | -s -w 60 10MB | 0.0374s | 0.0048s | **7.8x** |
| fold | -s -w 40 10MB | 0.0400s | 0.0060s | **6.7x** |
| fold | -b -w 40 10MB | 0.0325s | 0.0051s | **6.3x** |
...
| head | -n 100000 10MB | 0.0066s | 0.0039s | **1.7x** |
...
| join | self-join sorted 10MB | 0.0681s | 0.0401s | **1.7x** |
...
| md5sum | single 10MB text | 0.0172s | 0.0186s | 0.9x |
...
| mv | mv same-fs large (10MB) | 0.0113s | 0.0108s | **1.0x** |
...
| nl | default 1MB | 0.0047s | 0.0017s | **2.8x** |
| nl | default 10MB | 0.0334s | 0.0070s | **4.8x** |
| nl | -b a 10MB | 0.0308s | 0.0055s | **5.6x** |
| nl | -b a 10MB with blanks | 0.0392s | 0.0073s | **5.3x** |
| nl | -b a -n rz 10MB | 0.0297s | 0.0055s | **5.4x** |
| nl | -b a -w 8 -s ': ' 10MB | 0.0304s | 0.0053s | **5.8x** |
| nl | -b p'^the' 10MB | 0.0570s | 0.0061s | **9.4x** |
| nohup | nohup true | 0.0021s | 0.0022s | **1.0x** |
| nproc | nproc (no args) | 0.0009s | 0.0010s | 0.9x |
| nproc | nproc --all | 0.0009s | 0.0009s | 0.9x |
| numfmt | --to=iec single value | 0.0010s | 0.0012s | 0.9x |
| numfmt | --from=iec single value | 0.0011s | 0.0013s | 0.8x |
| numfmt | --to=si from CSV column | 0.0260s | 0.0245s | **1.1x** |
| od | default 1MB text | 0.0638s | 0.0088s | **7.2x** |
| od | -A x -t x1z 1MB | 0.1162s | 0.0142s | **8.2x** |
| od | -c 1MB text | 0.1213s | 0.0092s | **13.2x** |
| od | default 10MB binary | 0.6536s | 0.0811s | **8.1x** |
| od | -N 10000 10MB | 0.0014s | 0.0013s | **1.1x** |
| paste | 2 columns 10MB | 0.0237s | 0.0082s | **2.9x** |
| paste | 3 columns 10MB | 0.0305s | 0.0148s | **2.1x** |
| paste | -d comma 10MB | 0.0236s | 0.0083s | **2.9x** |
| paste | -s 10MB single file | 0.0106s | 0.0042s | **2.5x** |
| paste | stdin split 2-way 10MB | 0.0312s | 0.0081s | **3.9x** |
...
| pinky | pinky -l | - | - | - |
| pr | pr 1MB text | 0.0077s | 0.0013s | **5.9x** |
| pr | -2 (two columns) 1MB | 0.0099s | 0.0016s | **6.3x** |
| pr | -3 (three columns) 1MB | 0.0075s | 0.0014s | **5.3x** |
| pr | -n 1MB text | 0.0095s | 0.0018s | **5.2x** |
| pr | -t 1MB text | 0.0075s | 0.0013s | **6.0x** |
...
| ptx | ptx 10KB text | 0.0020s | 0.0016s | **1.3x** |
| ptx | ptx 100KB text | 0.0114s | 0.0060s | **1.9x** |
| ptx | -w 60 100KB text | 0.0110s | 0.0059s | **1.8x** |
| pwd | pwd (no args) | 0.0008s | 0.0009s | 0.9x |
| pwd | pwd -L | 0.0008s | 0.0009s | 0.9x |
| pwd | pwd -P | 0.0008s | 0.0009s | 0.9x |
| readlink | readlink symlink | 0.0009s | 0.0018s | 0.5x |
| readlink | readlink -f (canonicalize) | 0.0009s | 0.0010s | 0.9x |
| realpath | realpath . | 0.0006s | 0.0008s | 0.8x |
| realpath | realpath /tmp | 0.0007s | 0.0009s | 0.7x |
| realpath | realpath test data file | 0.0006s | 0.0007s | 0.8x |
| rev | reverse 100KB text | 0.0022s | 0.0010s | **2.1x** |
| rev | reverse 1MB text | 0.0146s | 0.0019s | **7.7x** |
| rev | reverse 10MB text | 0.1339s | 0.0078s | **17.2x** |
| rev | reverse CSV 10MB | 0.1001s | 0.0072s | **13.9x** |
| rev | reverse repetitive 10MB | 0.2864s | 0.0124s | **23.1x** |
...
| seq | seq -w 1 1000000 (zero-padded) | 0.2426s | 0.0156s | **15.6x** |
| sha1sum | single 1MB text | 0.0019s | 0.0016s | **1.2x** |
| sha1sum | single 10MB text | 0.0086s | 0.0081s | **1.1x** |
| sha1sum | single 10MB binary | 0.0086s | 0.0085s | **1.0x** |
| sha1sum | 100 files | 0.0025s | 0.0035s | 0.7x |
| sha224sum | single 1MB text | 0.0020s | 0.0017s | **1.1x** |
| sha224sum | single 10MB text | 0.0087s | 0.0097s | 0.9x |
...
| sha256sum | single 10MB text | 0.0087s | 0.0086s | **1.0x** |
| sha256sum | single 10MB binary | 0.0094s | 0.0090s | **1.0x** |
| sha256sum | 10 files | 0.0014s | 0.0026s | 0.5x |
| sha256sum | 100 files | 0.0025s | 0.0035s | 0.7x |
| sha384sum | single 1MB text | 0.0033s | 0.0039s | 0.8x |
| sha384sum | single 10MB text | 0.0158s | 0.0170s | 0.9x |
| sha384sum | single 10MB binary | 0.0166s | 0.0184s | 0.9x |
| sha512sum | single 1MB text | 0.0026s | 0.0037s | 0.7x |
| sha512sum | single 10MB text | 0.0173s | 0.0185s | 0.9x |
| sha512sum | single 10MB binary | 0.0183s | 0.0192s | **1.0x** |
| shred | shred 1MB file | 0.0101s | 0.0062s | **1.6x** |
| shred | shred 1MB file with remove (-u) | 0.0187s | 0.0073s | **2.6x** |
| shuf | shuf 1MB text | 0.0031s | 0.0018s | **1.7x** |
| shuf | shuf 10MB text | 0.0214s | 0.0077s | **2.8x** |
| shuf | -n 100 from 10MB | 0.0188s | 0.0045s | **4.2x** |
| shuf | -n 10000 from 10MB | 0.0217s | 0.0061s | **3.5x** |
| shuf | -i 1-1000000 | 0.0732s | 0.0149s | **4.9x** |
...
| sort | lexicographic 10MB random | 0.0569s | 0.0098s | **5.8x** |
| sort | already sorted 10MB | 0.0258s | 0.0050s | **5.2x** |
| sort | reverse sorted 10MB | 0.0272s | 0.0064s | **4.3x** |
| sort | -n numeric 10MB | 0.0735s | 0.0059s | **12.4x** |
| sort | -r reverse 10MB | 0.0552s | 0.0091s | **6.1x** |
| sort | -u unique 10MB | 0.0579s | 0.0091s | **6.4x** |
| sort | -t, -k2 CSV 10MB | 0.0664s | 0.0388s | **1.7x** |
| sort | repetitive 10MB | 0.0545s | 0.0129s | **4.2x** |
| sort | --parallel=4 10MB | 0.0549s | 0.0089s | **6.2x** |
| split | split 10MB into 1MB chunks (-b 1m) | 0.0105s | 0.0073s | **1.4x** |
| split | split 10MB by 1000 lines (-l 1000) | 0.0172s | 0.0179s | **1.0x** |
| stat | stat single file | 0.0014s | 0.0013s | **1.1x** |
| stat | 100 files | 0.0059s | 0.0054s | **1.1x** |
| stat | --format=%s (size only) | 0.0012s | 0.0011s | **1.1x** |
| stat | --format='%n %s %Y' | 0.0012s | 0.0017s | 0.7x |
| stat | -f (filesystem) | 0.0011s | 0.0010s | **1.2x** |
| stdbuf | -oL cat 1MB | 0.0013s | 0.0017s | 0.8x |
| stdbuf | -o0 cat 100KB | 0.0012s | 0.0015s | 0.8x |
| sum | single 1MB text | 0.0028s | 0.0025s | **1.1x** |
| sum | single 10MB text | 0.0198s | 0.0163s | **1.2x** |
| sum | single 10MB binary | 0.0206s | 0.0170s | **1.2x** |
| sync | sync (no args) | 0.0008s | 0.0010s | 0.9x |
| tac | reverse 100KB text | 0.0013s | 0.0011s | **1.1x** |
| tac | reverse 1MB text | 0.0019s | 0.0014s | **1.3x** |
| tac | reverse 10MB text | 0.0109s | 0.0049s | **2.2x** |
| tac | reverse CSV 10MB | 0.0097s | 0.0044s | **2.2x** |
| tac | reverse repetitive 10MB | 0.0231s | 0.0086s | **2.7x** |
| tac | custom separator 1MB | 0.0063s | 0.0042s | **1.5x** |
...
| tail | -n 100000 10MB | 0.0059s | 0.0030s | **1.9x** |
...
| tee | tee 10MB to /dev/null | 0.0067s | 0.0060s | **1.1x** |
...
| test | test -d /tmp | 0.0008s | 0.0011s | 0.7x |
...
| tr | a-z to A-Z 10MB | 0.0151s | 0.0038s | **3.9x** |
| tr | -d digits 10MB | 0.0183s | 0.0048s | **3.8x** |
| tr | -d lowercase 10MB | 0.0308s | 0.0055s | **5.7x** |
| tr | -s spaces 10MB | 0.0268s | 0.0040s | **6.6x** |
| tr | [:lower:] to [:upper:] 10MB | 0.0129s | 0.0049s | **2.6x** |
| tr | -d [:digit:] 10MB CSV | 0.0170s | 0.0046s | **3.7x** |
...
| tsort | tsort 100K pairs | 0.0573s | 0.0086s | **6.7x** |
| tsort | tsort 1M pairs | 0.6378s | 0.0770s | **8.3x** |
...
| uname | uname -m | 0.0008s | 0.0010s | 0.9x |
| unexpand | unexpand 1MB text | 0.0030s | 0.0010s | **3.0x** |
| unexpand | unexpand 10MB text | 0.0241s | 0.0020s | **12.3x** |
| unexpand | -a 1MB text | 0.0073s | 0.0010s | **7.1x** |
| unexpand | -a 10MB text | 0.0705s | 0.0018s | **39.0x** |
| unexpand | -t 4 10MB text | 0.0698s | 0.0018s | **38.8x** |
| unexpand | expand|unexpand pipeline 10MB | 0.0956s | 0.0610s | **1.6x** |
| uniq | default 10MB many duplicates | 0.0122s | 0.0018s | **6.7x** |
| uniq | default 10MB sorted (low dup) | 0.0140s | 0.0038s | **3.6x** |
| uniq | -c count 10MB many dups | 0.0122s | 0.0019s | **6.5x** |
| uniq | -c count 10MB sorted | 0.0293s | 0.0076s | **3.8x** |
| uniq | -d duplicates only 10MB | 0.0125s | 0.0018s | **6.9x** |
| uniq | -u unique only 10MB | 0.0120s | 0.0020s | **6.0x** |
| uniq | -i case insensitive 10MB | 0.0138s | 0.0044s | **3.2x** |
| uniq | repetitive 10MB | 0.0421s | 0.0038s | **11.2x** |
| unlink | unlink a file | 0.0015s | 0.0017s | 0.9x |
| uptime | uptime (default) | 0.0016s | 0.0011s | **1.5x** |
| uptime | uptime -s (since) | 0.0017s | 0.0012s | **1.5x** |
...
| vdir | -R test data | 0.0011s | 0.0014s | 0.8x |
| wc | default 100KB text | 0.0014s | 0.0013s | **1.1x** |
| wc | default 1MB text | 0.0059s | 0.0037s | **1.6x** |
| wc | default 10MB text | 0.0544s | 0.0033s | **16.4x** |
| wc | -l 10MB text | 0.0022s | 0.0022s | **1.0x** |
| wc | -w 10MB text | 0.0561s | 0.0146s | **3.8x** |
| wc | -c 10MB text | 0.0009s | 0.0010s | 0.9x |
| wc | -m 10MB text | 0.0546s | 0.0031s | **17.5x** |
| wc | -L 10MB text | 0.0547s | 0.0112s | **4.9x** |
| wc | default 10MB binary | 0.3204s | 0.0282s | **11.4x** |
| wc | default 10MB repetitive | 0.0730s | 0.0048s | **15.2x** |
...
| yes | throughput 10M lines | 0.0352s | 0.0239s | **1.5x** |
| yes | throughput hello 1M lines | 0.0095s | 0.0073s | **1.3x** |
| yes | throughput hello 10M lines | 0.0589s | 0.0535s | **1.1x** |
| yes | throughput 100MB | 0.0478s | 0.0467s | **1.0x** |
