# fcoreutils v0.20.5 — Detailed Results

Generated: 2026-03-13 16:42:48 UTC
...
|------|------|----------:|-----------------:|--------:|
| arch | arch (no args) | 0.0009s | 0.0011s | 0.9x |
...
| b2sum | -l 128 10MB | 0.0148s | 0.0123s | **1.2x** |
...
| base32 | encode 10MB text | 0.0145s | 0.0107s | **1.4x** |
| base32 | encode 10MB binary | 0.0152s | 0.0110s | **1.4x** |
...
| base64 | encode 10MB text | 0.0139s | 0.0051s | **2.7x** |
| base64 | encode 10MB binary | 0.0131s | 0.0050s | **2.6x** |
| base64 | decode 1MB | 0.0040s | 0.0021s | **2.0x** |
| base64 | decode 10MB | 0.0323s | 0.0049s | **6.6x** |
| base64 | encode -w 76 10MB | 0.0125s | 0.0049s | **2.6x** |
...
| basenc | encode --base64 10MB | 0.0126s | 0.0054s | **2.3x** |
...
| cat | passthrough 10MB | 0.0015s | 0.0019s | 0.7x |
| cat | -n 1MB | 0.0021s | 0.0021s | **1.0x** |
| cat | -n 10MB | 0.0103s | 0.0062s | **1.7x** |
...
| chgrp | chgrp current group on file | 0.0190s | 0.0172s | **1.1x** |
| chgrp | chgrp current group on 1MB file | 0.0020s | 0.0022s | 0.9x |
| chown | chown current user on file | 0.0023s | 0.0024s | 0.9x |
| chown | chown current user on 1MB file | 0.0037s | 0.0034s | **1.1x** |
| cksum | single 1MB text | 0.0016s | 0.0012s | **1.3x** |
| cksum | single 10MB text | 0.0031s | 0.0026s | **1.2x** |
| cksum | single 10MB binary | 0.0032s | 0.0027s | **1.2x** |
| comm | default 10MB sorted | 0.0252s | 0.0057s | **4.4x** |
| comm | -12 (common only) 10MB | 0.0218s | 0.0038s | **5.7x** |
| comm | -23 (unique to file1) 10MB | 0.0224s | 0.0042s | **5.3x** |
| comm | -3 10MB | 0.0242s | 0.0053s | **4.5x** |
| comm | identical 10MB sorted | 0.0366s | 0.0073s | **5.0x** |
...
| cut | -d, -f1 10MB CSV | 0.0166s | 0.0038s | **4.4x** |
| cut | -d, -f1,3,5 10MB CSV | 0.0219s | 0.0070s | **3.1x** |
| cut | -d, -f2-4 10MB CSV | 0.0247s | 0.0058s | **4.3x** |
| cut | --complement -d, -f1 10MB CSV | 0.0309s | 0.0044s | **7.0x** |
| cut | -d, -f1 100KB text | 0.0009s | 0.0016s | 0.5x |
| cut | -d, -f1 1MB text | 0.0033s | 0.0022s | **1.5x** |
| cut | -d: -f1 colon file | 0.0010s | 0.0016s | 0.6x |
| date | date (default) | 0.0007s | 0.0009s | 0.7x |
| date | +%Y-%m-%d %H:%M:%S | 0.0007s | 0.0009s | 0.8x |
| date | +%s (epoch) | 0.0006s | 0.0008s | 0.8x |
| date | ISO 8601 format | 0.0006s | 0.0008s | 0.8x |
| date | RFC 3339 | 0.0006s | 0.0008s | 0.8x |
| date | -u (UTC) | 0.0007s | 0.0008s | 0.8x |
| dd | dd read 10MB (bs=4096) | 0.0061s | 0.0062s | **1.0x** |
| dd | dd write 10MB from /dev/zero (bs=1M count=10) | 0.0106s | 0.0123s | 0.9x |
...
| expand | expand 10MB tabbed (default) | 0.0454s | 0.0176s | **2.6x** |
| expand | expand 1MB text | 0.0033s | 0.0011s | **3.0x** |
| expand | -t 4 10MB tabbed | 0.0417s | 0.0127s | **3.3x** |
| expand | -t 2 10MB tabbed | 0.0356s | 0.0122s | **2.9x** |
| expand | --initial 10MB tabbed | 0.0229s | 0.0067s | **3.4x** |
| expand | expand CSV 10MB | 0.0188s | 0.0017s | **10.8x** |
...
| expr | expr 'hello' : 'hel' | 0.0010s | 0.0010s | 0.9x |
| factor | factor 1234567890 | 0.0009s | 0.0009s | **1.0x** |
| factor | factor 999999999999999989 (large prime) | 0.0009s | 0.0010s | 0.9x |
| factor | factor 1-100000 via stdin | 0.0239s | 0.0111s | **2.2x** |
| false | false (startup overhead) | 0.0006s | 0.0008s | 0.8x |
| fmt | fmt 1MB text | 0.0168s | 0.0152s | **1.1x** |
| fmt | fmt 10MB text | 0.1482s | 0.1206s | **1.2x** |
| fmt | -w 40 10MB | 0.1229s | 0.0944s | **1.3x** |
| fmt | -w 120 10MB | 0.1748s | 0.1560s | **1.1x** |
| fmt | fmt wide lines 10MB | 0.1683s | 0.1436s | **1.2x** |
| fold | fold 10MB wide lines (default) | 0.0346s | 0.0039s | **8.9x** |
| fold | fold 1MB text | 0.0042s | 0.0015s | **2.9x** |
| fold | fold 10MB text | 0.0351s | 0.0051s | **6.9x** |
| fold | -w 40 10MB | 0.0351s | 0.0043s | **8.1x** |
| fold | -w 20 10MB | 0.0361s | 0.0056s | **6.5x** |
| fold | -s -w 60 10MB | 0.0378s | 0.0049s | **7.7x** |
| fold | -s -w 40 10MB | 0.0417s | 0.0061s | **6.8x** |
...
| md5sum | single 10MB text | 0.0170s | 0.0182s | 0.9x |
...
| nl | default 1MB | 0.0044s | 0.0014s | **3.1x** |
| nl | default 10MB | 0.0328s | 0.0048s | **6.9x** |
| nl | -b a 10MB | 0.0341s | 0.0046s | **7.5x** |
| nl | -b a 10MB with blanks | 0.0424s | 0.0062s | **6.9x** |
| nl | -b a -n rz 10MB | 0.0331s | 0.0045s | **7.3x** |
| nl | -b a -w 8 -s ': ' 10MB | 0.0333s | 0.0046s | **7.2x** |
| nl | -b p'^the' 10MB | 0.0585s | 0.0049s | **11.9x** |
| nohup | nohup true | 0.0022s | 0.0023s | 0.9x |
| nproc | nproc (no args) | 0.0008s | 0.0010s | 0.8x |
| nproc | nproc --all | 0.0009s | 0.0010s | 0.9x |
| numfmt | --to=iec single value | 0.0012s | 0.0014s | 0.8x |
| numfmt | --from=iec single value | 0.0012s | 0.0014s | 0.8x |
| numfmt | --to=si from CSV column | 0.0312s | 0.0196s | **1.6x** |
| od | default 1MB text | 0.0708s | 0.0106s | **6.7x** |
| od | -A x -t x1z 1MB | 0.1216s | 0.0167s | **7.3x** |
| od | -c 1MB text | 0.1205s | 0.0111s | **10.9x** |
| od | default 10MB binary | 0.6682s | 0.0881s | **7.6x** |
| od | -N 10000 10MB | 0.0021s | 0.0020s | **1.1x** |
| paste | 2 columns 10MB | 0.0244s | 0.0085s | **2.9x** |
| paste | 3 columns 10MB | 0.0303s | 0.0156s | **1.9x** |
| paste | -d comma 10MB | 0.0235s | 0.0083s | **2.8x** |
| paste | -s 10MB single file | 0.0104s | 0.0040s | **2.6x** |
| paste | stdin split 2-way 10MB | 0.0305s | 0.0087s | **3.5x** |
...
| pinky | pinky -l | - | - | - |
| pr | pr 1MB text | 0.0107s | 0.0014s | **7.5x** |
| pr | -2 (two columns) 1MB | 0.0131s | 0.0017s | **7.7x** |
| pr | -3 (three columns) 1MB | 0.0092s | 0.0015s | **5.9x** |
| pr | -n 1MB text | 0.0119s | 0.0020s | **5.8x** |
| pr | -t 1MB text | 0.0102s | 0.0013s | **7.9x** |
...
| ptx | ptx 10KB text | 0.0020s | 0.0015s | **1.3x** |
| ptx | ptx 100KB text | 0.0118s | 0.0057s | **2.1x** |
...
| rev | reverse 1MB text | 0.0145s | 0.0019s | **7.7x** |
| rev | reverse 10MB text | 0.1344s | 0.0081s | **16.7x** |
| rev | reverse CSV 10MB | 0.1023s | 0.0076s | **13.5x** |
| rev | reverse repetitive 10MB | 0.2937s | 0.0127s | **23.1x** |
| rev | reverse 10KB single line | 0.0011s | 0.0009s | **1.2x** |
| rm | rm single file | 0.0022s | 0.0023s | 0.9x |
| rm | rm -rf directory | 0.0071s | 0.0079s | 0.9x |
...
| seq | seq 0 0.1 100000 (float) | 0.2313s | 0.0205s | **11.3x** |
| seq | seq -w 1 1000000 (zero-padded) | 0.2431s | 0.0157s | **15.5x** |
| sha1sum | single 1MB text | 0.0020s | 0.0017s | **1.2x** |
| sha1sum | single 10MB text | 0.0083s | 0.0082s | **1.0x** |
| sha1sum | single 10MB binary | 0.0084s | 0.0085s | **1.0x** |
| sha1sum | 100 files | 0.0025s | 0.0032s | 0.8x |
| sha224sum | single 1MB text | 0.0020s | 0.0017s | **1.2x** |
| sha224sum | single 10MB text | 0.0087s | 0.0085s | **1.0x** |
...
| sha384sum | single 10MB text | 0.0161s | 0.0203s | 0.8x |
| sha384sum | single 10MB binary | 0.0165s | 0.0180s | 0.9x |
| sha512sum | single 1MB text | 0.0030s | 0.0043s | 0.7x |
| sha512sum | single 10MB text | 0.0174s | 0.0187s | 0.9x |
| sha512sum | single 10MB binary | 0.0180s | 0.0194s | 0.9x |
| shred | shred 1MB file | 0.0093s | 0.0061s | **1.5x** |
| shred | shred 1MB file with remove (-u) | 0.0167s | 0.0078s | **2.1x** |
| shuf | shuf 1MB text | 0.0030s | 0.0016s | **1.9x** |
| shuf | shuf 10MB text | 0.0219s | 0.0069s | **3.2x** |
| shuf | -n 100 from 10MB | 0.0187s | 0.0040s | **4.7x** |
| shuf | -n 10000 from 10MB | 0.0212s | 0.0057s | **3.7x** |
| shuf | -i 1-1000000 | 0.0706s | 0.0137s | **5.1x** |
...
| sort | already sorted 10MB | 0.0272s | 0.0053s | **5.2x** |
| sort | reverse sorted 10MB | 0.0274s | 0.0065s | **4.2x** |
| sort | -n numeric 10MB | 0.0732s | 0.0057s | **12.9x** |
| sort | -r reverse 10MB | 0.0543s | 0.0090s | **6.0x** |
| sort | -u unique 10MB | 0.0575s | 0.0093s | **6.2x** |
| sort | -t, -k2 CSV 10MB | 0.0665s | 0.0391s | **1.7x** |
| sort | repetitive 10MB | 0.0551s | 0.0128s | **4.3x** |
| sort | --parallel=4 10MB | 0.0548s | 0.0091s | **6.0x** |
| split | split 10MB into 1MB chunks (-b 1m) | 0.0105s | 0.0083s | **1.3x** |
| split | split 10MB by 1000 lines (-l 1000) | 0.0170s | 0.0177s | **1.0x** |
| stat | stat single file | 0.0011s | 0.0011s | **1.1x** |
| stat | 100 files | 0.0052s | 0.0048s | **1.1x** |
| stat | --format=%s (size only) | 0.0010s | 0.0009s | **1.2x** |
| stat | --format='%n %s %Y' | 0.0010s | 0.0011s | 0.9x |
...
| sum | single 10MB text | 0.0178s | 0.0144s | **1.2x** |
| sum | single 10MB binary | 0.0180s | 0.0152s | **1.2x** |
...
| tac | reverse 10MB text | 0.0111s | 0.0048s | **2.3x** |
| tac | reverse CSV 10MB | 0.0094s | 0.0045s | **2.1x** |
| tac | reverse repetitive 10MB | 0.0233s | 0.0087s | **2.7x** |
...
| tee | tee 1MB to /dev/null | 0.0018s | 0.0017s | **1.1x** |
| tee | tee 10MB to /dev/null | 0.0078s | 0.0064s | **1.2x** |
| test | test -f (file exists) | 0.0008s | 0.0010s | 0.9x |
| test | test 1 -eq 1 | 0.0008s | 0.0010s | 0.8x |
| test | test 'hello' = 'hello' | 0.0009s | 0.0011s | 0.8x |
...
| tr | a-z to A-Z 10MB | 0.0179s | 0.0037s | **4.8x** |
| tr | -d digits 10MB | 0.0159s | 0.0050s | **3.2x** |
| tr | -d lowercase 10MB | 0.0327s | 0.0059s | **5.5x** |
| tr | -s spaces 10MB | 0.0279s | 0.0037s | **7.6x** |
| tr | [:lower:] to [:upper:] 10MB | 0.0194s | 0.0047s | **4.2x** |
| tr | -d [:digit:] 10MB CSV | 0.0203s | 0.0056s | **3.6x** |
| tr | translate binary 10MB | 0.0111s | 0.0040s | **2.8x** |
| true | true (startup overhead) | 0.0005s | 0.0007s | 0.7x |
| truncate | truncate to zero (-s 0) | 0.0020s | 0.0022s | 0.9x |
| truncate | create 1M file (-s 1M) | 0.0013s | 0.0015s | 0.8x |
| tsort | tsort 100K pairs | 0.0557s | 0.0073s | **7.7x** |
| tsort | tsort 1M pairs | 0.6482s | 0.0647s | **10.0x** |
...
| unexpand | unexpand 1MB text | 0.0030s | 0.0010s | **2.9x** |
| unexpand | unexpand 10MB text | 0.0236s | 0.0019s | **12.3x** |
| unexpand | -a 1MB text | 0.0073s | 0.0010s | **7.0x** |
| unexpand | -a 10MB text | 0.0695s | 0.0018s | **37.7x** |
| unexpand | -t 4 10MB text | 0.0696s | 0.0019s | **36.7x** |
| unexpand | expand|unexpand pipeline 10MB | 0.0913s | 0.0588s | **1.6x** |
| uniq | default 10MB many duplicates | 0.0114s | 0.0020s | **5.7x** |
| uniq | default 10MB sorted (low dup) | 0.0144s | 0.0030s | **4.8x** |
| uniq | -c count 10MB many dups | 0.0114s | 0.0020s | **5.8x** |
| uniq | -c count 10MB sorted | 0.0257s | 0.0085s | **3.0x** |
| uniq | -d duplicates only 10MB | 0.0126s | 0.0020s | **6.4x** |
| uniq | -u unique only 10MB | 0.0114s | 0.0020s | **5.7x** |
| uniq | -i case insensitive 10MB | 0.0142s | 0.0048s | **3.0x** |
| uniq | repetitive 10MB | 0.0310s | 0.0033s | **9.5x** |
...
| vdir | -R test data | 0.0019s | 0.0017s | **1.1x** |
| wc | default 100KB text | 0.0014s | 0.0013s | **1.1x** |
| wc | default 1MB text | 0.0058s | 0.0035s | **1.6x** |
| wc | default 10MB text | 0.0551s | 0.0032s | **17.2x** |
| wc | -l 10MB text | 0.0019s | 0.0019s | **1.0x** |
| wc | -w 10MB text | 0.0539s | 0.0137s | **3.9x** |
| wc | -c 10MB text | 0.0009s | 0.0009s | 0.9x |
| wc | -m 10MB text | 0.0538s | 0.0028s | **19.2x** |
| wc | -L 10MB text | 0.0537s | 0.0097s | **5.5x** |
| wc | default 10MB binary | 0.3192s | 0.0265s | **12.0x** |
| wc | default 10MB repetitive | 0.0726s | 0.0045s | **16.1x** |
...
| who | who -b (boot) | 0.0009s | 0.0011s | 0.9x |
| whoami | whoami (no args) | 0.0009s | 0.0010s | 0.9x |
| yes | throughput 1M lines | 0.0032s | 0.0030s | **1.1x** |
| yes | throughput 10M lines | 0.0246s | 0.0356s | 0.7x |
| yes | throughput hello 1M lines | 0.0066s | 0.0065s | **1.0x** |
| yes | throughput hello 10M lines | 0.0565s | 0.0503s | **1.1x** |
| yes | throughput 100MB | 0.0457s | 0.0474s | **1.0x** |
...
|------|------|----------:|-----------:|-----------:|-----------:|------------:|
| base64 | encode 1MB | 0.0020s | 0.0013s | 0.0013s | **1.6x** | **1.0x** |
| cat | passthrough 1MB | 0.0011s | 0.0014s | 0.0005s | **2.3x** | **3.0x** |
| cat | passthrough 10MB | 0.0018s | 0.0022s | 0.0005s | **3.6x** | **4.4x** |
| cat | -n 10MB | 0.0108s | 0.0084s | 0.0115s | 0.9x | 0.7x |
| cut | 10MB -c1-20 | 0.0188s | 0.0038s | 0.0045s | **4.2x** | 0.8x |
| echo | short string | 0.0000s | 0.0008s | 0.0001s | 0.2x | **5.7x** |
| expand | 10MB text | 0.0314s | 0.0023s | 0.0060s | **5.2x** | 0.4x |
| fold | 10MB default width | 0.0350s | 0.0049s | 0.0050s | **7.0x** | **1.0x** |
| fold | 10MB -w 40 | 0.0359s | 0.0054s | 0.0051s | **7.0x** | **1.1x** |
| head | first 1000 lines 10MB | 0.0009s | 0.0012s | 0.0003s | **2.9x** | **3.8x** |
| md5sum | 10MB file | 0.0174s | 0.0188s | 0.0244s | 0.7x | 0.8x |
| nl | 10MB text | 0.0357s | 0.0049s | 0.0042s | **8.6x** | **1.2x** |
| od | 1MB text | 0.0638s | 0.0099s | 0.0063s | **10.1x** | **1.6x** |
| rev | 10MB text | 0.1340s | 0.0080s | 0.0140s | **9.5x** | 0.6x |
| seq | 1 to 1M | 0.0104s | 0.0024s | 0.0011s | **9.8x** | **2.3x** |
| seq | 1 to 10M | 0.0968s | 0.0136s | 0.0047s | **20.4x** | **2.9x** |
| sort | 1MB text | 0.0092s | 0.0041s | 0.0061s | **1.5x** | 0.7x |
| tac | reverse 1MB | 0.0020s | 0.0015s | 0.0010s | **2.0x** | **1.5x** |
| tail | last 1000 lines 10MB | 0.0009s | 0.0012s | 0.0003s | **3.1x** | **4.2x** |
| tr | 10MB lowercase | 0.0100s | 0.0026s | 0.0048s | **2.1x** | 0.5x |
| unexpand | 10MB text | 0.0230s | 0.0025s | 0.0071s | **3.2x** | 0.3x |
| uniq | 10MB sorted | 0.0243s | 0.0031s | 0.0033s | **7.3x** | 0.9x |
| wc | 10MB text | 0.0435s | 0.0025s | 0.0400s | **1.1x** | 0.1x |
| wc | 10MB -l only | 0.0014s | 0.0015s | 0.0013s | **1.1x** | **1.2x** |
| yes | 1M lines | 0.0050s | 0.0051s | 0.0050s | **1.0x** | **1.0x** |
