...
Generated: 2026-03-01 00:24:28 UTC
...
| Linux_x86_64 | 3919 | 3765 | 46 | 96.1% |
...
|------|------|----------:|-----------------:|--------:|
| arch | arch (no args) | 0.0009s | 0.0009s | 0.9x |
...
| b2sum | single 10MB binary | 0.0163s | 0.0130s | **1.3x** |
| b2sum | -l 256 10MB | 0.0151s | 0.0125s | **1.2x** |
| b2sum | -l 128 10MB | 0.0151s | 0.0124s | **1.2x** |
| b2sum | 100 files | 0.0023s | 0.0021s | **1.1x** |
| base32 | encode 100KB text | 0.0012s | 0.0012s | 0.9x |
| base32 | encode 1MB text | 0.0025s | 0.0021s | **1.2x** |
| base32 | encode 10MB text | 0.0161s | 0.0113s | **1.4x** |
| base32 | encode 10MB binary | 0.0168s | 0.0118s | **1.4x** |
| base32 | decode 1MB | 0.0035s | 0.0026s | **1.3x** |
| base32 | decode 10MB | 0.0274s | 0.0167s | **1.6x** |
| base64 | encode 100KB text | 0.0010s | 0.0013s | 0.8x |
| base64 | encode 1MB text | 0.0035s | 0.0027s | **1.3x** |
| base64 | encode 10MB text | 0.0126s | 0.0056s | **2.3x** |
| base64 | encode 10MB binary | 0.0134s | 0.0057s | **2.4x** |
| base64 | decode 1MB | 0.0040s | 0.0022s | **1.8x** |
| base64 | decode 10MB | 0.0329s | 0.0049s | **6.7x** |
| base64 | encode -w 76 10MB | 0.0126s | 0.0055s | **2.3x** |
| base64 | encode -w 0 (no wrap) 10MB | 0.0088s | 0.0042s | **2.1x** |
...
| basenc | encode --base32 1MB | 0.0035s | 0.0033s | **1.0x** |
| basenc | encode --base16 1MB | 0.0040s | 0.0025s | **1.6x** |
...
| cat | -n 1MB | 0.0020s | 0.0017s | **1.2x** |
| cat | -n 10MB | 0.0102s | 0.0062s | **1.6x** |
| cat | -b 10MB | 0.0102s | 0.0058s | **1.7x** |
...
| cksum | single 10MB text | 0.0027s | 0.0030s | 0.9x |
| cksum | single 10MB binary | 0.0027s | 0.0030s | 0.9x |
| comm | default 10MB sorted | 0.0263s | 0.0078s | **3.4x** |
| comm | -12 (common only) 10MB | 0.0212s | 0.0061s | **3.5x** |
| comm | -23 (unique to file1) 10MB | 0.0206s | 0.0057s | **3.6x** |
| comm | -3 10MB | 0.0227s | 0.0069s | **3.3x** |
| comm | identical 10MB sorted | 0.0306s | 0.0121s | **2.5x** |
| cp | cp small file (1KB) | 0.0021s | 0.0019s | **1.1x** |
| cp | cp medium file (1MB) | 0.0029s | 0.0027s | **1.1x** |
| cp | cp large file (10MB) | 0.0102s | 0.0103s | **1.0x** |
...
| cut | -c1-100 10MB CSV | 0.0269s | 0.0048s | **5.6x** |
| cut | -d, -f1 10MB CSV | 0.0194s | 0.0097s | **2.0x** |
| cut | -d, -f1,3,5 10MB CSV | 0.0221s | 0.0114s | **1.9x** |
| cut | -d, -f2-4 10MB CSV | 0.0249s | 0.0103s | **2.4x** |
| cut | --complement -d, -f1 10MB CSV | 0.0313s | 0.0110s | **2.9x** |
...
| date | RFC 3339 | 0.0009s | 0.0010s | **1.0x** |
| date | -u (UTC) | 0.0009s | 0.0009s | 0.9x |
| dd | dd read 10MB (bs=4096) | 0.0047s | 0.0045s | **1.1x** |
| dd | dd write 10MB from /dev/zero (bs=1M count=10) | 0.0105s | 0.0146s | 0.7x |
...
| dir | -R test data | 0.0014s | 0.0017s | 0.8x |
...
| env | env true (run command) | 0.0009s | 0.0011s | 0.9x |
| env | env VAR=value true | 0.0009s | 0.0011s | 0.9x |
| expand | expand 10MB tabbed (default) | 0.0449s | 0.0352s | **1.3x** |
| expand | expand 1MB text | 0.0033s | 0.0011s | **2.9x** |
| expand | -t 4 10MB tabbed | 0.0417s | 0.0350s | **1.2x** |
| expand | -t 2 10MB tabbed | 0.0355s | 0.0347s | **1.0x** |
| expand | --initial 10MB tabbed | 0.0230s | 0.0067s | **3.4x** |
| expand | expand CSV 10MB | 0.0189s | 0.0018s | **10.7x** |
| expr | expr 1 + 1 | 0.0007s | 0.0009s | 0.8x |
| expr | expr 999999 * 999999 | 0.0007s | 0.0009s | 0.7x |
| expr | expr length 'hello world' | 0.0006s | 0.0009s | 0.7x |
| expr | expr 'hello' : 'hel' | 0.0007s | 0.0009s | 0.8x |
| factor | factor 1234567890 | 0.0009s | 0.0009s | **1.0x** |
| factor | factor 999999999999999989 (large prime) | 0.0009s | 0.0010s | 0.9x |
| factor | factor 1-100000 via stdin | 0.0188s | 0.0100s | **1.9x** |
| false | false (startup overhead) | 0.0000s | 0.0007s | 0.0x |
| fmt | fmt 1MB text | 0.0217s | 0.0182s | **1.2x** |
| fmt | fmt 10MB text | 0.1456s | 0.1477s | **1.0x** |
| fmt | -w 40 10MB | 0.1225s | 0.1117s | **1.1x** |
| fmt | -w 120 10MB | 0.1742s | 0.1929s | 0.9x |
| fmt | fmt wide lines 10MB | 0.1659s | 0.1830s | 0.9x |
| fold | fold 10MB wide lines (default) | 0.0353s | 0.0058s | **6.0x** |
| fold | fold 1MB text | 0.0042s | 0.0019s | **2.3x** |
| fold | fold 10MB text | 0.0350s | 0.0082s | **4.3x** |
| fold | -w 40 10MB | 0.0358s | 0.0064s | **5.6x** |
| fold | -w 20 10MB | 0.0367s | 0.0074s | **5.0x** |
| fold | -s -w 60 10MB | 0.0391s | 0.0067s | **5.9x** |
| fold | -s -w 40 10MB | 0.0403s | 0.0071s | **5.7x** |
| fold | -b -w 40 10MB | 0.0331s | 0.0062s | **5.4x** |
...
| head | -n 100000 10MB | 0.0063s | 0.0030s | **2.1x** |
...
| install | install 1MB file | 0.0032s | 0.0029s | **1.1x** |
| install | install -d create directory | 0.0026s | 0.0025s | **1.0x** |
| join | default join 10MB | - | - | - |
| join | outer join 10MB | - | - | - |
| join | -v 1 (unmatched from file1) 10MB | - | - | - |
| join | -o 0,1.2,2.2 10MB | - | - | - |
| join | self-join sorted 10MB | 0.0467s | 0.0384s | **1.2x** |
...
| ln | symlink force overwrite (-sf) | 0.0020s | 0.0019s | **1.0x** |
...
| md5sum | single 10MB text | 0.0170s | 0.0190s | 0.9x |
| md5sum | single 10MB binary | 0.0179s | 0.0204s | 0.9x |
| md5sum | 10 files | 0.0013s | 0.0027s | 0.5x |
| md5sum | 100 files | 0.0023s | 0.0033s | 0.7x |
| mkdir | mkdir single directory | 0.0027s | 0.0021s | **1.2x** |
...
| mv | mv same-fs large (10MB) | 0.0113s | 0.0111s | **1.0x** |
...
| nl | default 10MB | 0.0357s | 0.0068s | **5.3x** |
| nl | -b a 10MB | 0.0354s | 0.0067s | **5.3x** |
| nl | -b a 10MB with blanks | 0.0451s | 0.0089s | **5.1x** |
| nl | -b a -n rz 10MB | 0.0363s | 0.0069s | **5.3x** |
| nl | -b a -w 8 -s ': ' 10MB | 0.0367s | 0.0072s | **5.1x** |
| nl | -b p'^the' 10MB | 0.0609s | 0.0117s | **5.2x** |
| nohup | nohup true | 0.0023s | 0.0023s | **1.0x** |
...
| numfmt | --to=si from CSV column | 0.0262s | 0.0532s | 0.5x |
| od | default 1MB text | 0.0664s | 0.0403s | **1.6x** |
| od | -A x -t x1z 1MB | 0.1176s | 0.0689s | **1.7x** |
| od | -c 1MB text | 0.1203s | 0.0451s | **2.7x** |
| od | default 10MB binary | 0.6741s | 0.4291s | **1.6x** |
| od | -N 10000 10MB | 0.0022s | 0.0023s | **1.0x** |
| paste | 2 columns 10MB | 0.0239s | 0.0093s | **2.6x** |
| paste | 3 columns 10MB | 0.0306s | 0.0143s | **2.1x** |
| paste | -d comma 10MB | 0.0237s | 0.0092s | **2.6x** |
| paste | -s 10MB single file | 0.0108s | 0.0054s | **2.0x** |
| paste | stdin split 2-way 10MB | 0.0296s | 0.0180s | **1.7x** |
...
| ptx | ptx 10KB text | 0.0020s | 0.0056s | 0.4x |
| ptx | ptx 100KB text | 0.0109s | 0.4252s | 0.0x |
| ptx | -w 60 100KB text | 0.0099s | 0.4232s | 0.0x |
...
| rev | reverse 100KB text | 0.0023s | 0.0012s | **2.0x** |
| rev | reverse 1MB text | 0.0147s | 0.0019s | **7.6x** |
| rev | reverse 10MB text | 0.1345s | 0.0079s | **17.0x** |
| rev | reverse CSV 10MB | 0.0999s | 0.0072s | **13.9x** |
| rev | reverse repetitive 10MB | 0.2872s | 0.0130s | **22.1x** |
...
| seq | seq 1000000 | 0.0106s | 0.0025s | **4.2x** |
| seq | seq 1 10000000 | 0.0969s | 0.0140s | **6.9x** |
| seq | seq 0 0.1 100000 (float) | 0.2321s | 0.0194s | **12.0x** |
| seq | seq -w 1 1000000 (zero-padded) | 0.2430s | 0.0160s | **15.2x** |
| sha1sum | single 1MB text | 0.0019s | 0.0032s | 0.6x |
| sha1sum | single 10MB text | 0.0080s | 0.0097s | 0.8x |
| sha1sum | single 10MB binary | 0.0082s | 0.0101s | 0.8x |
| sha1sum | 100 files | 0.0023s | 0.0032s | 0.7x |
| sha224sum | single 1MB text | 0.0020s | 0.0033s | 0.6x |
| sha224sum | single 10MB text | 0.0086s | 0.0103s | 0.8x |
| sha224sum | single 10MB binary | 0.0086s | 0.0104s | 0.8x |
| sha256sum | single 100KB text | 0.0014s | 0.0027s | 0.5x |
| sha256sum | single 1MB text | 0.0020s | 0.0034s | 0.6x |
| sha256sum | single 10MB text | 0.0096s | 0.0105s | 0.9x |
| sha256sum | single 10MB binary | 0.0089s | 0.0107s | 0.8x |
| sha256sum | 10 files | 0.0014s | 0.0027s | 0.5x |
| sha256sum | 100 files | 0.0033s | 0.0046s | 0.7x |
| sha384sum | single 1MB text | 0.0027s | 0.0040s | 0.7x |
| sha384sum | single 10MB text | 0.0156s | 0.0173s | 0.9x |
| sha384sum | single 10MB binary | 0.0163s | 0.0181s | 0.9x |
| sha512sum | single 1MB text | 0.0027s | 0.0042s | 0.6x |
| sha512sum | single 10MB text | 0.0156s | 0.0173s | 0.9x |
| sha512sum | single 10MB binary | 0.0161s | 0.0178s | 0.9x |
| shred | shred 1MB file | 0.0092s | 0.0064s | **1.4x** |
| shred | shred 1MB file with remove (-u) | 0.0176s | 0.0075s | **2.3x** |
| shuf | shuf 1MB text | 0.0029s | 0.0023s | **1.3x** |
| shuf | shuf 10MB text | 0.0161s | 0.0141s | **1.1x** |
| shuf | -n 100 from 10MB | 0.0188s | 0.0108s | **1.8x** |
| shuf | -n 10000 from 10MB | 0.0204s | 0.0109s | **1.9x** |
| shuf | -i 1-1000000 | 0.0694s | 0.0389s | **1.8x** |
| shuf | -i 1-1000000 -n 100 | 0.0009s | 0.0270s | 0.0x |
| sleep | sleep 0 (startup overhead) | 0.0010s | 0.0011s | **1.0x** |
| sleep | sleep 0.001 (tiny sleep) | 0.0020s | 0.0021s | **1.0x** |
| sort | lexicographic 1MB | 0.0087s | 0.0037s | **2.3x** |
| sort | lexicographic 10MB random | 0.0606s | 0.0096s | **6.3x** |
| sort | already sorted 10MB | 0.0267s | 0.0052s | **5.1x** |
| sort | reverse sorted 10MB | 0.0277s | 0.0066s | **4.2x** |
| sort | -n numeric 10MB | 0.0746s | 0.0058s | **13.0x** |
| sort | -r reverse 10MB | 0.0551s | 0.0098s | **5.7x** |
| sort | -u unique 10MB | 0.0583s | 0.0105s | **5.6x** |
| sort | -t, -k2 CSV 10MB | 0.0671s | 0.0412s | **1.6x** |
| sort | repetitive 10MB | 0.0551s | 0.0135s | **4.1x** |
| sort | --parallel=4 10MB | 0.0552s | 0.0093s | **6.0x** |
| split | split 10MB into 1MB chunks (-b 1m) | - | - | - |
| split | split 10MB by 1000 lines (-l 1000) | 0.0176s | 0.0186s | 0.9x |
| stat | stat single file | 0.0012s | 0.0012s | **1.0x** |
| stat | 100 files | 0.0049s | 0.0051s | **1.0x** |
| stat | --format=%s (size only) | 0.0011s | 0.0011s | **1.0x** |
| stat | --format='%n %s %Y' | 0.0011s | 0.0010s | **1.0x** |
| stat | -f (filesystem) | 0.0011s | 0.0011s | **1.0x** |
...
| tac | reverse 10MB text | 0.0105s | 0.0056s | **1.9x** |
| tac | reverse CSV 10MB | 0.0096s | 0.0053s | **1.8x** |
...
| tail | -n 100000 10MB | 0.0062s | 0.0032s | **2.0x** |
| tail | -n +100 10MB (from line 100) | 0.0040s | 0.0021s | **1.9x** |
| tail | -n +100000 10MB (from line 100000) | 0.0042s | 0.0034s | **1.3x** |
...
| tee | tee 10MB to /dev/null | 0.0075s | 0.0065s | **1.2x** |
...
| timeout | timeout 10 true | 0.0011s | 0.0112s | 0.1x |
| timeout | timeout 10 echo hello | 0.0013s | 0.0113s | 0.1x |
| touch | create new file | 0.0017s | 0.0019s | 0.9x |
| touch | update existing file timestamp | 0.0010s | 0.0010s | **1.0x** |
| touch | set specific timestamp (-t) | 0.0018s | 0.0018s | **1.0x** |
| tr | a-z to A-Z 1MB | 0.0023s | 0.0016s | **1.5x** |
| tr | a-z to A-Z 10MB | 0.0159s | 0.0042s | **3.8x** |
| tr | -d digits 10MB | 0.0248s | 0.0053s | **4.7x** |
| tr | -d lowercase 10MB | 0.0310s | 0.0049s | **6.4x** |
| tr | -s spaces 10MB | 0.0279s | 0.0039s | **7.2x** |
| tr | [:lower:] to [:upper:] 10MB | 0.0127s | 0.0037s | **3.4x** |
| tr | -d [:digit:] 10MB CSV | 0.0161s | 0.0043s | **3.8x** |
| tr | translate binary 10MB | 0.0140s | 0.0039s | **3.5x** |
| true | true (startup overhead) | 0.0001s | 0.0007s | 0.1x |
| truncate | truncate to zero (-s 0) | 0.0020s | 0.0023s | 0.9x |
| truncate | create 1M file (-s 1M) | 0.0012s | 0.0014s | 0.8x |
| tsort | tsort 100K pairs | 0.0647s | 0.0115s | **5.6x** |
| tsort | tsort 1M pairs | 0.6515s | 0.0628s | **10.4x** |
| tty | tty (no args) | 0.0009s | 0.0010s | 0.9x |
| uname | uname (no args) | 0.0008s | 0.0010s | 0.9x |
| uname | uname -a | 0.0009s | 0.0011s | 0.8x |
| uname | uname -r | 0.0009s | 0.0010s | 0.9x |
| uname | uname -m | 0.0009s | 0.0010s | 0.9x |
| unexpand | unexpand 1MB text | 0.0030s | 0.0013s | **2.4x** |
| unexpand | unexpand 10MB text | 0.0247s | 0.0040s | **6.2x** |
| unexpand | -a 1MB text | 0.0073s | 0.0051s | **1.4x** |
| unexpand | -a 10MB text | 0.0701s | 0.0366s | **1.9x** |
| unexpand | -t 4 10MB text | 0.0702s | 0.0384s | **1.8x** |
| unexpand | expand|unexpand pipeline 10MB | 0.0933s | 0.0990s | 0.9x |
...
| uniq | repetitive 10MB | 0.0434s | 0.0035s | **12.6x** |
| unlink | unlink a file | 0.0021s | 0.0022s | 0.9x |
| uptime | uptime (default) | 0.0012s | 0.0010s | **1.3x** |
...
| vdir | 100 files directory | 0.0018s | 0.0016s | **1.1x** |
...
| wc | -m 10MB text | 0.0542s | 0.0030s | **18.1x** |
| wc | -L 10MB text | 0.0542s | 0.0098s | **5.5x** |
| wc | default 10MB binary | 0.3170s | 0.0270s | **11.7x** |
| wc | default 10MB repetitive | 0.0729s | 0.0044s | **16.5x** |
...
| yes | throughput 10M lines | 0.0339s | 0.0215s | **1.6x** |
| yes | throughput hello 1M lines | 0.0082s | 0.0087s | 0.9x |
| yes | throughput hello 10M lines | 0.0509s | 0.0573s | 0.9x |
| yes | throughput 100MB | 0.0459s | 0.0432s | **1.1x** |
