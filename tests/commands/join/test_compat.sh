...
GNU_TOOL=$(resolve_gnu_tool "join")
F_TOOL="fjoin"
...
run_join_tests() {
    ...
    # === GNU Upstream: UTF-8 Separators ===
    echo ""
    echo "=== GNU Upstream: UTF-8 Separators ==="

    run_test "vertical line separator" \
        "$GNU_TOOL -t'|' -a1 -a2 -eouch -o '0,1.2,2.2' <(printf '0|A\n1|a\n2|b\n4|c\n') <(printf '0|B\n1|d\n3|e\n4|f\n')" \
        "$F_TOOL -t'|' -a1 -a2 -eouch -o '0,1.2,2.2' <(printf '0|A\n1|a\n2|b\n4|c\n') <(printf '0|B\n1|d\n3|e\n4|f\n')"

    run_test "space separator with -a -e -o" \
        "$GNU_TOOL -a1 -a2 -eouch -o '0,1.2,2.2' <(printf '0 A\n1 a\n2 b\n4 c\n') <(printf '0 B\n1 d\n3 e\n4 f\n')" \
        "$F_TOOL -a1 -a2 -eouch -o '0,1.2,2.2' <(printf '0 A\n1 a\n2 b\n4 c\n') <(printf '0 B\n1 d\n3 e\n4 f\n')"
