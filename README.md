...
- **Compatibility:** 1059/1209 tests passed (87.6%)
...
### Known Issues
- 150 compatibility test failures across 5 platforms
...
## Platform Functional Tests (v0.9.2)

| Platform | Passed | Failed | Skipped | Status |
|----------|--------|--------|---------|--------|
| Linux x86_64 | 417 | 23 | 0 | ⚠️ |
| Linux ARM64 | 417 | 23 | 0 | ⚠️ |
