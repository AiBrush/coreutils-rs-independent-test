...
Generated: 2026-02-11 22:25:02 UTC
...
```
1d0
< md5sum: /tmp/fcoreutils_md5missing_NDfSA6: no file was verified
...
# GNU command:
md5sum -c --ignore-missing '/tmp/fcoreutils_md5missing_NDfSA6'
echo "GNU exit: $?"

# fcoreutils command:
fmd5sum -c --ignore-missing '/tmp/fcoreutils_md5missing_NDfSA6'
...
```
1d0
< sha256sum: /tmp/fcoreutils_missingcheck_uekL9l: no file was verified
Exit code mismatch: GNU=1, fcoreutils=0
...
# GNU command:
sha256sum -c --ignore-missing '/tmp/fcoreutils_missingcheck_uekL9l'
echo "GNU exit: $?"

# fcoreutils command:
fsha256sum -c --ignore-missing '/tmp/fcoreutils_missingcheck_uekL9l'
echo "fcoreutils exit: $?"
...
```
1d0
< md5sum: /tmp/fcoreutils_md5missing_2FdQy4: no file was verified
Exit code mismatch: GNU=1, fcoreutils=0
...
# Reproduction case for: md5sum - -c --ignore-missing
# GNU command:
md5sum -c --ignore-missing '/tmp/fcoreutils_md5missing_2FdQy4'
echo "GNU exit: $?"

# fcoreutils command:
fmd5sum -c --ignore-missing '/tmp/fcoreutils_md5missing_2FdQy4'
echo "fcoreutils exit: $?"
...
```
1c1
<    3   19 1024 /tmp/fcoreutils-test-data/random_1k.bin
---
>    3   20 1024 /tmp/fcoreutils-test-data/random_1k.bin
...
```
1d0
< sha256sum: /tmp/fcoreutils_missingcheck_uq1zwM: no file was verified
Exit code mismatch: GNU=1, fcoreutils=0
...
# Reproduction case for: sha256sum - -c --ignore-missing
# GNU command:
sha256sum -c --ignore-missing '/tmp/fcoreutils_missingcheck_uq1zwM'
echo "GNU exit: $?"

# fcoreutils command:
fsha256sum -c --ignore-missing '/tmp/fcoreutils_missingcheck_uq1zwM'
echo "fcoreutils exit: $?"
...
# GNU command:
sha256sum -c --status '/tmp/fcoreutils_checksums_BT9K3I'
echo "GNU exit: $?"

# fcoreutils command:
fsha256sum -c --status '/tmp/fcoreutils_checksums_BT9K3I'
echo "fcoreutils exit: $?"
...
# GNU command:
md5sum -c '/tmp/fcoreutils_md5check_luq9Qs'
echo "GNU exit: $?"

# fcoreutils command:
fmd5sum -c '/tmp/fcoreutils_md5check_luq9Qs'
echo "fcoreutils exit: $?"
...
```
1d0
< md5sum: /tmp/fcoreutils_md5missing_cwZtXe: no file was verified
Exit code mismatch: GNU=1, fcoreutils=0
...
# Reproduction case for: md5sum - -c --ignore-missing
# GNU command:
md5sum -c --ignore-missing '/tmp/fcoreutils_md5missing_cwZtXe'
echo "GNU exit: $?"

# fcoreutils command:
fmd5sum -c --ignore-missing '/tmp/fcoreutils_md5missing_cwZtXe'
echo "fcoreutils exit: $?"
...
```
1c1
<    6   31 1024 /tmp/fcoreutils-test-data/random_1k.bin
---
>    6   24 1024 C:/Users/RUNNER~1/AppData/Local/Temp/fcoreutils-test-data/random_1k.bin
...
```
1c1
< 9325da79c96b1cf1135fcddda339c9d8 */tmp/fcoreutils-test-data/random_1k.bin
---
> 9325da79c96b1cf1135fcddda339c9d8  C:/Users/RUNNER~1/AppData/Local/Temp/fcoreutils-test-data/random_1k.bin
...
# GNU command:
md5sum -c --quiet '/tmp/fcoreutils_md5check_luq9Qs'
echo "GNU exit: $?"

# fcoreutils command:
fmd5sum -c --quiet '/tmp/fcoreutils_md5check_luq9Qs'
echo "fcoreutils exit: $?"
...
```
1c1
< a275ca04f2be9d5814946b1f596676029519190f28d331ee357210a9a5cda979 */tmp/fcoreutils-test-data/random_1k.bin
---
> a275ca04f2be9d5814946b1f596676029519190f28d331ee357210a9a5cda979  C:/Users/RUNNER~1/AppData/Local/Temp/fcoreutils-test-data/random_1k.bin
...
```
1c1
< 75c57add5cce4945b4f417b5885802c2b5f1d14189b20e1602bc14e6f210cdeebcead16a0b8a99ae32bcbf5f173a16f8c507ce548fc4130d9c4510ab9c522306 */tmp/fcoreutils-test-data/random_10m.bin
---
> 75c57add5cce4945b4f417b5885802c2b5f1d14189b20e1602bc14e6f210cdeebcead16a0b8a99ae32bcbf5f173a16f8c507ce548fc4130d9c4510ab9c522306  C:/Users/RUNNER~1/AppData/Local/Temp/fcoreutils-test-data/random_10m.bin
...
```
1c1
< a275ca04f2be9d5814946b1f596676029519190f28d331ee357210a9a5cda979 *-
---
> a275ca04f2be9d5814946b1f596676029519190f28d331ee357210a9a5cda979  -
...
**Diff:**
```
Binary files /tmp/gnu_output_4212 and /tmp/f_output_4212 differ
...
**Diff:**
```
Binary files /tmp/gnu_output_5137 and /tmp/f_output_5137 differ
...
# GNU command:
sha256sum -c '/tmp/fcoreutils_checksums_BT9K3I'
echo "GNU exit: $?"

# fcoreutils command:
fsha256sum -c '/tmp/fcoreutils_checksums_BT9K3I'
echo "fcoreutils exit: $?"
...
```
1c1
< 58ae8b1c5d4baef0380a749df540e631f4c554cd1c3cd5712857783008dcb3429229d0ca41bf8868d3c540a6aa72b2a5092e0509f042e9dd7d63f91bcb1ec22f */tmp/fcoreutils-test-data/random_1k.bin
---
> 58ae8b1c5d4baef0380a749df540e631f4c554cd1c3cd5712857783008dcb3429229d0ca41bf8868d3c540a6aa72b2a5092e0509f042e9dd7d63f91bcb1ec22f  C:/Users/RUNNER~1/AppData/Local/Temp/fcoreutils-test-data/random_1k.bin
...
```
1c1
< e861d1a544c9ee05cf0d132df55831f6 */tmp/fcoreutils-test-data/random_10m.bin
---
> e861d1a544c9ee05cf0d132df55831f6  C:/Users/RUNNER~1/AppData/Local/Temp/fcoreutils-test-data/random_10m.bin
...
# GNU command:
b2sum -c '/tmp/fcoreutils_b2check_OvSyhr'
echo "GNU exit: $?"

# fcoreutils command:
fb2sum -c '/tmp/fcoreutils_b2check_OvSyhr'
echo "fcoreutils exit: $?"
...
# GNU command:
wc --files0-from='/tmp/fcoreutils_filelist_Zx8Nxw'
echo "GNU exit: $?"

# fcoreutils command:
fwc --files0-from='/tmp/fcoreutils_filelist_Zx8Nxw'
echo "fcoreutils exit: $?"
...
```
1c1
< 9325da79c96b1cf1135fcddda339c9d8 *-
---
> 9325da79c96b1cf1135fcddda339c9d8  -
...
# GNU command:
md5sum -c --status '/tmp/fcoreutils_md5check_luq9Qs'
echo "GNU exit: $?"

# fcoreutils command:
fmd5sum -c --status '/tmp/fcoreutils_md5check_luq9Qs'
echo "fcoreutils exit: $?"
...
```
1d0
< sha256sum: /tmp/fcoreutils_missingcheck_SeI7yY: no file was verified
Exit code mismatch: GNU=1, fcoreutils=0
...
# Reproduction case for: sha256sum - -c --ignore-missing
# GNU command:
sha256sum -c --ignore-missing '/tmp/fcoreutils_missingcheck_SeI7yY'
echo "GNU exit: $?"

# fcoreutils command:
fsha256sum -c --ignore-missing '/tmp/fcoreutils_missingcheck_SeI7yY'
echo "fcoreutils exit: $?"
...
```
1c1
< b6b3a2a23b44f3eb74f3ba269ce0f85c04ae33f191f3b1b7b3f267728db60278 */tmp/fcoreutils-test-data/random_10m.bin
---
> b6b3a2a23b44f3eb74f3ba269ce0f85c04ae33f191f3b1b7b3f267728db60278  C:/Users/RUNNER~1/AppData/Local/Temp/fcoreutils-test-data/random_10m.bin
...
# GNU command:
sha256sum -c --quiet '/tmp/fcoreutils_checksums_BT9K3I'
echo "GNU exit: $?"

# fcoreutils command:
fsha256sum -c --quiet '/tmp/fcoreutils_checksums_BT9K3I'
echo "fcoreutils exit: $?"
...
```
1d0
< md5sum: /tmp/fcoreutils_md5missing_xsTU7g: no file was verified
Exit code mismatch: GNU=1, fcoreutils=0
...
# Reproduction case for: md5sum - -c --ignore-missing
# GNU command:
md5sum -c --ignore-missing '/tmp/fcoreutils_md5missing_xsTU7g'
echo "GNU exit: $?"

# fcoreutils command:
fmd5sum -c --ignore-missing '/tmp/fcoreutils_md5missing_xsTU7g'
echo "fcoreutils exit: $?"
...
```
1d0
< sha256sum: /tmp/fcoreutils_missingcheck_sIMqDP: no file was verified
Exit code mismatch: GNU=1, fcoreutils=0
...
# Reproduction case for: sha256sum - -c --ignore-missing
# GNU command:
sha256sum -c --ignore-missing '/tmp/fcoreutils_missingcheck_sIMqDP'
echo "GNU exit: $?"

# fcoreutils command:
fsha256sum -c --ignore-missing '/tmp/fcoreutils_missingcheck_sIMqDP'
echo "fcoreutils exit: $?"
...
# Reproduction case for: sha256sum - -c --status valid checksums
# GNU command:
sha256sum -c --status '/tmp/fcoreutils_checksums_4v1BIe'
echo "GNU exit: $?"

# fcoreutils command:
fsha256sum -c --status '/tmp/fcoreutils_checksums_4v1BIe'
echo "fcoreutils exit: $?"
...
# Reproduction case for: md5sum - -c check valid
# GNU command:
md5sum -c '/tmp/fcoreutils_md5check_2t34yV'
echo "GNU exit: $?"

# fcoreutils command:
fmd5sum -c '/tmp/fcoreutils_md5check_2t34yV'
echo "fcoreutils exit: $?"
...
```
1d0
< md5sum: /tmp/fcoreutils_md5missing_cZ6Vil: no file was verified
Exit code mismatch: GNU=1, fcoreutils=0
...
# Reproduction case for: md5sum - -c --ignore-missing
# GNU command:
md5sum -c --ignore-missing '/tmp/fcoreutils_md5missing_cZ6Vil'
echo "GNU exit: $?"

# fcoreutils command:
fmd5sum -c --ignore-missing '/tmp/fcoreutils_md5missing_cZ6Vil'
echo "fcoreutils exit: $?"
...
```
1c1
< c553784908df52cd38ab5beabe8acf18 */tmp/fcoreutils-test-data/random_1k.bin
---
> c553784908df52cd38ab5beabe8acf18  C:/Users/RUNNER~1/AppData/Local/Temp/fcoreutils-test-data/random_1k.bin
...
# Reproduction case for: md5sum - -c --quiet
# GNU command:
md5sum -c --quiet '/tmp/fcoreutils_md5check_2t34yV'
echo "GNU exit: $?"

# fcoreutils command:
fmd5sum -c --quiet '/tmp/fcoreutils_md5check_2t34yV'
echo "fcoreutils exit: $?"
...
```
1c1
< c8a82864cb48d5297905b514f1dfa1109b0342860e446c80a4fef056b5e8aef9 */tmp/fcoreutils-test-data/random_1k.bin
---
> c8a82864cb48d5297905b514f1dfa1109b0342860e446c80a4fef056b5e8aef9  C:/Users/RUNNER~1/AppData/Local/Temp/fcoreutils-test-data/random_1k.bin
...
```
1c1
< e439215a9a22cc153e35a5d53d089860ce1f6321645025bbab3e5804b5906455cead7f68b8a485bb8a3d5737b71390f5820464ad8a880655f0b5b7b5391a62ae */tmp/fcoreutils-test-data/random_10m.bin
---
> e439215a9a22cc153e35a5d53d089860ce1f6321645025bbab3e5804b5906455cead7f68b8a485bb8a3d5737b71390f5820464ad8a880655f0b5b7b5391a62ae  C:/Users/RUNNER~1/AppData/Local/Temp/fcoreutils-test-data/random_10m.bin
...
```
1c1
< c8a82864cb48d5297905b514f1dfa1109b0342860e446c80a4fef056b5e8aef9 *-
---
> c8a82864cb48d5297905b514f1dfa1109b0342860e446c80a4fef056b5e8aef9  -
...
**Diff:**
```
Binary files /tmp/gnu_output_3256 and /tmp/f_output_3256 differ
...
**Diff:**
```
Binary files /tmp/gnu_output_4181 and /tmp/f_output_4181 differ
...
# Reproduction case for: sha256sum - -c check valid checksums
# GNU command:
sha256sum -c '/tmp/fcoreutils_checksums_4v1BIe'
echo "GNU exit: $?"

# fcoreutils command:
fsha256sum -c '/tmp/fcoreutils_checksums_4v1BIe'
echo "fcoreutils exit: $?"
...
```
1c1
< 4a27df70cf88b1d135c27c5e8410e1cef6f4e8c07d76ccdbce1e0fffc581fd92673d5f9f017d061b5accb10a531b7972b7fa828302a8fd346c06ababf6d04ec2 */tmp/fcoreutils-test-data/random_1k.bin
---
> 4a27df70cf88b1d135c27c5e8410e1cef6f4e8c07d76ccdbce1e0fffc581fd92673d5f9f017d061b5accb10a531b7972b7fa828302a8fd346c06ababf6d04ec2  C:/Users/RUNNER~1/AppData/Local/Temp/fcoreutils-test-data/random_1k.bin
...
```
1c1
< 8edf6013b63a67b5bd34a32ca0c42faf */tmp/fcoreutils-test-data/random_10m.bin
---
> 8edf6013b63a67b5bd34a32ca0c42faf  C:/Users/RUNNER~1/AppData/Local/Temp/fcoreutils-test-data/random_10m.bin
...
# Reproduction case for: b2sum - -c check valid
# GNU command:
b2sum -c '/tmp/fcoreutils_b2check_S5PxwW'
echo "GNU exit: $?"

# fcoreutils command:
fb2sum -c '/tmp/fcoreutils_b2check_S5PxwW'
echo "fcoreutils exit: $?"
...
# Reproduction case for: wc - --files0-from
# GNU command:
wc --files0-from='/tmp/fcoreutils_filelist_ZfXMCY'
echo "GNU exit: $?"

# fcoreutils command:
fwc --files0-from='/tmp/fcoreutils_filelist_ZfXMCY'
echo "fcoreutils exit: $?"
...
```
1c1
< c553784908df52cd38ab5beabe8acf18 *-
---
> c553784908df52cd38ab5beabe8acf18  -
...
# Reproduction case for: md5sum - -c --status
# GNU command:
md5sum -c --status '/tmp/fcoreutils_md5check_2t34yV'
echo "GNU exit: $?"

# fcoreutils command:
fmd5sum -c --status '/tmp/fcoreutils_md5check_2t34yV'
echo "fcoreutils exit: $?"
...
```
1d0
< sha256sum: /tmp/fcoreutils_missingcheck_0ab9w9: no file was verified
Exit code mismatch: GNU=1, fcoreutils=0
...
# Reproduction case for: sha256sum - -c --ignore-missing
# GNU command:
sha256sum -c --ignore-missing '/tmp/fcoreutils_missingcheck_0ab9w9'
echo "GNU exit: $?"

# fcoreutils command:
fsha256sum -c --ignore-missing '/tmp/fcoreutils_missingcheck_0ab9w9'
echo "fcoreutils exit: $?"
...
```
1c1
< 71592bfed656558b5a37f5f8c9462091613be594fd97422ac00c8c070b27f7aa */tmp/fcoreutils-test-data/random_10m.bin
---
> 71592bfed656558b5a37f5f8c9462091613be594fd97422ac00c8c070b27f7aa  C:/Users/RUNNER~1/AppData/Local/Temp/fcoreutils-test-data/random_10m.bin
...
# Reproduction case for: sha256sum - -c --quiet valid checksums
# GNU command:
sha256sum -c --quiet '/tmp/fcoreutils_checksums_4v1BIe'
echo "GNU exit: $?"

# fcoreutils command:
fsha256sum -c --quiet '/tmp/fcoreutils_checksums_4v1BIe'
echo "fcoreutils exit: $?"
...
|------|-----------|-------------------|---------|
| wc (default 100KB text) | 0.0034s | 0.0096s | **0.4x** |
| wc (default 1MB text) | 0.0059s | 0.0056s | **1.1x** |
| wc (default 10MB text) | 0.0422s | 0.0106s | **4.0x** |
| wc (default 100MB text) | 0.3178s | 0.0449s | **7.1x** |
| wc (-l 10MB text) | 0.0133s | 0.0022s | **6.1x** |
| wc (-w 10MB text) | 0.0450s | 0.0074s | **6.1x** |
| wc (-c 10MB text) | 0.0049s | 0.0019s | **2.6x** |
| wc (-m 10MB text) | 0.0329s | 0.0072s | **4.6x** |
| wc (-L 10MB text) | 0.0542s | 0.0337s | **1.6x** |
| wc (default 10MB binary) | 0.1928s | 0.0105s | **18.4x** |
| wc (default 10MB repetitive) | 0.0610s | 0.0126s | **4.8x** |
| wc (10 files) | 0.0007s | 0.0079s | **0.1x** |
| wc (100 files) | 0.0165s | 0.0233s | **0.7x** |
| cut | - | - | no data |
| sha256sum (single 100KB text) | - | 0.0057s | - |
| sha256sum (single 1MB text) | 0.0046s | 0.0142s | **0.3x** |
| sha256sum (single 10MB text) | 0.0462s | 0.0493s | **0.9x** |
| sha256sum (single 10MB binary) | 0.0673s | 0.0690s | **1.0x** |
| sha256sum (single 100MB text) | 0.4722s | 0.4146s | **1.1x** |
| sha256sum (10 files) | 0.0044s | 0.0156s | **0.3x** |
| sha256sum (100 files) | 0.0075s | 0.0162s | **0.5x** |
| md5sum | - | - | no data |
| b2sum (single 100KB text) | 0.0090s | 0.0033s | **2.7x** |
| b2sum (single 1MB text) | 0.0207s | 0.0091s | **2.3x** |
| b2sum (single 10MB text) | 0.0154s | 0.0129s | **1.2x** |
| b2sum (single 10MB binary) | 0.0162s | 0.0022s | **7.3x** |
| b2sum (single 100MB text) | 0.2067s | 0.1757s | **1.2x** |
| b2sum (-l 256 10MB) | 0.0473s | 0.0411s | **1.2x** |
| b2sum (-l 128 10MB) | 0.0213s | 0.0150s | **1.4x** |
| b2sum (100 files) | 0.0214s | 0.0123s | **1.7x** |
| base64 (encode 100KB text) | 0.0015s | 0.0033s | **0.4x** |
| base64 (encode 1MB text) | 0.0020s | 0.0219s | **0.1x** |
| base64 (encode 10MB text) | 0.0217s | 0.0096s | **2.3x** |
| base64 (encode 10MB binary) | 0.0341s | 0.0098s | **3.5x** |
| base64 (decode 1MB) | 0.0197s | 0.0196s | **1.0x** |
| base64 (decode 10MB) | 0.0484s | 0.0287s | **1.7x** |
| base64 (encode -w 76 10MB) | 0.0270s | 0.0001s | **284.3x** |
| base64 (encode -w 0 (no wrap) 10MB) | 0.0315s | 0.0084s | **3.7x** |
| sort (lexicographic 1MB) | 0.1135s | 0.0042s | **26.8x** |
| sort (lexicographic 10MB random) | 0.5732s | 0.0453s | **12.6x** |
| sort (already sorted 10MB) | 0.2170s | 0.0068s | **31.8x** |
| sort (reverse sorted 10MB) | 0.2387s | 0.0111s | **21.4x** |
| sort (-n numeric 10MB) | 0.5102s | 0.0598s | **8.5x** |
| sort (-r reverse 10MB) | 0.4921s | 0.0322s | **15.3x** |
| sort (-u unique 10MB) | 0.5716s | 0.0250s | **22.8x** |
| sort (-t, -k2 CSV 10MB) | 0.7198s | 0.0511s | **14.1x** |
| sort (repetitive 10MB) | 0.0728s | 0.0219s | **3.3x** |
| sort (--parallel=4 10MB) | 0.4967s | 0.0657s | **7.6x** |
| tr (a-z to A-Z 1MB) | 0.0280s | 0.0217s | **1.3x** |
| tr (a-z to A-Z 10MB) | 0.0203s | 0.0171s | **1.2x** |
| tr (-d digits 10MB) | 0.0290s | 0.0092s | **3.1x** |
| tr (-d lowercase 10MB) | 0.0689s | 0.0498s | **1.4x** |
| tr (-s spaces 10MB) | 0.0603s | 0.0401s | **1.5x** |
| tr ([:lower:] to [:upper:] 10MB) | 0.0143s | 0.0153s | **0.9x** |
| tr (-d [:digit:] 10MB CSV) | 0.0354s | 0.0233s | **1.5x** |
| tr (translate binary 10MB) | 0.0265s | 0.0128s | **2.1x** |
| uniq (default 10MB many duplicates) | 0.0125s | 0.0057s | **2.2x** |
| uniq (default 10MB sorted (low dup)) | 0.0217s | 0.0105s | **2.1x** |
| uniq (-c count 10MB many dups) | 0.0146s | 0.0076s | **1.9x** |
| uniq (-c count 10MB sorted) | 0.0389s | 0.0135s | **2.9x** |
| uniq (-d duplicates only 10MB) | 0.0189s | 0.0095s | **2.0x** |
| uniq (-u unique only 10MB) | 0.0179s | 0.0085s | **2.1x** |
| uniq (-i case insensitive 10MB) | 0.0054s | 0.0033s | **1.6x** |
| uniq (repetitive 10MB) | 0.0417s | 0.0147s | **2.8x** |
| tac | - | - | no data |
...
| wc (default 1MB text) | 0.0038s | 0.0012s | **3.1x** |
| wc (default 10MB text) | 0.0348s | 0.0028s | **12.5x** |
| wc (default 100MB text) | 0.2923s | 0.0147s | **19.9x** |
| wc (-l 10MB text) | 0.0047s | 0.0021s | **2.2x** |
| wc (-w 10MB text) | 0.0348s | 0.0026s | **13.4x** |
| wc (-c 10MB text) | 0.0008s | 0.0008s | **1.0x** |
| wc (-m 10MB text) | 0.0348s | 0.0034s | **10.1x** |
| wc (-L 10MB text) | 0.0348s | 0.0146s | **2.4x** |
| wc (default 10MB binary) | 0.2357s | 0.0031s | **76.8x** |
| wc (default 10MB repetitive) | 0.0507s | 0.0043s | **11.9x** |
| wc (10 files) | 0.0008s | 0.0008s | **1.0x** |
| wc (100 files) | 0.0013s | 0.0013s | **1.0x** |
| cut (-b1-100 10MB CSV) | 0.0181s | 0.0035s | **5.1x** |
| cut (-c1-100 10MB CSV) | 0.0181s | 0.0040s | **4.6x** |
| cut (-d, -f1 10MB CSV) | 0.0183s | 0.0025s | **7.2x** |
| cut (-d, -f1,3,5 10MB CSV) | 0.0208s | 0.0047s | **4.4x** |
| cut (-d, -f2-4 10MB CSV) | 0.0229s | 0.0042s | **5.4x** |
| cut (--complement -d, -f1 10MB CSV) | 0.0261s | 0.0064s | **4.1x** |
| cut (-d, -f1 100KB text) | 0.0008s | 0.0008s | **0.9x** |
| cut (-d, -f1 1MB text) | 0.0035s | 0.0013s | **2.6x** |
| cut (-d: -f1 colon file) | 0.0007s | 0.0008s | **1.0x** |
| sha256sum (single 100KB text) | 0.0011s | 0.0011s | **1.1x** |
| sha256sum (single 1MB text) | 0.0018s | 0.0034s | **0.5x** |
| sha256sum (single 10MB text) | 0.0083s | 0.0261s | **0.3x** |
| sha256sum (single 10MB binary) | 0.0087s | 0.0272s | **0.3x** |
| sha256sum (single 100MB text) | 0.0615s | 0.2467s | **0.2x** |
...
| md5sum (single 10MB binary) | 0.0226s | 0.0170s | **1.3x** |
| md5sum (single 100MB text) | 0.1929s | 0.1503s | **1.3x** |
| md5sum (10 files) | 0.0012s | 0.0012s | **0.9x** |
| md5sum (100 files) | 0.0018s | 0.0018s | **1.0x** |
| b2sum (single 100KB text) | 0.0009s | 0.0009s | **0.9x** |
| b2sum (single 1MB text) | 0.0021s | 0.0020s | **1.1x** |
| b2sum (single 10MB text) | 0.0148s | 0.0124s | **1.2x** |
| b2sum (single 10MB binary) | 0.0153s | 0.0130s | **1.2x** |
| b2sum (single 100MB text) | 0.1280s | 0.1132s | **1.1x** |
| b2sum (-l 256 10MB) | 0.0148s | 0.0124s | **1.2x** |
| b2sum (-l 128 10MB) | 0.0147s | 0.0124s | **1.2x** |
| b2sum (100 files) | 0.0017s | 0.0019s | **0.9x** |
| base64 (encode 100KB text) | 0.0009s | 0.0009s | **1.0x** |
| base64 (encode 1MB text) | 0.0017s | 0.0019s | **0.9x** |
| base64 (encode 10MB text) | 0.0103s | 0.0078s | **1.3x** |
| base64 (encode 10MB binary) | 0.0107s | 0.0081s | **1.3x** |
| base64 (decode 1MB) | 0.0039s | 0.0025s | **1.6x** |
| base64 (decode 10MB) | 0.0310s | 0.0178s | **1.7x** |
| base64 (encode -w 76 10MB) | 0.0105s | 0.0080s | **1.3x** |
| base64 (encode -w 0 (no wrap) 10MB) | 0.0084s | 0.0057s | **1.5x** |
| sort (lexicographic 1MB) | 0.0075s | 0.0043s | **1.7x** |
| sort (lexicographic 10MB random) | 0.0534s | 0.0189s | **2.8x** |
| sort (already sorted 10MB) | 0.0253s | 0.0083s | **3.0x** |
| sort (reverse sorted 10MB) | 0.0253s | 0.0085s | **3.0x** |
| sort (-n numeric 10MB) | 0.0715s | 0.0391s | **1.8x** |
| sort (-r reverse 10MB) | 0.0546s | 0.0208s | **2.6x** |
| sort (-u unique 10MB) | 0.0567s | 0.0223s | **2.5x** |
| sort (-t, -k2 CSV 10MB) | 0.0729s | 0.0394s | **1.9x** |
| sort (repetitive 10MB) | 0.0426s | 0.0219s | **2.0x** |
| sort (--parallel=4 10MB) | 0.0531s | 0.0206s | **2.6x** |
| tr (a-z to A-Z 1MB) | 0.0019s | 0.0027s | **0.7x** |
| tr (a-z to A-Z 10MB) | 0.0086s | 0.0127s | **0.7x** |
| tr (-d digits 10MB) | 0.0115s | 0.0152s | **0.8x** |
| tr (-d lowercase 10MB) | 0.0190s | 0.0241s | **0.8x** |
| tr (-s spaces 10MB) | 0.0168s | 0.0279s | **0.6x** |
| tr ([:lower:] to [:upper:] 10MB) | 0.0086s | 0.0127s | **0.7x** |
| tr (-d [:digit:] 10MB CSV) | 0.0115s | 0.0152s | **0.8x** |
| tr (translate binary 10MB) | 0.0089s | 0.0139s | **0.6x** |
| uniq (default 10MB many duplicates) | 0.0092s | 0.0046s | **2.0x** |
| uniq (default 10MB sorted (low dup)) | 0.0169s | 0.0043s | **3.9x** |
| uniq (-c count 10MB many dups) | 0.0092s | 0.0046s | **2.0x** |
| uniq (-c count 10MB sorted) | 0.0298s | 0.0055s | **5.4x** |
| uniq (-d duplicates only 10MB) | 0.0093s | 0.0046s | **2.0x** |
| uniq (-u unique only 10MB) | 0.0093s | 0.0045s | **2.0x** |
| uniq (-i case insensitive 10MB) | 0.0169s | 0.0048s | **3.5x** |
...
| tac (reverse 10MB text) | 0.0094s | 0.0055s | **1.7x** |
| tac (reverse 100MB text) | 0.0803s | 0.0452s | **1.8x** |
| tac (reverse CSV 10MB) | 0.0080s | 0.0050s | **1.6x** |
| tac (reverse repetitive 10MB) | 0.0173s | 0.0098s | **1.8x** |
...
| wc (default 1MB text) | 0.0059s | 0.0010s | **5.6x** |
| wc (default 10MB text) | 0.0543s | 0.0023s | **23.6x** |
| wc (default 100MB text) | 0.4830s | 0.0118s | **40.8x** |
| wc (-l 10MB text) | 0.0021s | 0.0020s | **1.1x** |
| wc (-w 10MB text) | 0.0548s | 0.0021s | **26.3x** |
| wc (-c 10MB text) | 0.0008s | 0.0008s | **1.1x** |
| wc (-m 10MB text) | 0.0548s | 0.0027s | **20.1x** |
| wc (-L 10MB text) | 0.0548s | 0.0153s | **3.6x** |
| wc (default 10MB binary) | 0.3175s | 0.0024s | **134.8x** |
| wc (default 10MB repetitive) | 0.0731s | 0.0035s | **20.9x** |
| wc (10 files) | 0.0009s | 0.0009s | **1.0x** |
| wc (100 files) | 0.0017s | 0.0017s | **1.0x** |
| cut (-b1-100 10MB CSV) | 0.0220s | 0.0046s | **4.8x** |
| cut (-c1-100 10MB CSV) | 0.0220s | 0.0044s | **5.0x** |
| cut (-d, -f1 10MB CSV) | 0.0163s | 0.0032s | **5.0x** |
| cut (-d, -f1,3,5 10MB CSV) | 0.0216s | 0.0077s | **2.8x** |
| cut (-d, -f2-4 10MB CSV) | 0.0239s | 0.0072s | **3.3x** |
| cut (--complement -d, -f1 10MB CSV) | 0.0300s | 0.0108s | **2.8x** |
...
| sha256sum (single 10MB text) | 0.0090s | 0.0081s | **1.1x** |
| sha256sum (single 10MB binary) | 0.0090s | 0.0082s | **1.1x** |
| sha256sum (single 100MB text) | 0.0766s | 0.0737s | **1.0x** |
| sha256sum (10 files) | 0.0013s | 0.0014s | **0.9x** |
| sha256sum (100 files) | 0.0023s | 0.0022s | **1.1x** |
| md5sum (single 100KB text) | 0.0014s | 0.0010s | **1.3x** |
| md5sum (single 1MB text) | 0.0030s | 0.0029s | **1.0x** |
| md5sum (single 10MB text) | 0.0182s | 0.0214s | **0.8x** |
| md5sum (single 10MB binary) | 0.0184s | 0.0221s | **0.8x** |
| md5sum (single 100MB text) | 0.1623s | 0.2012s | **0.8x** |
| md5sum (10 files) | 0.0013s | 0.0013s | **1.0x** |
| md5sum (100 files) | 0.0022s | 0.0022s | **1.0x** |
| b2sum (single 100KB text) | 0.0010s | 0.0010s | **1.1x** |
| b2sum (single 1MB text) | 0.0023s | 0.0020s | **1.2x** |
| b2sum (single 10MB text) | 0.0156s | 0.0121s | **1.3x** |
| b2sum (single 10MB binary) | 0.0160s | 0.0126s | **1.3x** |
| b2sum (single 100MB text) | 0.1440s | 0.1113s | **1.3x** |
| b2sum (-l 256 10MB) | 0.0158s | 0.0124s | **1.3x** |
| b2sum (-l 128 10MB) | 0.0158s | 0.0124s | **1.3x** |
| b2sum (100 files) | 0.0021s | 0.0021s | **1.0x** |
| base64 (encode 100KB text) | 0.0010s | 0.0010s | **1.0x** |
| base64 (encode 1MB text) | 0.0019s | 0.0022s | **0.9x** |
| base64 (encode 10MB text) | 0.0122s | 0.0060s | **2.0x** |
| base64 (encode 10MB binary) | 0.0121s | 0.0063s | **1.9x** |
| base64 (decode 1MB) | 0.0038s | 0.0029s | **1.3x** |
| base64 (decode 10MB) | 0.0314s | 0.0174s | **1.8x** |
| base64 (encode -w 76 10MB) | 0.0120s | 0.0060s | **2.0x** |
| base64 (encode -w 0 (no wrap) 10MB) | 0.0091s | 0.0040s | **2.3x** |
| sort (lexicographic 1MB) | 0.0090s | 0.0048s | **1.9x** |
| sort (lexicographic 10MB random) | 0.0573s | 0.0258s | **2.2x** |
| sort (already sorted 10MB) | 0.0277s | 0.0116s | **2.4x** |
| sort (reverse sorted 10MB) | 0.0282s | 0.0115s | **2.4x** |
| sort (-n numeric 10MB) | 0.0772s | 0.0421s | **1.8x** |
| sort (-r reverse 10MB) | 0.0587s | 0.0238s | **2.5x** |
| sort (-u unique 10MB) | 0.0634s | 0.0224s | **2.8x** |
| sort (-t, -k2 CSV 10MB) | 0.0727s | 0.0419s | **1.7x** |
| sort (repetitive 10MB) | 0.0556s | 0.0203s | **2.7x** |
| sort (--parallel=4 10MB) | 0.0598s | 0.0241s | **2.5x** |
| tr (a-z to A-Z 1MB) | 0.0022s | 0.0029s | **0.7x** |
| tr (a-z to A-Z 10MB) | 0.0115s | 0.0154s | **0.7x** |
| tr (-d digits 10MB) | 0.0177s | 0.0192s | **0.9x** |
| tr (-d lowercase 10MB) | 0.0282s | 0.0311s | **0.9x** |
| tr (-s spaces 10MB) | 0.0289s | 0.0388s | **0.7x** |
| tr ([:lower:] to [:upper:] 10MB) | 0.0127s | 0.0152s | **0.8x** |
| tr (-d [:digit:] 10MB CSV) | 0.0172s | 0.0194s | **0.9x** |
| tr (translate binary 10MB) | 0.0098s | 0.0163s | **0.6x** |
| uniq (default 10MB many duplicates) | 0.0118s | 0.0059s | **2.0x** |
| uniq (default 10MB sorted (low dup)) | 0.0134s | 0.0059s | **2.3x** |
| uniq (-c count 10MB many dups) | 0.0122s | 0.0059s | **2.0x** |
| uniq (-c count 10MB sorted) | 0.0283s | 0.0079s | **3.6x** |
| uniq (-d duplicates only 10MB) | 0.0121s | 0.0059s | **2.0x** |
| uniq (-u unique only 10MB) | 0.0121s | 0.0058s | **2.1x** |
| uniq (-i case insensitive 10MB) | 0.0135s | 0.0064s | **2.1x** |
| uniq (repetitive 10MB) | 0.0409s | 0.0084s | **4.8x** |
| tac (reverse 100KB text) | 0.0010s | 0.0011s | **0.9x** |
| tac (reverse 1MB text) | 0.0018s | 0.0021s | **0.9x** |
| tac (reverse 10MB text) | 0.0099s | 0.0064s | **1.6x** |
| tac (reverse 100MB text) | 0.0914s | 0.0500s | **1.8x** |
| tac (reverse CSV 10MB) | 0.0087s | 0.0060s | **1.4x** |
| tac (reverse repetitive 10MB) | 0.0210s | 0.0111s | **1.9x** |
| tac (custom separator 1MB) | 0.0057s | 0.0055s | **1.0x** |
...
1. 38 compatibility test failures detected across 5 platforms
